...
**Classes**: [Bard](list-spells-classes-bard); [Druid](list-spells-classes-druid); [Sorcerer](list-spells-classes-sorcerer); [Wizard](list-spells-classes-wizard); [Rogue (Arcane Trickster)](list-spells-classes-rogue-arcane-trickster); [Druid (Circle of Spores)](list-spells-classes-druid-circle-of-spores-tce); [Fighter (Eldritch Knight)](list-spells-classes-fighter-eldritch-knight); [Cleric (Knowledge Domain)](list-spells-classes-cleric-knowledge-domain)
