...
```ad-statblock
title: Nothic
![](bestiary/tokens/MM/Nothic.webp#token)
...
***Weird Insight.*** The nothic targets one creature it can see within 30 feet of it. The target must contest its Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check against the nothic's Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check. If the nothic wins, it magically learns one fact or secret about the target. The target automatically wins if it is immune to being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed).
```
^statblock
