...
![](bestiary/tokens/MPMM/Gnoll Flesh Gnawer.webp#token)
...
***Sudden Rush.*** Until the end of the turn, the gnoll's speed increases by 60 feet and it doesn't provoke [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack).
