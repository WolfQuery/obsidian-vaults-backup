...
---
# Rust Monster
*Source: Monster Manual p. 262, Waterdeep: Dragon Heist. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Rust Monster
![](bestiary/tokens/MM/Rust Monster.webp#token)
