...
---
# Doppelganger
*Source: Monster Manual p. 82, Waterdeep: Dragon Heist. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
```ad-statblock
title: Doppelganger
![](bestiary/tokens/MM/Doppelganger.webp#token)
...
***Ambusher.*** In the first round of a combat, the doppelganger has advantage on attack rolls against any creature it [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised).
