...
```ad-statblock
title: Winter Wolf
![](bestiary/tokens/MM/Winter Wolf.webp#token)
...
***Snow Camouflage.*** The wolf has advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in snowy terrain.
