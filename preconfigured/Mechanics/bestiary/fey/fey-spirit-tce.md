...
```ad-statblock
title: Fey Spirit
![](bestiary/tokens/TCE/Fey Spirit.webp#token)
*Small fey, Unaligned*
...
***Shortsword.*** *Melee Weapon Attack:* `YourSpellAttack` to hit, reach 5 ft., one target. *Hit:* `1d6 + 3` + the spell's level piercing damage `+ 1d6` force damage.
