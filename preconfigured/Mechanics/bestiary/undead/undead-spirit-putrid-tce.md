...
***Festering Aura.*** Any creature, other than you, that starts its turn within 5 feet of the spirit must succeed on a Constitution saving throw against your spell save DC or be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) until the start of its next turn.
