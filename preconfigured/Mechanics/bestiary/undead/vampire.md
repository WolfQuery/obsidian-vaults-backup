...
---
# Vampire
*Source: Monster Manual p. 297, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Vampire
![](bestiary/tokens/MM/Vampire.webp#token)
...
![Vampire](3-Mechanics/CLI/bestiary/legendary-group/vampire.md)
```
^statblock
