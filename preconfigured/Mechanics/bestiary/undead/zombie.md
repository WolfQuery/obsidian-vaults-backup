...
---
# Zombie
*Source: Monster Manual p. 316, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
```ad-statblock
title: Zombie
![](bestiary/tokens/MM/Zombie.webp#token)
