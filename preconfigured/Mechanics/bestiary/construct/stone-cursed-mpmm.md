...
```ad-statblock
title: Stone Cursed
![](bestiary/tokens/MPMM/Stone Cursed.webp#token)
...
***Cunning Opportunist.*** The stone cursed has advantage on the attack rolls of [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack).
