...
```ad-statblock
title: Bullywug
![](bestiary/tokens/MM/Bullywug.webp#token)
...
***Swamp Camouflage.*** The bullywug has advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in swampy terrain.
