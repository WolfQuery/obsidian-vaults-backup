...
```ad-statblock
title: Tortle Druid
![](bestiary/tokens/MPMM/Tortle Druid.webp#token)
...
***Multiattack.*** The tortle makes four Claw attacks or two [Nature](3-Mechanics/CLI/rules/skills.md#Nature)'s Wrath attacks.
