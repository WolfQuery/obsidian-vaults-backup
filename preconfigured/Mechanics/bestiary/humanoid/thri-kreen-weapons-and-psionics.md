...
***Chameleon Carapace.*** The thri-kreen can change the color of its carapace to match the color and texture of its surroundings. As a result, it has advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide.
...
**At will**: [mage hand](3-Mechanics/CLI/spells/mage-hand.md) (the hand is [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible))
