...
![](bestiary/tokens/MPMM/Duergar Despot.webp#token)
...
***Multiattack.*** The duergar makes two Iron Fist attacks and two Stomping Foot attacks. After one of the attacks, the duergar can move up to its speed without provoking [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack). It can replace one of the attacks with a use of Flame Jet.
