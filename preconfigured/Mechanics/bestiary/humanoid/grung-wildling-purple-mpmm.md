...
***Poisonous Skin.*** A creature [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) by a grung suffers an additional effect that depends on the grung's color. This effect lasts until the creature is no longer [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) by the grung. The [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) creature feels a desperate need to soak itself in liquid or mud. It can't take actions or move except to do so or to reach a body of liquid or mud.
