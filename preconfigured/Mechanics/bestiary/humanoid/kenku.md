...
---
# Kenku
*Source: Monster Manual p. 194, Waterdeep: Dragon Heist*  
...
```ad-statblock
title: Kenku
![](bestiary/tokens/MM/Kenku.webp#token)
...
***Ambusher.*** In the first round of a combat, the kenku has advantage on attack rolls against any creature it [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised).

***Mimicry.*** The kenku can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check.
