...
```ad-statblock
title: Shard Shunner
![](bestiary/tokens/WDH/Shard Shunner.webp#token)
...
***Keen Smell.*** The Shard Shunner has advantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on smell.
