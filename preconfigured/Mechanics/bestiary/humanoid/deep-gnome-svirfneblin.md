...
*Source: Monster Manual p. 164, Waterdeep: Dragon Heist. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
![](bestiary/tokens/MM/Deep Gnome (Svirfneblin).webp#token)
...
***Stone Camouflage.*** The gnome has advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in rocky terrain.
