...
---
# Troglodyte
*Source: Monster Manual p. 290, Waterdeep: Dragon Heist*  
...
```ad-statblock
title: Troglodyte
![](bestiary/tokens/MM/Troglodyte.webp#token)
...
***Chameleon Skin.*** The troglodyte has advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide.
