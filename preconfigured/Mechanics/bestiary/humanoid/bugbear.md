...
---
# Bugbear
*Source: Monster Manual p. 33, Waterdeep: Dragon Heist, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
```ad-statblock
title: Bugbear
![](bestiary/tokens/MM/Bugbear.webp#token)
