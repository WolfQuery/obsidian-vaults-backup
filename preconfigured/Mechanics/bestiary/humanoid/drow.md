...
---
# Drow
*Source: Monster Manual p. 128, Waterdeep: Dragon Heist. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Drow
![](bestiary/tokens/MM/Drow.webp#token)
