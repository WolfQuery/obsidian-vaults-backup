...
---
# Unicorn
*Source: Monster Manual p. 294, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Unicorn
![](bestiary/tokens/MM/Unicorn.webp#token)
...
![Unicorn](3-Mechanics/CLI/bestiary/legendary-group/unicorn.md)
```
^statblock
