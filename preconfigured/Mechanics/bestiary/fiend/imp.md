...
---
# Imp
*Source: Monster Manual p. 76, Waterdeep: Dragon Heist, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
```ad-statblock
title: Imp
![](bestiary/tokens/MM/Imp.webp#token)
