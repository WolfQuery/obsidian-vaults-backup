...
```ad-statblock
title: Molydeus
![](bestiary/tokens/MPMM/Molydeus.webp#token)
...
***Move.*** The molydeus moves without provoking [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack).
