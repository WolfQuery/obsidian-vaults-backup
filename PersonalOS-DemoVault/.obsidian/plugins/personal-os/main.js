...
var getCurrent = () => ({
  today: (0, import_obsidian15.moment)().format("YYYY-MM-DD"),
  day: (0, import_obsidian15.moment)().format("d"),
  month: (0, import_obsidian15.moment)().format("M"),
  year: (0, import_obsidian15.moment)().format("YYYY")
});
var getMeta = (dailyNoteFormat, globalTaskFilter, disableRecurrence, tasks) => {
  ...
  for (let task of tasks) {
    ...
    if (isOverdue(task)) {
      task.type = "overdue";
      task.typePriority = 1;
      task.moment = task.due ? (0, import_obsidian15.moment)(task.due) : (0, import_obsidian15.moment)(task.scheduled);
      ...
      if (task.due && task.scheduled && (0, import_obsidian15.moment)(task.due).isSameOrBefore(task.scheduled) || task.due) {
        task.type = "due";
        task.typePriority = 3;
        task.moment = (0, import_obsidian15.moment)(task.due);
      } else if (task.scheduled) {
        task.type = "scheduled";
        task.typePriority = 3;
        task.moment = (0, import_obsidian15.moment)(task.scheduled);
      }
    } else if (isStart(task) && !hasTimeFormat(task)) {
      task.type = "start";
      task.typePriority = 4;
      task.moment = (0, import_obsidian15.moment)(task.start);
    } else if (isTime(task)) {
      task.type = "time";
      task.typePriority = 5;
      let time = getTime(taskText).split(":");
      task.moment = task.due ? (0, import_obsidian15.moment)(task.due).startOf("day") : (0, import_obsidian15.moment)(task.scheduled).startOf("day");
      task.moment.add(parseInt(time[0]), "hours").add(parseInt(time[1]), "minutes");
    } else if (isDone(task)) {
      task.type = "done";
      task.typePriority = 6;
      task.moment = (0, import_obsidian15.moment)(task.completion);
    } else if (isCancelled(task)) {
      task.type = "cancelled";
      task.typePriority = 7;
      if (task.cancelled)
        task.moment = (0, import_obsidian15.moment)(task.cancelled);
    }
    if (dailyNoteMatch && !dailyTaskMatch) {
      task.dailyNote = (0, import_obsidian15.moment)(dailyNoteMatch[1], dailyNoteFormat).format("YYYY-MM-DD");
    }
...
var isOverdue = (task) => isNotCompletedOrCancelled(task) && (task.due && (0, import_obsidian15.moment)(task.due).isBefore((0, import_obsidian15.moment)(), "day") || task.scheduled && (0, import_obsidian15.moment)(task.scheduled).isBefore((0, import_obsidian15.moment)(), "day"));
...
var updateCounters = (status, counter, currentDate) => {
  ...
  counter.recurrence += status.filter((t) => t.recurrence && !(t.type == "overdue" && (0, import_obsidian15.moment)().isSame(currentDate, "day"))).length;
  counter.overdue += status.filter((t) => t.type == "overdue" && (0, import_obsidian15.moment)().isSame(currentDate, "day")).length;
};
...
var filterTasks = (task, date) => {
  if (task.type == "overdue" && (0, import_obsidian15.moment)(date).isSame((0, import_obsidian15.moment)(), "day")) {
    return true;
  } else if (task.type == "overdue" && (0, import_obsidian15.moment)(date).isBefore((0, import_obsidian15.moment)(), "day")) {
    return false;
  }
  if (task.recurrence) {
    return IsRecurringThisDay(task, date);
  } else if (task.moment) {
    return task.moment.isSame((0, import_obsidian15.moment)(date), "day");
  } else {
    return false;
  }
};
var setTask = (obj, cls, dv) => {
  ...
  const relative = obj.due ? (0, import_obsidian15.moment)(obj.due).fromNow() : "";
  ...
  if (cls.toLocaleLowerCase() == "done")
    ...
    taskIcon = "\u{1F4C4}";
  else if (cls.toLocaleLowerCase() == "time" || cls.toLocaleLowerCase() == "timepassed" && !obj.moment.isSame((0, import_obsidian15.moment)(), "day"))
    taskIcon = "\u231A";
  ...
  constructor(app) {
    ...
    this.displayCalendar = (input, element) => {
      ...
      if (view.toLowerCase() == "month") {
        this.selectedDate = (0, import_obsidian16.moment)(startPosition || (0, import_obsidian16.moment)(), "YYYY-MM").date(1);
      } else if (view.toLowerCase() == "week") {
        this.selectedDate = (0, import_obsidian16.moment)(startPosition || (0, import_obsidian16.moment)(), "YYYY-ww").startOf("week");
    ...
    this.setButtonEvents = () => {
      this.rootNode.querySelectorAll("button").forEach((btn) => btn.addEventListener("click", () => {
        ...
        if (btn.className == "previous") {
          if (activeView == "month") {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).subtract(1, "months");
            this.getMonth();
          } else if (activeView == "week") {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).subtract(7, "days").startOf("week");
            this.getWeek();
          ...
          if (activeView == "month") {
            this.selectedDate = (0, import_obsidian16.moment)().date(1);
            this.getMonth();
          } else if (activeView == "week") {
            this.selectedDate = (0, import_obsidian16.moment)().startOf("week");
            this.getWeek();
          } else if (activeView == "list") {
            this.selectedDate = (0, import_obsidian16.moment)().date(1);
            this.getList();
          ...
          if (activeView == "month") {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).add(1, "months");
            this.getMonth();
          } else if (activeView == "week") {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).add(7, "days").startOf("week");
            this.getWeek();
          } else if (activeView == "list") {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).add(1, "months");
            this.getList();
          ...
          if ((0, import_obsidian16.moment)().format("ww-YYYY") == (0, import_obsidian16.moment)(this.selectedDate).format("ww-YYYY")) {
            this.selectedDate = (0, import_obsidian16.moment)().date(1);
          } else {
            this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).date(1);
          }
          ;
          this.getMonth();
          ...
          if (this.rootNode.getAttribute("view") == "week") {
            ...
            if ((0, import_obsidian16.moment)().format("MM-YYYY") != (0, import_obsidian16.moment)(this.selectedDate).format("MM-YYYY")) {
              this.selectedDate = (0, import_obsidian16.moment)(this.selectedDate).startOf("month").startOf("week");
            } else {
              this.selectedDate = (0, import_obsidian16.moment)().startOf("week");
            }
            ;
    ...
    this.getMonth = async () => {
      ...
      this.rootNode.querySelector("button.current").innerHTML = `<span>${(0, import_obsidian16.moment)(this.selectedDate).format("MMMM")}</span><span>${(0, import_obsidian16.moment)(this.selectedDate).format("YYYY")}</span>`;
      let firstDayOfMonth = parseInt((0, import_obsidian16.moment)(this.selectedDate).format("d"));
      let lastDateOfMonth = parseInt((0, import_obsidian16.moment)(this.selectedDate).endOf("month").format("D"));
      let counter = {
        due: 0,
        done: 0,
        overdue: 0,
      ...
      let monthName = (0, import_obsidian16.moment)(this.selectedDate).format("MMM").replace(".", "").substring(0, 3);
      let current = getCurrent();
      if (firstDayOfMonth == 0)
        firstDayOfMonth = 7;
      let gridHeads = "";
      for (let h = 0 - firstDayOfMonth + this.firstDayOfWeek; h < 7 - firstDayOfMonth + this.firstDayOfWeek; h++) {
        let weekDayNr = (0, import_obsidian16.moment)(this.selectedDate).add(h, "days").format("d");
        let weekDayName = (0, import_obsidian16.moment)(this.selectedDate).add(h, "days").format("ddd");
        if (current.day == weekDayNr && current.month == (0, import_obsidian16.moment)(this.selectedDate).format("M") && current.year == (0, import_obsidian16.moment)(this.selectedDate).format("YYYY")) {
      ...
      for (let w = 1; w < 7; w++) {
        tasksPromises.push((async () => {
          ...
          for (let i = starts; i < starts + 7; i++) {
            if (i == starts) {
              weekNr = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("w");
              yearNr = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("YYYY");
            }
            ;
            let currentDate = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("YYYY-MM-DD");
            let dailyNotePath = this.dailyNoteFolder + "/" + currentDate;
            let weekDay = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("d");
            let shortDayName = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("D");
            let longDayName = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("D. MMM");
            let status = getTasks(this.tasks, currentDate);
            if ((0, import_obsidian16.moment)(this.selectedDate).format("MM") == (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("MM")) {
            ...
            if (parseInt((0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("D")) == 1) {
    ...
    this.getWeek = async () => {
      ...
      if (this.rootNode.querySelector("button.current"))
        this.rootNode.querySelector("button.current").innerHTML = `<span>${(0, import_obsidian16.moment)(this.selectedDate).format("YYYY")}</span><span>${(0, import_obsidian16.moment)(this.selectedDate).format("[W]w")}</span>`;
      let gridContent = "";
      let currentWeekday = parseInt((0, import_obsidian16.moment)(this.selectedDate).format("d"));
      let weekNr = (0, import_obsidian16.moment)(this.selectedDate).format("[W]w");
      let counter = {
        due: 0,
        done: 0,
        overdue: 0,
      ...
      for (let i = 0 - currentWeekday + this.firstDayOfWeek; i < 7 - currentWeekday + this.firstDayOfWeek; i++) {
        tasksPromises.push((async () => {
          ...
          let dailyNotePath = this.dailyNoteFolder + "/" + currentDate;
          let weekDay = (0, import_obsidian16.moment)(this.selectedDate).add(i, "days").format("d");
          let dayName = (0, import_obsidian16.moment)(currentDate).format("ddd D.");
          let longDayName = (0, import_obsidian16.moment)(currentDate).format("ddd, D. MMM");
    ...
    this.getList = async () => {
      ...
      let monthName = (0, import_obsidian16.moment)(this.selectedDate).format("MMM").replace(".", "").substring(0, 3);
      const tasksPromises = [];
      for (let i = 0; i < parseInt((0, import_obsidian16.moment)(this.selectedDate).endOf("month").format("D")); i++) {
        tasksPromises.push((async () => {
          let currentDate = (0, import_obsidian16.moment)(this.selectedDate).startOf("month").add(i, "days").format("YYYY-MM-DD");
          let status = getTasks(this.tasks, currentDate);
          updateCounters(status, counter, currentDate);
          if ((0, import_obsidian16.moment)().format("YYYY-MM-DD") == currentDate) {
            ...
            for (let t = 1; t < this.upcomingDays + 1; t++) {
              let next = (0, import_obsidian16.moment)(currentDate).add(t, "days").format("YYYY-MM-DD");
            ...
            listContent += `<details open class='today'><summary><span>${(0, import_obsidian16.moment)(currentDate).format("dddd, D")}</span><span class='weekNr'>${(0, import_obsidian16.moment)(currentDate).format("[W]w")}</span></summary><div class='content'>${overdueDetails}${todayDetails}${upcomingDetails}</div></details>`;
          } else {
            listContent += `<details open><summary><span>${(0, import_obsidian16.moment)(currentDate).format("dddd, D")}</span><span class='weekNr'>${(0, import_obsidian16.moment)(currentDate).format("[W]w")}</span></summary><div class='content'>${setTaskContentContainer(status, this.dv, currentDate)}</div></details>`;
          }
        })());
      }
      await Promise.all(tasksPromises);
      ...
      if ((0, import_obsidian16.moment)().format("YYYY-MM") == (0, import_obsidian16.moment)(this.selectedDate).format("YYYY-MM")) {
    ...
    this.setWrapperEvents = () => {
      this.rootNode.querySelectorAll(".wrapperButton").forEach((wBtn) => wBtn.addEventListener("click", () => {
        ...
        this.selectedDate = (0, import_obsidian16.moment)((0, import_obsidian16.moment)(year).add(week - 1, "weeks")).startOf("week");
        this.rootNode.querySelector(`.grid`).remove();
        this.getWeek();
      }));
    };
    this.dv = (0, import_obsidian_dataview7.getAPI)(app);
  }
};
...
var getMeta2 = (tasks, input) => {
  ...
  if (!dailyNoteFormat)
    dailyNoteFormat = "YYYY-MM-DD";
  let today = (0, import_obsidian17.moment)().format("YYYY-MM-DD");
  let dailyNoteRegEx = momentToRegex(dailyNoteFormat);
  let timelineDates = [];
  numberOfDays = numberOfDays || "1";
  for (let i = 0; i < parseInt(numberOfDays); i++) {
    timelineDates.push((0, import_obsidian17.moment)(today).add(i, "days").format("YYYY-MM-DD"));
  }
  ...
  for (let task of tasks) {
    ...
    if (dailyNoteMatch && task.completed == false && task.checked == false) {
      task.dailyNote = true;
      if (!dailyTaskMatch) {
        if ((0, import_obsidian17.moment)(dailyNoteMatch[1], dailyNoteFormat).format("YYYY-MM-DD") < today) {
          if (forward == true) {
            happens["unplanned"] = today;
            task.order = taskOrder.indexOf("unplanned");
          } else {
            happens["unplanned"] = (0, import_obsidian17.moment)(dailyNoteMatch[1], dailyNoteFormat).format("YYYY-MM-DD");
            task.order = taskOrder.indexOf("unplanned");
          }
          ;
        } else {
      ...
      ;
    } else if (dailyNoteMatch && task.completed == false && task.checked == true && (0, import_obsidian17.moment)(dailyNoteMatch[1], dailyNoteFormat).format("YYYY-MM-DD") >= today) {
      happens["cancelled"] = (0, import_obsidian17.moment)(dailyNoteMatch[1], dailyNoteFormat).format("YYYY-MM-DD");
    ...
    while (inlineFields = /\[([^\]]+)\:\:([^\]]+)\]/g.exec(task.text)) {
      ...
      if (fieldKey == "due" || fieldKey == "scheduled" || fieldKey == "start" || fieldKey == "completion") {
        let fieldDate = (0, import_obsidian17.moment)(fieldValue).format("YYYY-MM-DD");
    ...
    if (dueMatch && task.completed == false && task.checked == false) {
      task.text = task.text.replace(dueMatch[0], "");
      task.moment = (0, import_obsidian17.moment)(dueMatch[1]);
      ...
      if (dueMatch[1] < today) {
        ...
        task.order = taskOrder.indexOf("due");
      } else if (dueMatch[1] > (0, import_obsidian17.moment)().format("YYYY-MM-DD")) {
        happens["due"] = dueMatch[1];
        task.order = taskOrder.indexOf("due");
      }
      ;
    ...
    if (scheduledMatch && task.completed == false && task.checked == false) {
      task.moment = (0, import_obsidian17.moment)(scheduledMatch[1]);
      task.text = task.text.replace(scheduledMatch[0], "");
    ...
    if (startMatch && task.completed == false && task.checked == false) {
      task.moment = (0, import_obsidian17.moment)(startMatch[1]);
      task.text = task.text.replace(startMatch[0], "");
...
var getRelative = (someDate) => {
  let date = (0, import_obsidian17.moment)(someDate);
  if ((0, import_obsidian17.moment)().diff(date, "days") >= 1 || (0, import_obsidian17.moment)().diff(date, "days") <= -1) {
    return date.fromNow();
  } else {
...
var getSelectOptions = (rootNode, dailyNoteFolder, dailyNoteFormat, taskFiles, inbox, select) => {
  if (!dailyNoteFormat)
    dailyNoteFormat = "YYYY-MM-DD";
  const currentDailyNote = dailyNoteFolder + (0, import_obsidian17.moment)().format(dailyNoteFormat) + ".md";
  ...
  constructor(app) {
    ...
    this.setEvents = () => {
      ...
      (_b = this.rootNode.querySelector(".ok")) == null ? void 0 : _b.addEventListener("click", () => {
        ...
        if (newTask.length > 1) {
          try {
            ...
            if (abstractFilePath && abstractFilePath instanceof import_obsidian18.TFile) {
            ...
            ;
            new import_obsidian18.Notice("New task saved!");
            ...
            new import_obsidian18.Notice("Something went wrong!");
          }
          ;
        } else {
          this.rootNode.querySelector(".newTask").focus();
      ...
      this.rootNode.querySelector(".newTask").addEventListener("input", () => {
        ...
        if (newTask.includes("today ")) {
          input.value = newTask.replace("today", (0, import_obsidian18.moment)().format("YYYY-MM-DD"));
        }
        ;
        if (newTask.includes("tomorrow ")) {
          input.value = newTask.replace("tomorrow", (0, import_obsidian18.moment)().add(1, "days").format("YYYY-MM-DD"));
        }
        ;
        if (newTask.includes("yesterday ")) {
          input.value = newTask.replace("yesterday", (0, import_obsidian18.moment)().subtract(1, "days").format("YYYY-MM-DD"));
        }
        ;
        ...
        if (futureDate) {
          ...
          let date = (0, import_obsidian18.moment)().add(x, unit).format("YYYY-MM-DD[ ]");
        ...
        if (weekday) {
          ...
          if ((0, import_obsidian18.moment)().isoWeekday() < dayINeed) {
            input.value = newTask.replace(weekday[1], (0, import_obsidian18.moment)().isoWeekday(dayINeed).format("YYYY-MM-DD"));
          } else {
            input.value = newTask.replace(weekday[1], (0, import_obsidian18.moment)().add(1, "weeks").isoWeekday(dayINeed).format("YYYY-MM-DD"));
          }
        }
        this.rootNode.querySelector(".newTask").focus();
      });
      ...
      this.app.workspace.openLinkText("", link).then(() => {
        if (line && col) {
          try {
            ...
            let cmEditor = this.app.workspace.getActiveViewOfType(import_obsidian18.MarkdownView).editor;
    ...
    this.getTimeline = (dateFormat) => {
      ...
      for (let timelineDate of this.timelineDates) {
        ...
        let date = (0, import_obsidian18.moment)(timelineDate.toString()).format(dateFormat);
        let weekday = (0, import_obsidian18.moment)(timelineDate.toString()).format("dddd");
        let year = (0, import_obsidian18.moment)(timelineDate.toString()).format("YYYY");
        ...
        if (year != lastYear) {
          ...
          if ((0, import_obsidian18.moment)().format("YYYY") == year) {
...
var POSVaultFunctions = class {
  constructor(app, configFolder) {
    this.setConfigFolder = (configFolder) => {
      this.configFolder = this.app.vault.getAbstractFileByPath(configFolder || "/") instanceof import_obsidian19.TFolder ? configFolder : "";
      if (this.configFolder === "/" || this.configFolder === "")
        this.configFolder = "";
      else if (!this.configFolder.endsWith("/"))
        this.configFolder += "/";
    ...
    this.rewardActiveFile = () => {
      ...
      const processLinkedFile = async (list) => {
        ...
        if (!targetFile || !(targetFile instanceof import_obsidian19.TFile)) {
...
// main.ts
var PersonalOS = class extends import_obsidian20.Plugin {
  constructor() {
    super(...arguments);
    this.manageToggle = () => {
