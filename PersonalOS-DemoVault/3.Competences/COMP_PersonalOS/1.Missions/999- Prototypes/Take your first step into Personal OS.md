...
tags:
  - Mission-Description
Image: "[[Take your first step into Personal OS.png]]"
Difficulty: 1
Uses Template: "[[First step into Personal OS]]"
---
# Requirements
```dataviewjs
...
# Goal
> [!success]
> Customize your vault and try a complex task today ! 
# Rewards
By completing this mission you will obtain the [[Day 1 of systemic work]] achievement. 
# Map widget
```dataviewjs
...
actions:
  - type: templaterCreateNote
    templateFile: "3.Competences/COMP_PersonalOS/1.Missions/002 - First step into Personal OS/Templates/First step into Personal OS.md"
