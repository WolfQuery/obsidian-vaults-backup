...
If the [mending](3-Mechanics/CLI/spells/mending.md) spell is cast on it, it regains `dice:2d6|noform|noparens|avg` (`2d6`) hit points. If it has died within the last hour, you can use your [smith's tools](3-Mechanics/CLI/items/smiths-tools.md) as an action to revive it, provided you are within 5 feet of it and you expend a spell slot of 1st level or higher. The steel defender returns to life after 1 minute with all its hit points restored.
