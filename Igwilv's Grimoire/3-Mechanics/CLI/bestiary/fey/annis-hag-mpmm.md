...
- "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit, reach\
  ...
  "name": "Claw"
- "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit, reach\
    \ 5 ft., one target. Hit: dice:9d6+5|noform|noparens|avg|text(36) (9d6 +\
    ...
    \ the target takes dice:9d6+5|noform|noparens|avg|text(36) (9d6 + 5) bludgeoning\
    \ damage at the start of each of the hag's turns. The hag can't make attacks while\
