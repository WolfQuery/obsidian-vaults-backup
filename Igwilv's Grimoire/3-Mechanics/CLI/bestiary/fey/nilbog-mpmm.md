...
- "desc": "The nilbog targets one creature it can see within 60 feet of it. The target\
    \ must succeed on a DC 12 Wisdom saving throw or take dice:2d4|noform|noparens|avg|text(5)\
...
- "desc": "In response to another creature dealing damage to the nilbog, the nilbog\
    \ reduces the damage to 0 and regains dice:1d6|noform|noparens|avg|text(3) (1d6)\
    \ hit points."
