...
- "desc": "Melee Weapon Attack: dice:1d20+14|noform|noparens|text(+14) to hit,\
    ...
    \ can't regain hit points, and it takes dice:6d6|noform|noparens|avg|text(21)\
    \ (6d6) poison damage at the start of each of its turns. The [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Melee Weapon Attack: dice:1d20+14|noform|noparens|text(+14) to hit,\
    ...
    \ + 8) bludgeoning damage plus dice:6d6|noform|noparens|avg|text(21) (6d6)\
    \ fire damage."
  "name": "Mace"
- "desc": "Melee Weapon Attack: dice:1d20+14|noform|noparens|text(+14) to hit,\
