...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ construct, it must succeed on a DC 12 Constitution saving throw or lose dice:1d10|noform|noparens|avg|text(5)\
    \ (1d10) hit points at the start of each of its turns due to an infernal wound.\
    \ Each time the devil hits the wounded target with this attack, the damage dealt\
    \ by the wound increases by dice:1d10|noform|noparens|avg|text(5) (1d10).\
    \ Any creature can take an action to stanch the wound with a successful DC 12\
