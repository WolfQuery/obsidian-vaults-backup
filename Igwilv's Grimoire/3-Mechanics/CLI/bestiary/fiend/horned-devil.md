...
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 10 ft., one target. Hit: dice:2d8+6|noform|noparens|avg|text(15) (2d8\
    \ + 6) piercing damage."
  "name": "Fork"
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    ...
    \ construct, it must succeed on a DC 17 Constitution saving throw or lose dice:3d6|noform|noparens|avg|text(10)\
    \ (3d6) hit points at the start of each of its turns due to an infernal wound.\
    \ Each time the devil hits the wounded target with this attack, the damage dealt\
    \ by the wound increases by dice:3d6|noform|noparens|avg|text(10) (3d6). Any\
    \ creature can take an action to stanch the wound with a successful DC 12 Wisdom\
    \ ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check. The wound also\
    \ closes if the target receives magical healing."
  "name": "Tail"
- "desc": "Ranged Spell Attack: dice:1d20+7|noform|noparens|text(+7) to hit, range\
    \ 150 ft., one target. Hit: dice:4d6|noform|noparens|avg|text(14) (4d6)\
