...
*Source: Monster Manual p. 57, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    \ 5 ft., one creature. Hit: dice:4d6+2|noform|noparens|avg|text(16) (4d6\
    \ + 2) piercing damage plus dice:7d6|noform|noparens|avg|text(24) (7d6) necrotic\
    \ damage, and the target's hit point maximum is reduced by an amount equal to\
    \ the necrotic damage taken. If this effect reduces a creature's hit point maximum\
    \ to 0, the creature dies. This reduction to a creature's hit point maximum lasts\
    \ until the creature finishes a long rest or until it is affected by a spell like\
