...
- "desc": "A 15-foot-radius cloud of toxic spores extends out from the vrock. The\
    ...
    \ a target takes dice:1d10|noform|noparens|avg|text(5) (1d10) poison damage\
    \ at the start of each of its turns. A target can repeat the saving throw at the\
    \ end of each of its turns, ending the effect on itself on a success. Emptying\
    \ a vial of holy water on the target also ends the effect on it."
