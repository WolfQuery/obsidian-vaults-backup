...
- "desc": "At the start of each of the wastrilith's turns, exposed water within 30\
    ...
    \ for 24 hours. On a failed save, the creature takes dice:4d6|noform|noparens|avg|text(14)\
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 10 ft., one target. Hit: dice:4d12+4|noform|noparens|avg|text(30) (4d12\
    \ + 4) piercing damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 10 ft., one target. Hit: dice:4d6+4|noform|noparens|avg|text(18) (4d6 +\
    \ 4) slashing damage."
  "name": "Claws"
- "desc": "The wastrilith magically launches a spout of water at one creature it can\
    ...
    \ and it has disadvantage if it's underwater. On a failed save, it takes dice:4d8+4|noform|noparens|avg|text(22)\
    \ (4d8 + 4) acid damage and is pulled up to 60 feet toward the wastrilith. On\
    \ a successful save, it takes half as much damage and isn't pulled."
  "name": "Grasping Spout"
"bonus_actions":
