...
*Source: Monster Manual p. 313, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ slashing damage. The target must make a DC 14 Constitution saving throw, taking\
    \ dice:3d6|noform|noparens|avg|text(10) (3d6) poison damage on a failed save,\
