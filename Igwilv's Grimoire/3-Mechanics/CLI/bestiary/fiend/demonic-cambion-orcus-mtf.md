...
---
# [Demonic Cambion (Orcus)](3-Mechanics\CLI\bestiary\fiend/demonic-cambion-orcus-mtf.md)
...
- "desc": "The cambion's spellcasting ability is Charisma (spell save DC 14). The\
    ...
    \ [detect magic](3-Mechanics/CLI/spells/detect-magic.md), [animate dead](3-Mechanics/CLI/spells/animate-dead.md)"
...
- "desc": "At the end of each of the cambion's turns, each undead of its choice that\
    ...
    \ isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)."
