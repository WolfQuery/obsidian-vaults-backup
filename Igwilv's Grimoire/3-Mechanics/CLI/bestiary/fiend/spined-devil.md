...
*Source: Monster Manual p. 78, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+2|noform|noparens|text(+2) to hit, reach\
    \ 5 ft., one target. Hit: dice:2d4|noform|noparens|avg|text(5) (2d4) slashing\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+2|noform|noparens|text(+2) to hit, reach\
    \ 5 ft., one target. Hit: dice:1d6|noform|noparens|avg|text(3) (1d6) piercing\
    \ damage."
  "name": "Fork"
- "desc": "Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
    \ range 20/80 ft., one target. Hit: dice:1d4+2|noform|noparens|avg|text(4)\
    \ (1d4 + 2) piercing damage plus dice:1d6|noform|noparens|avg|text(3) (1d6)\
    \ fire damage."
  "name": "Tail Spine"
"source":
- "MM"
