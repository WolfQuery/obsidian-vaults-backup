...
*Source: Monster Manual p. 64, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ + 3) psychic damage or, if the demon had advantage on the attack roll, dice:4d6+3|noform|noparens|avg|text(17)\
