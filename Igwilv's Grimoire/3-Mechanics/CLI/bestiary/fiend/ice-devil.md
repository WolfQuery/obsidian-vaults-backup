...
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 5 ft., one target. Hit: dice:2d6+5|noform|noparens|avg|text(12) (2d6\
    \ + 5) piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) cold\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 5 ft., one target. Hit: dice:2d4+5|noform|noparens|avg|text(10) (2d4\
    \ + 5) slashing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) cold\
    \ damage."
  "name": "Claws"
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 10 ft., one target. Hit: dice:2d6+5|noform|noparens|avg|text(12) (2d6\
    \ + 5) bludgeoning damage plus dice:3d6|noform|noparens|avg|text(10) (3d6)\
    \ cold damage."
  "name": "Tail"
- "desc": "The devil magically forms an opaque wall of ice on a solid surface it can\
    ...
    \ The creature then makes a DC 17 Dexterity saving throw, taking dice:10d6|noform|noparens|avg|text(35)\
    ...
    \ make a DC 17 Constitution saving throw, taking dice:5d6|noform|noparens|avg|text(17)\
    \ (5d6) cold damage on a failed save, or half as much damage on a successful\
    \ one. The frigid air dissipates when the rest of the wall vanishes."
