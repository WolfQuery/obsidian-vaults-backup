...
"cr": "5"
"traits":
- "desc": "At the start of each of its turns, the barbed devil deals dice:1d10|noform|noparens|avg|text(5)\
...
- "desc": "Ranged Spell Attack: dice:1d20+5|noform|noparens|text(+5) to hit, range\
    \ 150 ft., one target. Hit: dice:3d6|noform|noparens|avg|text(10) (3d6)\
