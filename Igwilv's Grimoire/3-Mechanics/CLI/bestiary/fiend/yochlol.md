...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 5 ft. (10 feet in demon form), one target. Hit: dice:1d6+2|noform|noparens|avg|text(5)\
    \ (1d6 + 2) bludgeoning (piercing in spider form) damage plus dice:6d6|noform|noparens|avg|text(21)\
    \ (6d6) poison damage."
