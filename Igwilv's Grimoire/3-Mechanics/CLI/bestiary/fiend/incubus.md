...
*Source: Monster Manual p. 285, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The fiend kisses a creature [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
    ...
    \ throw against this magic, taking dice:5d10+5|noform|noparens|avg|text(32)\
