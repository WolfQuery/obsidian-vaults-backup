...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    ...
    \ + 5) force damage plus dice:2d10|noform|noparens|avg|text(9) (2d10) psychic\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
...
- "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
    ...
    \ and it must make a DC 16 Intelligence saving throw. On a successful save, the\
    \ target becomes immune to this hydroloth's Steal Memory for 24 hours. On a failed\
    \ save, the target loses all proficiencies; it can't cast spells; it can't understand\
    \ language; and if its Intelligence and Charisma scores are higher than 5, they\
    \ become 5. Each time the target finishes a long rest, it can repeat the saving\
    \ throw, ending the effect on itself on a success. A [greater restoration](3-Mechanics/CLI/spells/greater-restoration.md)\
