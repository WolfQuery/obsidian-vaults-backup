...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ has sworn vengeance, the target takes an extra dice:4d6|noform|noparens|avg|text(14)\
    \ (4d6) bludgeoning damage. Instead of dealing damage, the revenant can grapple\
    \ the target (escape DC 14) provided the target is Large or smaller."
  "name": "Fist"
