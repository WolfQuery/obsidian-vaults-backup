...
*Source: Monster Manual p. 279, Keys from the Golden Vault*  
...
- "desc": "The poltergeist targets a creature or unattended object within 30 feet\
    ...
    \ or heavy object, the target takes dice:1d6|noform|noparens|avg (1d6) damage\
    ...
    \ path (dice:1d20+4|noform|noparens|text(+4) to hit) and dealing dice:2d4|noform|noparens|avg|text(5)\
