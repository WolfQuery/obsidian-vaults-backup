...
- "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ [comprehend languages](3-Mechanics/CLI/spells/comprehend-languages.md), [fog\
    \ cloud](3-Mechanics/CLI/spells/fog-cloud.md), [sleep](3-Mechanics/CLI/spells/sleep.md)\n\
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 5 ft., one creature. Hit: dice:1d8+4|noform|noparens|avg|text(8) (1d8 +\
    \ 4) bludgeoning damage. Instead of dealing damage, the vampire can grapple the\
    \ target (escape DC 18)."
  "name": "Unarmed Strike (Vampire Form Only)"
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 5 ft., one willing creature, or a creature that is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
    \ by the vampire, [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated),\
    \ or [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained). Hit: dice:1d6+4|noform|noparens|avg|text(7)\
    \ (1d6 + 4) piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6)\
    ...
    \ spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn.md) under the vampire's\
    \ control."
...
- "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
  ...
  "name": "Charm"
- "desc": "The vampire magically calls dice:2d4|noform|noparens|avg (2d4) swarms\
    \ of [bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats.md) or [rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats.md),\
    \ provided that the sun isn't up. While outdoors, the vampire can call dice:3d6|noform|noparens|avg\
    \ (3d6) [wolves](3-Mechanics/CLI/bestiary/beast/wolf.md) instead. The called\
    \ creatures arrive in dice:1d4|noform|noparens|avg (1d4) rounds, acting as\
    \ allies of the vampire and obeying its spoken commands. The beasts remain for\
    \ 1 hour, until the vampire dies, or until the vampire dismisses them as a bonus\
    \ action."
...
- "desc": "- There's a noticeable increase in the populations of bats, rats, and wolves\
  ...
  "name": ""
- "desc": "If the vampire is destroyed, these effects end after dice:2d6|noform|noparens|avg\
    \ (2d6) days."
  "name": ""
"source":
- "MM"
