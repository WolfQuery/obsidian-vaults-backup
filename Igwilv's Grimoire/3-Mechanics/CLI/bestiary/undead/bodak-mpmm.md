...
- "desc": "When a creature that can see the bodak's eyes starts its turn within 30\
    ...
    \ condition. Otherwise, a creature takes dice:3d10|noform|noparens|avg|text(16)\
    \ (3d10) psychic damage on a failed save.\n\nUnless [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised),\
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ bludgeoning damage plus dice:2d8|noform|noparens|avg|text(9) (2d8) necrotic\
    \ damage."
  "name": "Fist"
- "desc": "One creature that the bodak can see within 60 feet of it must make a DC\
    \ 13 Constitution saving throw, taking dice:4d10|noform|noparens|avg|text(22)\
