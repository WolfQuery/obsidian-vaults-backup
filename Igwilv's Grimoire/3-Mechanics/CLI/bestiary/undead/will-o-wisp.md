...
*Source: Monster Manual p. 301, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "As a bonus action, the will-o'-wisp can target one creature it can see\
    ...
    \ target dies, the will-o'-wisp regains dice:3d6|noform|noparens|avg|text(10)\
    \ (3d6) hit points."
  "name": "Consume Life"
