...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ slashing damage plus dice:2d6|noform|noparens|avg|text(7) (2d6) necrotic\
    \ damage."
  "name": "Claw"
- "desc": "A worm launches from the spawn of Kyuss at one Humanoid that the spawn\
    ...
    \ takes dice:2d6|noform|noparens|avg|text(7) (2d6) necrotic damage per worm\
    \ infesting it (maximum of dice:10d6|noform|noparens|avg (10d6)), and if it\
    \ drops to 0 hit points, it dies and then rises 10 minutes later as a spawn of\
    \ Kyuss. If a worm-infested target is targeted by an effect that cures disease\
