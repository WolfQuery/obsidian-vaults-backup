...
- "desc": "The alhoon casts one of the following spells, requiring no material components\
    ...
    \ [plane shift](3-Mechanics/CLI/spells/plane-shift.md) (self only), [wall of force](3-Mechanics/CLI/spells/wall-of-force.md)"
  "name": "Spellcasting"
...
- "desc": "The alhoon makes two Chilling Grasp or Arcane Bolt attacks."
  "name": "Multiattack"
- "desc": "Melee Spell Attack: dice:1d20+8|noform|noparens|text(+8) to hit, reach\
    \ 5 ft., one target. Hit: dice:4d6|noform|noparens|avg|text(14) (4d6) cold\
    \ damage, and the alhoon regains 14 hit points."
  "name": "Chilling Grasp"
