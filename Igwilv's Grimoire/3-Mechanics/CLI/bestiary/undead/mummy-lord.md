...
- "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ spell attacks). The mummy lord has the following cleric spells prepared:\n\n\
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    ...
    \ 4) bludgeoning damage plus dice:6d6|noform|noparens|avg|text(21) (6d6)\
    \ necrotic damage. If the target is a creature, it must succeed on a DC 16 Constitution\
    \ saving throw or be cursed with mummy rot. The cursed target can't regain hit\
    \ points, and its hit point maximum decreases by dice:3d6|noform|noparens|avg|text(10)\
...
- "desc": "- Each undead creature in the lair can pinpoint the location of each living\
    ...
    \ DC 16 Constitution saving throw. On a failed save, it takes dice:1d6|noform|noparens|avg\
