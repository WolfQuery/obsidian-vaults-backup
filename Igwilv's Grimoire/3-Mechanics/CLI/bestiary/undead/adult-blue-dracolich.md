...
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    ...
    \ (2d10 + 7) piercing damage plus dice:1d10|noform|noparens|avg|text(5) (1d10)\
    \ lightning damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
...
- "desc": "The dracolich exhales lightning in a 90-foot line that is 5 feet wide.\
    ...
    \ dice:12d10|noform|noparens|avg|text(66) (12d10) lightning damage on a failed\
...
- "desc": "The dracolich beats its tattered wings. Each creature within 10 feet of\
    \ the dracolich must succeed on a DC 21 Dexterity saving throw or take dice:2d6+7|noform|noparens|avg|text(14)\
