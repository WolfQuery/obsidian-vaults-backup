...
- "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
    \ throw. On a failure, a target takes dice:2d8+4|noform|noparens|avg|text(13)\
    \ (2d8 + 4) bludgeoning damage. If it is Large or smaller, it is also [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
    ...
    \ by it takes dice:2d8+4|noform|noparens|avg|text(13) (2d8 + 4) bludgeoning\
    \ damage. A creature within 5 feet of the elemental can pull a creature or object\
    \ out of it by taking an action to make a DC 14 Strength check and succeeding."
