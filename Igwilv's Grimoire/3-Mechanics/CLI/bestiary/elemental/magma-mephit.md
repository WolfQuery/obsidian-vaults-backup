...
- "desc": "When the mephit dies, it explodes in a burst of lava. Each creature within\
    \ 5 feet of it must make a DC 11 Dexterity saving throw, taking dice:2d6|noform|noparens|avg|text(7)\
...
- "desc": "Melee Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit, reach\
    ...
    \ 1) slashing damage plus dice:1d4|noform|noparens|avg|text(2) (1d4) fire\
    \ damage."
  "name": "Claws"
- "desc": "The mephit exhales a 15-foot cone of fire. Each creature in that area must\
    \ make a DC 11 Dexterity saving throw, taking dice:2d6|noform|noparens|avg|text(7)\
    \ (2d6) fire damage on a failed save, or half as much damage on a successful\
    \ one."
