...
*Source: Monster Manual p. 145, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC 15,\
    \ dice:1d20+7|noform|noparens|text(+7) to hit with spell attacks). It can innately\
...
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    ...
    \ + 6) slashing damage plus dice:2d6|noform|noparens|avg|text(7) (2d6) fire\
    \ damage."
  "name": "Scimitar"
- "desc": "Ranged Spell Attack: dice:1d20+7|noform|noparens|text(+7) to hit, range\
    \ 120 ft., one target. Hit: dice:5d6|noform|noparens|avg|text(17) (5d6)\
    \ fire damage."
  "name": "Hurl Flame"
"source":
- "MM"
