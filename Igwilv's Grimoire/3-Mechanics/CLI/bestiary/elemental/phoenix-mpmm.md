...
- "desc": "If the phoenix dies, it explodes. Each creature in 60-foot-radius sphere\
    ...
    \ cinder, which weighs 5 pounds. The cinder deals dice:6d6|noform|noparens|avg|text(21)\
...
- "desc": "The phoenix can move through a space as narrow as 1 inch wide without squeezing.\n\
    ...
    \ 5 feet of it takes dice:1d10|noform|noparens|avg|text(5) (1d10) fire damage.\
    \ In addition, the phoenix can enter a hostile creature's space and stop there.\
    \ The first time it enters a creature's space on a turn, that creature takes dice:1d10|noform|noparens|avg|text(5)\
...
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 15 ft., one target. Hit: dice:2d6+8|noform|noparens|avg|text(15) (2d6\
    \ + 8) fire damage."
  "name": "Beak"
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 15 ft., one target. Hit: dice:2d8+8|noform|noparens|avg|text(17) (2d8\
    \ + 8) fire damage."
  "name": "Fiery Talons"
"legendary_actions":
