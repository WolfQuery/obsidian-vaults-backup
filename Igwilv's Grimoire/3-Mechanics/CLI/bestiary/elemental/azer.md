...
*Source: Monster Manual p. 22, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "A creature that touches the azer or hits it with a melee attack while within\
  ...
  "name": "Heated Body"
- "desc": "When the azer hits with a metal melee weapon, it deals an extra dice:1d6|noform|noparens|avg|text(3)\
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ bludgeoning damage, or dice:1d10+3|noform|noparens|avg|text(8) (1d10 + 3)\
    \ bludgeoning damage if used with two hands to make a melee attack, plus dice:1d6|noform|noparens|avg|text(3)\
    \ (1d6) fire damage."
  "name": "Warhammer"
"source":
- "MM"
