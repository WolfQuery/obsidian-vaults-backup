...
- "desc": "The zaratan exhales rocky debris in a 90-foot cube. Each creature in that\
    \ area must make a DC 25 Dexterity saving throw. A creature takes dice:6d10|noform|noparens|avg|text(33)\
...
- "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
    ...
    \ is [concentrating](3-Mechanics/CLI/rules/conditions.md#Concentration) must succeed\
    \ on a DC 25 Constitution saving throw or the creature's [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration)\
    ...
    \ takes dice:5d6|noform|noparens|avg|text(17) (5d6) bludgeoning damage, is\
    \ knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone), and is trapped in\
    \ the rubble. A trapped creature is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained),\
...
- "desc": "The zaratan can use this option only if it is retracted in its shell. It\
    \ regains dice:5d20|noform|noparens|avg|text(52) (5d20) hit points. The next\
