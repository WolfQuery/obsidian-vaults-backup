...
- "desc": "A creature that touches the salamander or hits it with a melee attack while\
    ...
    \ damage."
  "name": "Heated Body"
- "desc": "Any metal melee weapon the salamander wields deals an extra dice:1d6|noform|noparens|avg|text(3)\
...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ 4) bludgeoning damage plus dice:2d6|noform|noparens|avg|text(7) (2d6) fire\
