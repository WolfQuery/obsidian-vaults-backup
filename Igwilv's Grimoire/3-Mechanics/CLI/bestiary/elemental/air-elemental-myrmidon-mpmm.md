...
- "desc": "The myrmidon makes one Flail attack. On a hit, the target takes an extra\
    \ dice:4d8|noform|noparens|avg|text(18) (4d8) lightning damage, and the target\
    \ must succeed on a DC 13 Constitution saving throw or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned)\
