...
*Source: Monster Manual p. 124, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Each creature in the elemental's space must make a DC 13 Strength saving\
    \ throw. On a failure, a target takes dice:3d8+2|noform|noparens|avg|text(15)\
    \ (3d8 + 2) bludgeoning damage and is flung up 20 feet away from the elemental\
    \ in a random direction and knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone).\
    \ If a thrown target strikes an object, such as a wall or floor, the target takes\
    \ dice:1d6|noform|noparens|avg|text(3) (1d6) bludgeoning damage for every\
    \ 10 feet it was thrown. If the target is thrown at another creature, that creature\
    \ must succeed on a DC 13 Dexterity saving throw or take the same damage and be\
    ...
    \ flung away or knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone)."
