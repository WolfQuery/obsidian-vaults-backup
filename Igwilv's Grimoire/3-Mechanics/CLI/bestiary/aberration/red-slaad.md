...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ piercing damage. If the target is a humanoid, it must succeed on a DC 14 Constitution\
    \ saving throw or be infected with a disease—a minuscule slaad egg.\n\nA humanoid\
    \ host can carry only one slaad egg to term at a time. Over three months, the\
    \ egg moves to the chest cavity, gestates, and forms a [slaad tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole.md).\
