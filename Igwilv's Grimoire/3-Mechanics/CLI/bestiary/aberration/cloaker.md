...
*Source: Monster Manual p. 41, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 5 ft., one creature. Hit: dice:2d6+3|noform|noparens|avg|text(10) (2d6\
    ...
    \ to the target's head, and the target is [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded)\
  ...
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 10 ft., one creature. Hit: dice:1d8+3|noform|noparens|avg|text(7) (1d8\
    \ + 3) slashing damage."
  "name": "Tail"
