...
*Source: Monster Manual p. 172, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    \ 10 ft., one creature. Hit: dice:1d10+2|noform|noparens|avg|text(7) (1d10\
    ...
    \ The [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) target is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed),\
