...
*Source: Monster Manual p. 28, Keys from the Golden Vault*  
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ turns, ending the effect on itself on a success.  \n- 5. Enervation Ray.\
    \ The targeted creature must make a DC 16 Constitution saving throw, taking dice:8d8|noform|noparens|avg|text(36)\
    ...
    \ it must succeed on a DC 16 Dexterity saving throw or take dice:10d8|noform|noparens|avg|text(45)\
...
- "desc": "- Creatures within 1 mile of the beholder's lair sometimes feel as if they're\
    ...
    \ person.  "
  "name": ""
- "desc": "If the beholder dies, these effects fade over the course of dice:1d10|noform|noparens|avg\
    \ (1d10) days."
  "name": ""
"source":
- "MM"
