...
- "desc": "The morkoth casts one of the following spells, requiring no material components\
    ...
    \n3/day each: [darkness](3-Mechanics/CLI/spells/darkness.md), [dimension door](3-Mechanics/CLI/spells/dimension-door.md),\
...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ slashing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) psychic\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 15 ft., one target. Hit: dice:3d8+2|noform|noparens|avg|text(15) (3d8 +\
    ...
    \ the target is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) and\
    \ takes dice:3d8+2|noform|noparens|avg|text(15) (3d8 + 2) bludgeoning damage\
    \ at the start of each of its turns, and the morkoth can't use its tentacles on\
    \ another target."
  "name": "Tentacles"
