...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ 2) piercing damage plus dice:1d4|noform|noparens|avg|text(2) (1d4) acid\
    \ damage. At the end of each of its turns, the target must make a DC 10 Constitution\
    \ saving throw, taking dice:1d4|noform|noparens|avg|text(2) (1d4) acid damage\
...
- "desc": "Each creature in a 15-foot cone originating from the flumph must succeed\
    ...
    \ coated creature exudes a horrible stench for dice:1d4|noform|noparens|avg\
    \ (1d4) hours. The coated creature is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
