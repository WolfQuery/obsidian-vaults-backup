...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    \ 0 ft., one target in the swarm's space. Hit: dice:4d6|noform|noparens|avg|text(14)\
    \ (4d6) piercing damage, or dice:2d6|noform|noparens|avg|text(7) (2d6) piercing\
    \ damage if the swarm has half of its hit points or fewer, plus dice:5d8|noform|noparens|avg|text(22)\
    \ (5d8) psychic damage."
  "name": "Bites"
"bonus_actions":
