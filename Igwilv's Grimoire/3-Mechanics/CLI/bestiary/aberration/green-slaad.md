...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
  ...
  "name": "Staff"
- "desc": "Ranged Spell Attack: dice:1d20+4|noform|noparens|text(+4) to hit, range\
    \ 60 ft., one target. Hit: dice:3d6|noform|noparens|avg|text(10) (3d6) fire\
    \ damage. The fire ignites flammable objects that aren't being worn or carried."
  "name": "Hurl Flame"
"source":
- "MM"
