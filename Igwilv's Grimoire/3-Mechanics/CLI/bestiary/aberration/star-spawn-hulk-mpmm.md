...
- "desc": "The hulk makes two Slam attacks. If both attacks hit the same target, the\
    \ target also takes dice:2d8|noform|noparens|avg|text(9) (2d8) psychic damage\
    \ and must succeed on a DC 17 Constitution saving throw or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned)\
