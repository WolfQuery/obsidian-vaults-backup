...
- "desc": "One Large or smaller creature that the slithering tracker can see within\
    ...
    \ target takes dice:3d10|noform|noparens|avg|text(16) (3d10) necrotic damage\
    \ at the start of each of its turns. The slithering tracker can grapple only one\
    \ target at a time.\n\nWhile grappling the target, the slithering tracker takes\
    \ only half any damage dealt to it (rounded down), and the target takes the other\
    \ half."
  "name": "Life Leech"
"bonus_actions":
