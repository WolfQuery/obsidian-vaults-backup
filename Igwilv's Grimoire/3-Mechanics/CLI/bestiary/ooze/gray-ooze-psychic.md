...
*Source: Monster Manual p. 243, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit, reach\
    ...
    \ bludgeoning damage plus dice:2d6|noform|noparens|avg|text(7) (2d6) acid\
    \ damage, and if the target is wearing nonmagical metal armor, its armor is partly\
    \ corroded and takes a permanent and cumulative −1 penalty to the AC it offers.\
...
- "desc": "The ooze targets one creature that it can sense within 60 feet of it. The\
    \ target must make a DC 10 Intelligence saving throw, taking dice:3d6|noform|noparens|avg|text(10)\
    \ (3d6) psychic damage on a failed save, or half as much damage on a successful\
    \ one."
