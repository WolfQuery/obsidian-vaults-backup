...
---
# [Fragment of Krokulmar](3-Mechanics\CLI\bestiary\npc/fragment-of-krokulmar-kftgv.md)
...
- "desc": "The fragment touches one creature that has 0 hit points in the fragment's\
    ...
    \ the healed creature takes dice:1d6|noform|noparens|avg|text(3) (1d6) psychic\
    \ damage."
...
"source":
- "KftGV"
"image": "3-Mechanics/CLI/bestiary/npc/token/fragment-of-krokulmar-kftgv.webp"
```
^statblock