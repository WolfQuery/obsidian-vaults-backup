...
- "desc": "Melee or Ranged Weapon Attack: dice:1d20+14|noform|noparens|text(+14)\
    ...
    \ (4d6 + 7) acid damage. Any creature killed by this attack is drawn into Juiblex's\
...
- "desc": "Juiblex spews out a corrosive slime, targeting one creature that it can\
    ...
    \ the target is carrying or wearing takes a permanent −1 penalty to damage rolls.\
    \ The penalty worsens each time a target is subjected to this effect. If the penalty\
    \ on an object drops to −5, the object is destroyed. The penalty on an object\
    \ can be removed by the [mending](3-Mechanics/CLI/spells/mending.md) spell."
...
- "desc": "- Green Slime. A [green slime](3-Mechanics/CLI/traps-hazards/green-slime.md)\
    ...
    \ and slide 10 feet in a random direction determined by a dice:d8|noform|noparens|avg\
    ...
    \ burning slime takes dice:4d10|noform|noparens|avg|text(22) (4d10) fire damage.\
    \  \n- Sticky Slime. Juiblex slimes a square area of ground it can see within\
    \ the lair. The area can be up to 10 feet on a side. When the slime appears, each\
    \ creature in that area must succeed on a DC 21 Strength saving throw or become\
    \ [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained). When a creature\
    ...
    \ 1 round. Any creature that starts its turn in the burning slime takes dice:4d10|noform|noparens|avg|text(22)\
    \ (4d10) fire damage.  "
  "name": ""
"regional_effects":
