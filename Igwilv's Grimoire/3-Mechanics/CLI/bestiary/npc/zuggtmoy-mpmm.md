...
- "desc": "Zuggtmoy casts one of the following spells, requiring no material components\
    ...
    \ [detect magic](3-Mechanics/CLI/spells/detect-magic.md), [locate animals or plants](3-Mechanics/CLI/spells/locate-animals-or-plants.md)\n\
...
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    ...
    \ + 6) force damage plus dice:2d8|noform|noparens|avg|text(9) (2d8) poison\
    \ damage."
  "name": "Pseudopod"
"bonus_actions":
...
- "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ is [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) by her and can't be\
...
- "desc": "- Corrupted Nature. Within 6 miles of the lair, all Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine))\
    ...
    \ dies, these effects fade over the course of dice:1d10|noform|noparens|avg\
    \ (1d10) days.  "
  "name": ""
"source":
- "MPMM"
