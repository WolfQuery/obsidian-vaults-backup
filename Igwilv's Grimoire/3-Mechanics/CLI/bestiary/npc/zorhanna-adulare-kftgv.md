...
- "desc": "Zorhanna Adulare is an 18th-level spellcaster. Its spellcasting ability\
    \ is Intelligence (spell save DC 17, dice:1d20+9|noform|noparens|text(+9) to\
    \ hit with spell attacks). Zorhanna Adulare can cast [disguise self](3-Mechanics/CLI/spells/disguise-self.md)\
