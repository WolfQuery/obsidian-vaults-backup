...
---
# [Arlo Kettletoe (Levels 5-8)](3-Mechanics\CLI\bestiary\npc/arlo-kettletoe-levels-5-8-kftgv.md)
...
"cr": "3"
"traits":
- "desc": "Arlo Kettletoe has advantage on saving throws against being [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, Arlo Kettletoe can utter a special command or warning whenever\
    ...
    \ to its roll provided it can hear and understand Arlo Kettletoe. A creature can\
    \ benefit from only one Leadership die at a time. This effect ends if Arlo Kettletoe\
...
"source":
- "KftGV"
"image": "3-Mechanics/CLI/bestiary/npc/token/arlo-kettletoe-levels-5-8-kftgv.webp"
```
^statblock