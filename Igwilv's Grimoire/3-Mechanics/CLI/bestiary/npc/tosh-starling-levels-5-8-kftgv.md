...
- "desc": "On each of its turns, Tosh Starling can use a bonus action to take the\
  ...
  "name": "Cunning Action"
- "desc": "Tosh Starling deals an extra dice:2d6|noform|noparens|avg|text(7) (2d6)\
    \ damage when it hits a target with a weapon attack and has advantage on the attack\
    \ roll, or when the target is within 5 feet of an ally of Tosh Starling that isn't\
    \ [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) and Tosh\
    \ Starling doesn't have disadvantage on the attack roll."
