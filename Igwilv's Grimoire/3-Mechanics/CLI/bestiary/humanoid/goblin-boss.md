...
*Source: Monster Manual p. 166, The Wild Beyond the Witchlight, Keys from the Golden Vault*  
...
- "desc": "Melee or Ranged Weapon Attack: dice:1d20+2|noform|noparens|text(+2)\
    \ to hit, reach 5 ft. or range 30/120 ft., one target. Hit: dice:1d6|noform|noparens|avg|text(3)\
    \ (1d6) piercing damage."
  "name": "Javelin"
"reactions":
