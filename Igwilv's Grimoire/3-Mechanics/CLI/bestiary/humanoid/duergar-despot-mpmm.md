...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 5 ft., one target. Hit: dice:4d8+5|noform|noparens|avg|text(23) (4d8 +\
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    ...
    \ + 5) bludgeoning damage, or dice:3d10+5|noform|noparens|avg|text(21) (3d10\
    \ + 5) to a [prone](3-Mechanics/CLI/rules/conditions.md#Prone) target."
  "name": "Stomping Foot"
