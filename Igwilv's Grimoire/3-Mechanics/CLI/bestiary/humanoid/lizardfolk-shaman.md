...
- "desc": "The lizardfolk is a 5th-level spellcaster. Its spellcasting ability is\
    \ Wisdom (spell save DC 12, dice:1d20+4|noform|noparens|text(+4) to hit with\
    \ spell attacks). The lizardfolk has the following druid spells prepared:\n\n\
    Cantrips (at will): [druidcraft](3-Mechanics/CLI/spells/druidcraft.md), [produce\
    \ flame](3-Mechanics/CLI/spells/produce-flame.md), [thorn whip](3-Mechanics/CLI/spells/thorn-whip.md)\n\
...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ piercing damage, or dice:1d10+2|noform|noparens|avg|text(7) (1d10 + 2) piercing\
    \ damage in [crocodile](3-Mechanics/CLI/bestiary/beast/crocodile.md) form. If\
    \ the lizardfolk is in crocodile form and the target is a Large or smaller creature,\
    \ the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape\
    \ DC 12). Until this grapple ends, the target is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained),\
