...
- "desc": "The githyanki's innate spellcasting ability is Intelligence (spell save\
    \ DC 13, dice:1d20+5|noform|noparens|text(+5) to hit with spell attacks). It\
    ...
    \n3/day each: [jump](3-Mechanics/CLI/spells/jump.md), [misty step](3-Mechanics/CLI/spells/misty-step.md),\
    \ [nondetection](3-Mechanics/CLI/spells/nondetection.md) (self only), [tongues](3-Mechanics/CLI/spells/tongues.md)"
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 5 ft., one target. Hit: dice:2d6+6|noform|noparens|avg|text(13) (2d6 +\
    \ 6) slashing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) psychic\
    \ damage. This is a magic weapon attack. On a critical hit against a target in\
    \ an astral body (as with the [astral projection](3-Mechanics/CLI/spells/astral-projection.md)\
