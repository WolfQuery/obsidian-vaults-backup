...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    \ 5 ft., one target. Hit: dice:2d8+3|noform|noparens|avg|text(11) (2d8 +\
    \ 3) piercing damage."
  "name": "Morningstar"
- "desc": "Melee or Ranged Weapon Attack: dice:1d20+5|noform|noparens|text(+5)\
    \ to hit, reach 5 ft. or range 30/120 ft., one target. Hit: dice:2d6+3|noform|noparens|avg|text(9)\
    \ (2d6 + 3) piercing damage in melee or dice:1d6+3|noform|noparens|avg|text(5)\
    \ (1d6 + 3) piercing damage at range."
  "name": "Javelin"
"source":
- "MM"
