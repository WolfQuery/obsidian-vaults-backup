...
- "desc": "Melee Weapon Attack: dice:1d20+2|noform|noparens|text(+2) to hit, reach\
    ...
    \ damage."
  "name": "Club"
- "desc": "Ranged Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit (the\
    \ target gains no benefit from less than total cover), range 320 ft., one target.\
    \ Hit: dice:1d8+3|noform|noparens|avg|text(7) (1d8 + 3) piercing damage.\
    \ Hit or Miss: Immediately after making this attack, the harengon can use the\
    \ Hide action."
  "name": "Light Crossbow"
"source":
- "WBtW"
