...
- "desc": "The kuo-toa is a 10th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ attacks). The kuo-toa has the following cleric spells prepared:\n\nCantrips\
    \ (at will): [guidance](3-Mechanics/CLI/spells/guidance.md), [sacred flame](3-Mechanics/CLI/spells/sacred-flame.md),\
    \ [thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy.md)\n\n1st level (4 slots):\
    \ [detect magic](3-Mechanics/CLI/spells/detect-magic.md), [sanctuary](3-Mechanics/CLI/spells/sanctuary.md),\
...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ bludgeoning damage plus dice:4d6|noform|noparens|avg|text(14) (4d6) lightning\
    \ damage."
  "name": "Scepter"
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
