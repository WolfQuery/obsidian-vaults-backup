...
"cr": "3"
"traits":
- "desc": "Once per turn, the hobgoblin can deal an extra dice:3d6|noform|noparens|avg|text(10)\
    \ (3d6) damage to a creature it hits with a weapon attack if that creature is\
