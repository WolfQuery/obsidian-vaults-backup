...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ or suffer one of the following effects (choose one or roll a dice:d6|noform|noparens|avg\
    \ (d6)):\n\n- 1–2 Decay. The target takes dice:4d10|noform|noparens|avg|text(22)\
