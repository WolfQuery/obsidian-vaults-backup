...
- "desc": "The orc is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ attacks). The orc has the following cleric spells prepared:\n\nCantrips (at\
    \ will): [guidance](3-Mechanics/CLI/spells/guidance.md), [resistance](3-Mechanics/CLI/spells/resistance.md),\
...
- "desc": "Melee or Ranged Weapon Attack: dice:1d20+5|noform|noparens|text(+5)\
    \ to hit, reach 5 ft. or range 20/60 ft., one target. Hit: 11 (dice:1d6+3|noform|noparens|avg\
    \ (1d6 + 3) plus dice:1d8|noform|noparens|avg (1d8)) piercing damage, or\
    \ dice:2d8+3|noform|noparens|avg|text(12) (2d8 + 3) piercing damage if used\
