...
*Source: Monster Manual p. 343, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "If the assassin is subjected to an effect that allows it to make a Dexterity\
  ...
  "name": "Evasion"
- "desc": "The assassin deals an extra dice:4d6|noform|noparens|avg|text(14) (4d6)\
    \ damage when it hits a target with a weapon attack and has advantage on the attack\
    \ roll, or when the target is within 5 feet of an ally of the assassin that isn't\
    \ [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) and the assassin\
