...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    ...
    \ 5) slashing damage, plus dice:2d6|noform|noparens|avg|text(7) (2d6) slashing\
    \ damage if the champion has more than half of its total hit points remaining."
  "name": "Greatsword"
- "desc": "Ranged Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit,\
    ...
    \ piercing damage if the champion has more than half of its total hit points remaining."
  "name": "Shortbow"
"bonus_actions":
