...
*Source: Monster Manual p. 186, Lost Mine of Phandelver, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"cr": "1/2"
"traits":
- "desc": "Once per turn, the hobgoblin can deal an extra dice:2d6|noform|noparens|avg|text(7)\
    \ (2d6) damage to a creature it hits with a weapon attack if that creature is\
...
- "desc": "Melee Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit, reach\
    ...
    \ slashing damage, or dice:1d10+1|noform|noparens|avg|text(6) (1d10 + 1) slashing\
