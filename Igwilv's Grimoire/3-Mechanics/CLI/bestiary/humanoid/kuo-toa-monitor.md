...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    ...
    \ bludgeoning damage plus dice:1d6|noform|noparens|avg|text(3) (1d6) lightning\
    \ damage, and the target can't take reactions until the end of the kuo-toa's next\
    \ turn."
  "name": "Unarmed Strike"
"source":
- "MM"
