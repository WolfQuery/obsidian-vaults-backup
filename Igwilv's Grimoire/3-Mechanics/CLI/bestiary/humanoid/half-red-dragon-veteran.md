...
- "desc": "Ranged Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit,\
    \ range 100/400 ft., one target. Hit: dice:1d10+1|noform|noparens|avg|text(6)\
    \ (1d10 + 1) piercing damage."
  "name": "Heavy Crossbow"
- "desc": "The veteran exhales fire in a 15-foot cone. Each creature in that area\
    \ must make a DC 15 Dexterity saving throw, taking dice:7d6|noform|noparens|avg|text(24)\
    \ (7d6) fire damage on a failed save, or half as much damage on a successful\
    \ one."
