...
- "desc": "The planetar's weapon attacks are magical. When the planetar hits with\
    \ any weapon, the weapon deals an extra dice:5d8|noform|noparens|avg (5d8)\
...
- "desc": "Melee Weapon Attack: dice:1d20+12|noform|noparens|text(+12) to hit,\
    \ reach 5 ft., one target. Hit: dice:4d6+7|noform|noparens|avg|text(21) (4d6\
    \ + 7) slashing damage plus dice:5d8|noform|noparens|avg|text(22) (5d8) radiant\
    \ damage."
  "name": "Greatsword"
- "desc": "The planetar touches another creature. The target magically regains dice:6d8+3|noform|noparens|avg|text(30)\
