...
*Source: Monster Manual p. 16, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The deva's weapon attacks are magical. When the deva hits with any weapon,\
    \ the weapon deals an extra dice:4d8|noform|noparens|avg (4d8) radiant damage\
...
- "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit, reach\
    ...
    \ bludgeoning damage plus dice:4d8|noform|noparens|avg|text(18) (4d8) radiant\
    \ damage."
  "name": "Mace"
- "desc": "The deva touches another creature. The target magically regains dice:4d8+2|noform|noparens|avg|text(20)\
    \ (4d8 + 2) hit points and is freed from any curse, disease, poison, blindness,\
    \ or deafness."
