...
- "desc": "The solar's weapon attacks are magical. When the solar hits with any weapon,\
    \ the weapon deals an extra dice:6d8|noform|noparens|avg (6d8) radiant damage\
...
- "desc": "Melee Weapon Attack: dice:1d20+15|noform|noparens|text(+15) to hit,\
    \ reach 5 ft., one target. Hit: dice:4d6+8|noform|noparens|avg|text(22) (4d6\
    \ + 8) slashing damage plus dice:6d8|noform|noparens|avg|text(27) (6d8) radiant\
    \ damage."
  "name": "Greatsword"
- "desc": "Ranged Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ range 150/600 ft., one target. Hit: dice:2d8+6|noform|noparens|avg|text(15)\
    \ (2d8 + 6) piercing damage plus dice:6d8|noform|noparens|avg|text(27) (6d8)\
    \ radiant damage. If the target is a creature that has 100 hit points or fewer,\
...
- "desc": "The solar releases its greatsword to hover magically in an unoccupied space\
  ...
  "name": "Flying Sword"
- "desc": "The solar touches another creature. The target magically regains dice:8d8+4|noform|noparens|avg|text(40)\
...
- "desc": "The solar emits magical, divine energy. Each creature of its choice in\
    \ a 10-foot radius must make a DC 23 Dexterity saving throw, taking dice:4d6|noform|noparens|avg|text(14)\
    \ (4d6) fire damage plus dice:4d6|noform|noparens|avg|text(14) (4d6) radiant\
