...
*Source: Monster Manual p. 294, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "If the unicorn moves at least 20 feet straight toward a target and then\
    \ hits it with a horn attack on the same turn, the target takes an extra dice:2d8|noform|noparens|avg|text(9)\
...
- "desc": "The unicorn touches another creature with its horn. The target magically\
    \ regains dice:2d8+2|noform|noparens|avg|text(11) (2d8 + 2) hit points. In\
    \ addition, the touch removes all diseases and neutralizes all poisons afflicting\
    \ the target."
...
- "desc": "The unicorn magically regains dice:2d8+2|noform|noparens|avg|text(11)\
    \ (2d8 + 2) hit points."
