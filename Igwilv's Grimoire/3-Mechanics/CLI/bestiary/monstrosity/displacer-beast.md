...
*Source: Monster Manual p. 81, The Wild Beyond the Witchlight, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 10 ft., one target. Hit: dice:1d6+4|noform|noparens|avg|text(7) (1d6 +\
    \ 4) bludgeoning damage plus dice:1d6|noform|noparens|avg|text(3) (1d6) piercing\
    \ damage."
  "name": "Tentacle"
"source":
- "MM"
