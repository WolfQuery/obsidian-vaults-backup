...
*Source: Monster Manual p. 131, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ 2) piercing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8) poison\
    \ damage. The target must succeed on a DC 11 Constitution saving throw or be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Ranged Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit,\
    \ range 30/60 ft., one Large or smaller creature. Hit: The creature is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
