...
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 10 ft., one target. Hit: dice:2d10+3|noform|noparens|avg|text(14) (2d10\
    \ + 3) piercing damage."
  "name": "Arm Spike"
- "desc": "Melee Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit, reach\
    \ 5 ft., one target. Hit: dice:4d10+3|noform|noparens|avg|text(25) (4d10\
    ...
    \ and it takes dice:6d8|noform|noparens|avg|text(27) (6d8) psychic damage\
...
- "desc": "If the sorrowsworn takes damage, the creature [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
    \ by Embrace takes dice:4d8|noform|noparens|avg|text(18) (4d8) psychic damage."
