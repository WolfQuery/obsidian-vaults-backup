...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one target. Hit: dice:4d12+4|noform|noparens|avg|text(30) (4d12\
    \ + 4) piercing damage."
  "name": "Bite"
- "desc": "If the bulette jumps at least 15 feet as part of its movement, it can then\
    ...
    \ and take dice:3d6+4|noform|noparens|avg|text(14) (3d6 + 4) bludgeoning damage\
    \ plus dice:3d6+4|noform|noparens|avg|text(14) (3d6 + 4) slashing damage.\
