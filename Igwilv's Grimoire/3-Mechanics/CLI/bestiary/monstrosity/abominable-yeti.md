...
- "desc": "Melee Weapon Attack: dice:1d20+11|noform|noparens|text(+11) to hit,\
    ...
    \ + 7) slashing damage plus dice:2d6|noform|noparens|avg|text(7) (2d6) cold\
    \ damage."
  "name": "Claw"
- "desc": "The yeti targets one creature it can see within 30 feet of it. If the target\
    ...
    \ against this magic or take dice:6d6|noform|noparens|avg|text(21) (6d6) cold\
    \ damage and then be [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
- "desc": "The yeti exhales a 30-foot cone of frigid air. Each creature in that area\
    \ must make a DC 18 Constitution saving throw, taking dice:10d8|noform|noparens|avg|text(45)\
