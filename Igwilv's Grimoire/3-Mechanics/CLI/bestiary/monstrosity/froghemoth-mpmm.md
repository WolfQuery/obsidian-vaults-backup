...
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 5 ft., one target. Hit: dice:3d10+6|noform|noparens|avg|text(22) (3d10\
    ...
    \ cover against attacks and other effects outside the froghemoth, and takes dice:3d6|noform|noparens|avg|text(10)\
  ...
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+10|noform|noparens|text(+10) to hit,\
    \ reach 20 ft., one target. Hit: dice:3d8+6|noform|noparens|avg|text(19) (3d8\
    \ + 6) bludgeoning damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
