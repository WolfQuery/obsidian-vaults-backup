...
- "desc": "Melee Weapon Attack: dice:1d20+8|noform|noparens|text(+8) to hit, reach\
    \ 10 ft., one creature. Hit: dice:1d4+2|noform|noparens|avg|text(4) (1d4\
    ...
    \ Until this poison ends, the target is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed).\
