...
*Source: Monster Manual p. 249, Lost Mine of Phandelver, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one creature. Hit: dice:1d10+5|noform|noparens|avg|text(10) (1d10\
    \ + 5) piercing damage."
  "name": "Beak"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
