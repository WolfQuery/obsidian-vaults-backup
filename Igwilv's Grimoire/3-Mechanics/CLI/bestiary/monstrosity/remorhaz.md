...
- "desc": "A creature that touches the remorhaz or hits it with a melee attack while\
    \ within 5 feet of it takes dice:3d6|noform|noparens|avg|text(10) (3d6) fire\
    \ damage."
  "name": "Heated Body"
"actions":
- "desc": "Melee Weapon Attack: dice:1d20+11|noform|noparens|text(+11) to hit,\
    \ reach 10 ft., one target. Hit: dice:6d10+7|noform|noparens|avg|text(40)\
    \ (6d10 + 7) piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6)\
    \ fire damage. If the target is a creature, it is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
...
- "desc": "The remorhaz makes one bite attack against a Medium or smaller creature\
    ...
    \ cover against attacks and other effects outside the remorhaz, and it takes dice:6d6|noform|noparens|avg|text(21)\
