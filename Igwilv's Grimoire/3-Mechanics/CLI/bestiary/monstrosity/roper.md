...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one target. Hit: dice:4d8+4|noform|noparens|avg|text(22) (4d8 +\
    \ 4) piercing damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 50 ft., one creature. Hit: The target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
