...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one creature. Hit: dice:1d6+4|noform|noparens|avg|text(7) (1d6 +\
    \ 4) piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6) poison\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
...
- "desc": "Ranged Weapon Attack: dice:1d20+6|noform|noparens|text(+6) to hit,\
    \ range 150/600 ft., one target. Hit: dice:2d8+3|noform|noparens|avg|text(12)\
    \ (2d8 + 3) piercing damage plus dice:3d6|noform|noparens|avg|text(10) (3d6)\
    \ poison damage."
