...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ bludgeoning damage."
  "name": "Unarmed Strike"
- "desc": "The sea spawn uses one of the following options (choose one or roll a dice:d6|noform|noparens|avg\
    \ (d6)):\n\n- 1–2 Bite. Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4)\
    \ to hit, reach 5 ft., one target. Hit: dice:1d4+2|noform|noparens|avg|text(4)\
    \ (1d4 + 2) piercing damage.  \n- 3–4 Poison Quills. Melee Weapon Attack:\
    \ dice:1d20+4|noform|noparens|text(+4) to hit, reach 5 ft., one creature. Hit:\
    \ dice:1d6|noform|noparens|avg|text(3) (1d6) poison damage, and the target\
    ...
    \ Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach 10 ft.,\
    \ one target. Hit: dice:1d6+2|noform|noparens|avg|text(5) (1d6 + 2) bludgeoning\
