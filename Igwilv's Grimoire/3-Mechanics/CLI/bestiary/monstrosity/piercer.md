...
- "desc": "The piercer can climb difficult surfaces, including upside down on ceilings,\
  ...
  "name": "Spider Climb"
"actions":
- "desc": "Melee Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit, one\
    \ creature directly underneath the piercer. Hit: dice:1d6|noform|noparens|avg|text(3)\
    \ (1d6) piercing damage per 10 feet fallen, up to dice:6d6|noform|noparens|avg|text(21)\
