...
- "desc": "One Large or smaller creature within 10 feet of the trapper must succeed\
    ...
    \ (3d6 + 3) bludgeoning damage plus dice:1d6|noform|noparens|avg|text(3) (1d6)\
    \ acid damage at the start of each of its turns. While [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
