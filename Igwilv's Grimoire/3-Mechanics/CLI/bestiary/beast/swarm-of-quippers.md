...
*Source: Monster Manual p. 338, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    \ 0 ft., one creature in the swarm's space. Hit: dice:4d6|noform|noparens|avg|text(14)\
    \ (4d6) piercing damage, or dice:2d6|noform|noparens|avg|text(7) (2d6) piercing\
