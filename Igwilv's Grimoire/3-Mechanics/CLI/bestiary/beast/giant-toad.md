...
*Source: Monster Manual p. 329, The Wild Beyond the Witchlight, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ 2) piercing damage plus dice:1d10|noform|noparens|avg|text(5) (1d10) poison\
...
- "desc": "The toad makes one bite attack against a Medium or smaller target it is\
    ...
    \ cover against attacks and other effects outside the toad, and it takes dice:3d6|noform|noparens|avg|text(10)\
