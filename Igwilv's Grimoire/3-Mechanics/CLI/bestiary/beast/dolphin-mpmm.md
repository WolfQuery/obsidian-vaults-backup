...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ bludgeoning damage. If the dolphin moved at least 30 feet straight toward the\
    \ target immediately before the hit, the target takes an extra dice:1d6|noform|noparens|avg|text(3)\
