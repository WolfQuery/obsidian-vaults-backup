...
*Source: Monster Manual p. 284, Lost Mine of Phandelver, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ the target loses dice:1d4+3|noform|noparens|avg|text(5) (1d4 + 3) hit points\
