...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ piercing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8) poison damage,\
    \ and the creature is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
    \ until the start of the troll's next turn."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one target. Hit: dice:2d6+4|noform|noparens|avg|text(11) (2d6 +\
    \ 4) slashing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8) poison\
    \ damage."
  "name": "Claws"
- "desc": "The troll slices itself with a claw, releasing a spray of poison in a 15-foot\
    \ cube. The troll takes dice:2d6|noform|noparens|avg|text(7) (2d6) slashing\
    \ damage (this damage can't be reduced in any way). Each creature in the area\
    \ must make a DC 16 Constitution saving throw. On a failed save, a creature takes\
    \ dice:4d8|noform|noparens|avg|text(18) (4d8) poison damage and is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
