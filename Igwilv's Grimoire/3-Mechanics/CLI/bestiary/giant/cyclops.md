...
*Source: Monster Manual p. 45, The Wild Beyond the Witchlight. Available in the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    \ 10 ft., one target. Hit: dice:3d8+6|noform|noparens|avg|text(19) (3d8 +\
    \ 6) bludgeoning damage."
  "name": "Greatclub"
- "desc": "Ranged Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit,\
    \ range 30/120 ft., one target. Hit: dice:4d10+6|noform|noparens|avg|text(28)\
