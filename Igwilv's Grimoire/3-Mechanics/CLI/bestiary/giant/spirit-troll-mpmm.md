...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    \ 5 ft., one creature. Hit: dice:3d10+3|noform|noparens|avg|text(19) (3d10\
    \ + 3) psychic damage, and the target must succeed on a DC 15 Wisdom saving throw\
    \ or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) for 1 minute. The\
    \ [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) target can repeat the\
