...
*Source: Monster Manual p. 237, Lost Mine of Phandelver, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee or Ranged Weapon Attack: dice:1d20+6|noform|noparens|text(+6)\
    \ to hit, reach 5 ft. or range 30/120 ft., one target. Hit: dice:2d6+4|noform|noparens|avg|text(11)\
