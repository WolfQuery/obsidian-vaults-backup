...
- "desc": "The gas spore explodes when it drops to 0 hit points. Each creature within\
    \ 20 feet of it must succeed on a DC 15 Constitution saving throw or take dice:3d6|noform|noparens|avg|text(10)\
    ...
    \ killing the creature in a number of hours equal to dice:1d12|noform|noparens|avg\
    \ (1d12) + the creature's Constitution score, unless the disease is removed.\
    \ In half that time, the creature becomes [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
    \ for the rest of the duration. After the creature dies, it sprouts dice:2d4|noform|noparens|avg\
...
- "desc": "Melee Weapon Attack: dice:1d20+0|noform|noparens|text(+0) to hit, reach\
    \ 5 ft., one creature. Hit: 1 poison damage, and the creature must succeed on\
    \ a DC 10 Constitution saving throw or become infected with the disease described\
    \ in the Death Burst trait."
  "name": "Touch"
"source":
- "MM"
