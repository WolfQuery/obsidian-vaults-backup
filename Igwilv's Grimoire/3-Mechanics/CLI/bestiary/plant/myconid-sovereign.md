...
*Source: Monster Manual p. 232, Keys from the Golden Vault*  
...
- "desc": "Melee Weapon Attack: dice:1d20+3|noform|noparens|text(+3) to hit, reach\
    \ 5 ft., one target. Hit: dice:3d4+1|noform|noparens|avg|text(8) (3d4 + 1)\
    \ bludgeoning damage plus dice:3d4|noform|noparens|avg|text(7) (3d4) poison\
    \ damage."
  "name": "Fist"
- "desc": "The myconid targets one corpse of a humanoid or a Large or smaller beast\
    ...
    \ rises as a spore servant. The corpse stays animated for dice:1d4+1|noform|noparens|avg\
