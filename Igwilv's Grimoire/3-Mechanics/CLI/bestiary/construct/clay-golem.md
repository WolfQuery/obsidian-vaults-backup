...
*Source: Monster Manual p. 168, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Whenever the golem starts its turn with 60 hit points or fewer, roll a\
    \ dice:d6|noform|noparens|avg (d6). On a 6, the golem goes berserk. On each\
