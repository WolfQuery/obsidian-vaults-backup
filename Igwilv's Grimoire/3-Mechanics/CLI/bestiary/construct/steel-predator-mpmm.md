...
- "desc": "Melee Weapon Attack: dice:1d20+12|noform|noparens|text(+12) to hit,\
    \ reach 5 ft., one target. Hit: dice:2d10+7|noform|noparens|avg|text(18) (2d10\
    \ + 7) lightning damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+12|noform|noparens|text(+12) to hit,\
    \ reach 5 ft., one target. Hit: dice:2d8+7|noform|noparens|avg|text(16) (2d8\
    \ + 7) force damage."
  "name": "Claw"
- "desc": "The steel predator emits a roar in a 60-foot cone. Each creature in that\
    ...
    \ everything it's holding, and is [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned)\
