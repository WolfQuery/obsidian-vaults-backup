...
- "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ save, a creature takes dice:4d12|noform|noparens|avg|text(26) (4d12) bludgeoning\
    \ damage and is knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). On\
    \ a successful save, a creature takes half as much damage and isn't knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone)."
  "name": "Crushing Leap"
"source":
- "TCE"
