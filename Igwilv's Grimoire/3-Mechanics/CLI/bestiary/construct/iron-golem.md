...
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 5 ft., one target. Hit: dice:3d8+7|noform|noparens|avg|text(20) (3d8\
...
- "desc": "The golem exhales poisonous gas in a 15-foot cone. Each creature in that\
    \ area must make a DC 19 Constitution saving throw, taking dice:10d8|noform|noparens|avg|text(45)\
