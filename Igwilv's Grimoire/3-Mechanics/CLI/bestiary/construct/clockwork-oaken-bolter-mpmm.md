...
- "desc": "Ranged Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit,\
    ...
    \ (1d10 + 4) piercing damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
    ...
    \ that bring it closer to the clockwork. A creature takes dice:1d10|noform|noparens|avg|text(5)\
    \ (1d10) slashing damage if it escapes from the grapple or if it tries and fails.\
    \ The clockwork can grapple only one creature at a time with its harpoon."
  "name": "Harpoon"
- "desc": "The clockwork launches an explosive charge at a point within 120 feet.\
    ...
    \ DC 15 Dexterity saving throw, taking dice:5d6|noform|noparens|avg|text(17)\
