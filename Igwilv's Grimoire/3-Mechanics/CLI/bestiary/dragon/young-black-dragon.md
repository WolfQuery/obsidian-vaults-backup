...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ + 4) piercing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8) acid\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
...
- "desc": "The dragon exhales acid in a 30-foot line that is 5 feet wide. Each creature\
    \ in that line must make a DC 14 Dexterity saving throw, taking dice:11d8|noform|noparens|avg|text(49)\
