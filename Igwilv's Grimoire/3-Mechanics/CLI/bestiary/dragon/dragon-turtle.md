...
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 15 ft., one target. Hit: dice:3d12+7|noform|noparens|avg|text(26)\
    \ (3d12 + 7) piercing damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 10 ft., one target. Hit: dice:2d8+7|noform|noparens|avg|text(16) (2d8\
    \ + 7) slashing damage."
  "name": "Claw"
- "desc": "Melee Weapon Attack: dice:1d20+13|noform|noparens|text(+13) to hit,\
    \ reach 15 ft., one target. Hit: dice:3d12+7|noform|noparens|avg|text(26)\
...
- "desc": "The dragon turtle exhales scalding steam in a 60-foot cone. Each creature\
    \ in that area must make a DC 18 Constitution saving throw, taking dice:15d6|noform|noparens|avg|text(52)\
