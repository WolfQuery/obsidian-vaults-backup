...
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
    ...
    \ + 5) piercing damage plus dice:1d10|noform|noparens|avg|text(5) (1d10)\
    \ lightning damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+9|noform|noparens|text(+9) to hit, reach\
...
- "desc": "The dragon exhales lightning in a 60-foot line that is 5 feet wide. Each\
    \ creature in that line must make a DC 16 Dexterity saving throw, taking dice:10d10|noform|noparens|avg|text(55)\
