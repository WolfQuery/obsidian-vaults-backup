...
- "desc": "The dragon uses one of the following breath weapons:\n\n- Fire Breath.\
    ...
    \ in that line must make a DC 21 Dexterity saving throw, taking dice:16d6|noform|noparens|avg|text(56)\
    ...
    \ or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) for 10\
...
- "desc": "At your discretion, a legendary ([adult](3-Mechanics/CLI/bestiary/dragon/adult-brass-dragon.md)\
    ...
    \ one creature within 5 feet of it, with a +7 bonus to hit and dealing dice:3d6|noform|noparens|avg|text(10)\
...
- "desc": "- Tracks appear in the sand within 6 miles of the dragon's lair. The tracks\
  ...
  "name": ""
- "desc": "If the dragon dies, the tracks fade in dice:1d10|noform|noparens|avg\
    \ (1d10) days, but the other effects fade immediately."
  "name": ""
