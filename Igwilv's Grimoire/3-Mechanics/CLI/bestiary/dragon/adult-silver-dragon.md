...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Cold Breath.\
    ...
    \ must make a DC 20 Constitution saving throw, taking dice:13d8|noform|noparens|avg|text(58)\
    \ (13d8) cold damage on a failed save, or half as much damage on a successful\
...
- "desc": "- The dragon creates fog as if it had cast the [fog cloud](3-Mechanics/CLI/spells/fog-cloud.md)\
    ...
    \ of the dragon must succeed on a DC 15 Constitution saving throw or take dice:1d10|noform|noparens|avg|text(5)\
