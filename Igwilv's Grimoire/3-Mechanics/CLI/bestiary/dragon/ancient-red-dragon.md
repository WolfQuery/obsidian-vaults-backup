...
- "desc": "Melee Weapon Attack: dice:1d20+17|noform|noparens|text(+17) to hit,\
    ...
    \ (2d10 + 10) piercing damage plus dice:4d6|noform|noparens|avg|text(14) (4d6)\
    \ fire damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+17|noform|noparens|text(+17) to hit,\
...
- "desc": "The dragon exhales fire in a 90-foot cone. Each creature in that area must\
    \ make a DC 24 Dexterity saving throw, taking dice:26d6|noform|noparens|avg|text(91)\
...
- "desc": "The dragon beats its wings. Each creature within 15 feet of the dragon\
    \ must succeed on a DC 25 Dexterity saving throw or take dice:2d6+10|noform|noparens|avg|text(17)\
...
- "desc": "- Magma erupts from a point on the ground the dragon can see within 120\
    ...
    \ the geyser's area must make a DC 15 Dexterity saving throw, taking dice:6d6|noform|noparens|avg|text(21)\
...
- "desc": "At your discretion, a legendary ([adult](3-Mechanics/CLI/bestiary/dragon/adult-red-dragon.md)\
    ...
    \ saving throw, taking dice:3d6|noform|noparens|avg|text(10) (3d6) fire damage\
    \ on a failed save, or half as much damage on a successful one. The heat lasts\
