...
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
    ...
    \ + 4) piercing damage plus dice:1d8|noform|noparens|avg|text(4) (1d8) cold\
    \ damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+7|noform|noparens|text(+7) to hit, reach\
...
- "desc": "The dragon exhales an icy blast in a 30-foot cone. Each creature in that\
    \ area must make a DC 15 Constitution saving throw, taking dice:10d8|noform|noparens|avg|text(45)\
