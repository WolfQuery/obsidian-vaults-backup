...
- "desc": "The dragon exhales a puff of euphoria gas at one creature within 5 feet\
    ...
    \ turn:\n\n1–4. The target takes no action or bonus action and uses all of its\
    \ movement to move in a random direction.\n\n5–6. The target doesn't move, and\
    \ the only thing it can do on its turn is make a DC 11 Wisdom saving throw, ending\
