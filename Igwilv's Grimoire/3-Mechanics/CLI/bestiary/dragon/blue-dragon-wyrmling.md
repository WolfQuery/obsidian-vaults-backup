...
- "desc": "Melee Weapon Attack: dice:1d20+5|noform|noparens|text(+5) to hit, reach\
    ...
    \ 3) piercing damage plus dice:1d6|noform|noparens|avg|text(3) (1d6) lightning\
    \ damage."
  "name": "Bite"
- "desc": "The dragon exhales lightning in a 30-foot line that is 5 feet wide. Each\
    \ creature in that line must make a DC 12 Dexterity saving throw, taking dice:4d10|noform|noparens|avg|text(22)\
