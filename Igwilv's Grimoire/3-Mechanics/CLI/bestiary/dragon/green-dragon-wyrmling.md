...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ 2) piercing damage plus dice:1d6|noform|noparens|avg|text(3) (1d6) poison\
    \ damage."
  "name": "Bite"
- "desc": "The dragon exhales poisonous gas in a 15-foot cone. Each creature in that\
    \ area must make a DC 11 Constitution saving throw, taking dice:6d6|noform|noparens|avg|text(21)\
