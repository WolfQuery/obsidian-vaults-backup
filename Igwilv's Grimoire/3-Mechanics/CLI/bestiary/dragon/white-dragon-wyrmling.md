...
- "desc": "Melee Weapon Attack: dice:1d20+4|noform|noparens|text(+4) to hit, reach\
    ...
    \ 2) piercing damage plus dice:1d4|noform|noparens|avg|text(2) (1d4) cold\
    \ damage."
  "name": "Bite"
- "desc": "The dragon exhales an icy blast of hail in a 15-foot cone. Each creature\
    \ in that area must make a DC 12 Constitution saving throw, taking dice:5d8|noform|noparens|avg|text(22)\
