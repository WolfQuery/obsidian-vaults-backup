...
- "desc": "Melee Weapon Attack: dice:1d20+11|noform|noparens|text(+11) to hit,\
    ...
    \ (2d10 + 6) piercing damage plus dice:1d6|noform|noparens|avg|text(3) (1d6)\
    \ necrotic damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice:1d20+11|noform|noparens|text(+11) to hit,\
...
- "desc": "The dragon exhales shadowy fire in a 30-foot cone. Each creature in that\
    \ area must make a DC 18 Dexterity saving throw, taking dice:16d6|noform|noparens|avg|text(56)\
    \ (16d6) necrotic damage on a failed save, or half as much damage on a successful\
    \ one. A humanoid reduced to 0 hit points by this damage dies, and an undead [shadow](3-Mechanics/CLI/bestiary/undead/shadow.md)\
