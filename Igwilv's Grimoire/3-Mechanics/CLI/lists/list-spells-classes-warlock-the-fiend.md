...
- [Command](3-Mechanics/CLI/spells/command.md "PHB") with access to 2nd-level spells

## 2nd Level

- [Blindness/Deafness](3-Mechanics/CLI/spells/blindness-deafness.md "PHB") with access to 2nd-level spells
...
- [Stinking Cloud](3-Mechanics/CLI/spells/stinking-cloud.md "PHB") with access to 2nd-level spells

## 4th Level

- [Fire Shield](3-Mechanics/CLI/spells/fire-shield.md "PHB") with access to 2nd-level spells
- [Wall of Fire](3-Mechanics/CLI/spells/wall-of-fire.md "PHB") with access to 2nd-level spells

## 5th Level

- [Flame Strike](3-Mechanics/CLI/spells/flame-strike.md "PHB") with access to 2nd-level spells
- [Hallow](3-Mechanics/CLI/spells/hallow.md "PHB") with access to 2nd-level spells