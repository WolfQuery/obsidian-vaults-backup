...
The homunculus regains `dice:2d6|noform|noparens|avg` (`2d6`) hit points if the [mending](3-Mechanics/CLI/spells/mending.md) spell is cast on it. If you or the homunculus dies, it vanishes, leaving its heart in its space.