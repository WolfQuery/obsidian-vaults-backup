...
***Bolt.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 120/480 ft., one target. *Hit:* 16 (`dice:3d10|noform|noparens|avg` (`3d10`)) piercing damage.
```
^statblock