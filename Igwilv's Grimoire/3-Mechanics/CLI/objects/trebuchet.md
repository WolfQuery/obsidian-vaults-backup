...
***Trebuchet Stone.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 300/1,200 ft. (can't hit targets within 60 feet of it), one target. *Hit:* 44 (`dice:8d10|noform|noparens|avg` (`8d10`)) bludgeoning damage.
```
^statblock