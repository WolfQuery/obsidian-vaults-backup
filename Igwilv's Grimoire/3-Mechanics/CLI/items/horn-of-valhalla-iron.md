...
The iron horn summons `dice:5d4+5|noform|noparens|avg` (`5d4 + 5`) [berserkers](3-Mechanics/CLI/bestiary/humanoid/berserker.md). To use the iron horn, you must be proficient with all martial weapons.
