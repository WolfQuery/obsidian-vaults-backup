...
Characters can also find a cookbook that contains formulas for common and uncommon potions. A character can brew such a potion by following the rules for [crafting magic items](3-Mechanics/CLI/rules/variant-rules/downtime-activity-crafting-a-magic-item.md) in the "Dungeon Master's Guide".
...
The toadstools are the tips of the hats worn by six [redcaps](3-Mechanics/CLI/bestiary/fey/redcap-vgm.md) (see appendix C) that are forming under the earth. Any creature that tries to pick a toadstool causes its redcap to rise up out of the earth, outraged at being awakened early. This redcap is not fully formed and has half its normal hit points.
