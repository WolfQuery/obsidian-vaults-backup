...
Magic causes each candle to float `dice:1d4+3|noform|noparens|avg` (`1d4 + 3`) feet above the floor. Casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic.md) on a candle or removing a candle from the library automatically ends the levitation effect on it.
...
| Jewel | Creature |
|-------|----------|
| Black | Spymaster Hushknife, a [darkling elder](3-Mechanics/CLI/bestiary/fey/darkling-elder-vgm.md) (see appendix C) |
| Blue | Allegra, a [quickling](3-Mechanics/CLI/bestiary/fey/quickling-vgm.md) (see appendix C) |
| Green | Frogspittle, a [green hag](3-Mechanics/CLI/bestiary/fey/green-hag.md) |
| Red | Sinch the Ruthless, a [redcap](3-Mechanics/CLI/bestiary/fey/redcap-vgm.md) (see appendix C) |
