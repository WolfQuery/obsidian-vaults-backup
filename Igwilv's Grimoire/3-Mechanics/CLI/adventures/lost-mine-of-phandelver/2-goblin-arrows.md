...
The hot coals in the central fire pit deal 1 fire damage to any creature that enters the fire pit, or `dice:1d6|noform|noparens|avg` (`1d6`) fire damage to any creature that falls [prone](3-Mechanics/CLI/rules/conditions.md#Prone) there. A creature can take each type of damage only once per round.
