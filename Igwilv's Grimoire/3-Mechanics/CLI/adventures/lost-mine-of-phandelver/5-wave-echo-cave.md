...
| Roll | Result |
|------|--------|
| 1-3 | [Stirges](3-Mechanics/CLI/bestiary/beast/stirge.md) (`dice:2d4\|noform\|noparens\|avg` (`2d4`)) |
| 4-5 | [Ghouls](3-Mechanics/CLI/bestiary/undead/ghoul.md) (`dice:1d4\|noform\|noparens\|avg` (`1d4`)) |
| 6 | [Gricks](3-Mechanics/CLI/bestiary/monstrosity/grick.md) (`dice:1d4\|noform\|noparens\|avg` (`1d4`)) |
| 7-8 | [Bugbears](3-Mechanics/CLI/bestiary/humanoid/bugbear.md) (`dice:1d4\|noform\|noparens\|avg` (`1d4`)) |
| 9 | [Skeletons](3-Mechanics/CLI/bestiary/undead/skeleton.md) (`dice:1d6\|noform\|noparens\|avg` (`1d6`)) |
| 10 | [Zombies](3-Mechanics/CLI/bestiary/undead/zombie.md) (`dice:1d6\|noform\|noparens\|avg` (`1d6`)) |
...
The escarpments are 10 feet high and require a successful DC 12 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to climb. A creature that falls or is knocked from the top of a ledge takes `dice:1d6|noform|noparens|avg` (`1d6`) bludgeoning damage and lands [prone](3-Mechanics/CLI/rules/conditions.md#Prone).
...
A successful DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check identifies the brazier as the source of the magic that suffuses the surrounding caverns. This magic has waned over the years, to the extent that it can no longer be harnessed to permanently enchant magic items. However, any nonmagical weapon or armor bathed in the green flame for at least 1 minute becomes a [+1 weapon](3-Mechanics/CLI/items/1-weapon.md) or [+1 armor](3-Mechanics/CLI/items/1-armor.md), respectively, for `dice:1d12|noform|noparens|avg` (`1d12`) hours. The brazier cannot be removed from the Forge of Spells.
