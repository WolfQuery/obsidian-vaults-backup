...
- (a) a [mace](/3-Mechanics/CLI/Compendium/items/mace.md) or (b) a [warhammer](/3-Mechanics/CLI/Compendium/items/warhammer.md) (if proficient)
- (a) [scale mail](/3-Mechanics/CLI/Compendium/items/scale-mail.md), (b) [leather armor](/3-Mechanics/CLI/Compendium/items/leather-armor.md), or (c) [chain mail](/3-Mechanics/CLI/Compendium/items/chain-mail.md) (if proficient)
...
- A [shield](/3-Mechanics/CLI/Compendium/items/shield.md) and a [holy symbol](/3-Mechanics/CLI/Compendium/items/holy-symbol.md)
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](/3-Mechanics/CLI/Compendium/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](/3-Mechanics/CLI/Compendium/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
