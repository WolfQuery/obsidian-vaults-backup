...
When you adopt this specialization at 3rd level, you gain proficiency with [smith's tools](/3-Mechanics/CLI/Compendium/items/smiths-tools.md). If you already have this proficiency, you gain proficiency with one other type of [artisan's tools](/3-Mechanics/CLI/Compendium/items/artisans-tools.md) of your choice.
...
|-----------------|-------|
| 3rd | [heroism](/3-Mechanics/CLI/Compendium/spells/heroism.md), [shield](/3-Mechanics/CLI/Compendium/spells/shield.md) |
| 5th | [branding smite](/3-Mechanics/CLI/Compendium/spells/branding-smite.md), [warding bond](/3-Mechanics/CLI/Compendium/spells/warding-bond.md) |
| 9th | [aura of vitality](/3-Mechanics/CLI/Compendium/spells/aura-of-vitality.md), [conjure barrage](/3-Mechanics/CLI/Compendium/spells/conjure-barrage.md) |
| 13th | [aura of purity](/3-Mechanics/CLI/Compendium/spells/aura-of-purity.md), [fire shield](/3-Mechanics/CLI/Compendium/spells/fire-shield.md) |
| 17th | [banishing smite](/3-Mechanics/CLI/Compendium/spells/banishing-smite.md), [mass cure wounds](/3-Mechanics/CLI/Compendium/spells/mass-cure-wounds.md) |
^battle-smith-spells
...
By 3rd level, your tinkering has borne you a faithful companion, a [steel defender](/3-Mechanics/CLI/Compendium/bestiary/construct/steel-defender-tce.md). It is friendly to you and your companions, and it obeys your commands. See this creature's game statistics in the steel defender stat block, which uses your proficiency bonus (PB) in several places. You determine the creature's appearance and whether it has two legs or four; your choice has no effect on its game statistics.
...
If the [mending](/3-Mechanics/CLI/Compendium/spells/mending.md) spell is cast on it, it regains `dice:2d6|noform|noparens|avg` (`2d6`) hit points. If it has died within the last hour, you can use your [smith's tools](/3-Mechanics/CLI/Compendium/items/smiths-tools.md) as an action to revive it, provided you are within 5 feet of it and you expend a spell slot of 1st level or higher. The steel defender returns to life after 1 minute with all its hit points restored.

At the end of a long rest, you can create a new steel defender if you have your [smith's tools](/3-Mechanics/CLI/Compendium/items/smiths-tools.md) with you. If you already have a steel defender from this feature, the first one immediately perishes. The defender also perishes if you die.
