...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value">Infusions Known^<a href="/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ai.md">Optional features from [Artificer Infusion</a>; defined in Tasha's Cauldron of Everything]</th><th class="value">Infused Items</th><th class="value">Cantrips Known</th><th class="spellSlot">1st</th><th class="spellSlot">2nd</th><th class="spellSlot">3rd</th><th class="spellSlot">4th</th><th class="spellSlot">5th</th></tr>
> </thead><tbody>
...
- **Armor**: [light armor](/3-Mechanics/CLI/Rules/item-types.md#Light%20Armor), [medium armor](/3-Mechanics/CLI/Rules/item-types.md#Medium%20Armor), [shields](/3-Mechanics/CLI/Compendium/items/shield.md)
- **Weapons**: simple weapons, firearms (optional)
- **Tools**: [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md), [tinker's tools](/3-Mechanics/CLI/Compendium/items/tinkers-tools.md), one type of [artisan's tools](/3-Mechanics/CLI/Compendium/items/artisans-tools.md) of your choice
...
- a [light crossbow](/3-Mechanics/CLI/Compendium/items/light-crossbow.md) and [20 bolts](/3-Mechanics/CLI/Compendium/items/crossbow-bolts-20.md)
- (a) [studded leather armor](/3-Mechanics/CLI/Compendium/items/studded-leather-armor.md) or (b) [scale mail](/3-Mechanics/CLI/Compendium/items/scale-mail.md)
- [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) and a [dungeoneer's pack](/3-Mechanics/CLI/Compendium/items/dungeoneers-pack.md)
...
- **Armor**: [light armor](/3-Mechanics/CLI/Rules/item-types.md#Light%20Armor), [medium armor](/3-Mechanics/CLI/Rules/item-types.md#Medium%20Armor), [shields](/3-Mechanics/CLI/Compendium/items/shield.md)
- **Tools**: [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md), [tinker's tools](/3-Mechanics/CLI/Compendium/items/tinkers-tools.md)
...
If artificer isn't your initial class, here are the proficiencies you gain when you take your first level as an artificer: light armor, medium armor, shields, [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md), [tinker's tools](/3-Mechanics/CLI/Compendium/items/tinkers-tools.md).
...
Masters of unlocking magic in everyday objects, artificers are supreme inventors. They see magic as a complex system waiting to be decoded and controlled. Artificers use tools to channel arcane power, crafting magical objects. To cast a spell, an artificer could use [alchemist's supplies](/3-Mechanics/CLI/Compendium/items/alchemists-supplies.md) to create a potent elixir, [calligrapher's supplies](/3-Mechanics/CLI/Compendium/items/calligraphers-supplies.md) to inscribe a sigil of power on an ally's armor, or [tinker's tools](/3-Mechanics/CLI/Compendium/items/tinkers-tools.md) to craft a temporary charm. The magic of artificers is tied to their tools and their talents.
...
You can make an artificer quickly by following these suggestions. First, put your highest ability score in Intelligence, followed by Constitution or Dexterity. Second, choose the [guild artisan](/3-Mechanics/CLI/Compendium/backgrounds/guild-artisan.md) background.
...
You've learned how to invest a spark of magic into mundane objects. To use this ability, you must have [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) or [artisan's tools](/3-Mechanics/CLI/Compendium/items/artisans-tools.md) in hand. You then touch a Tiny nonmagical object as an action and give it one of the following magical properties of your choice:
...
You produce your artificer spell effects through your tools. You must have a spellcasting focus—specifically [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) or some kind of [artisan's tool](/3-Mechanics/CLI/Compendium/items/artisans-tools.md)—in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See "chapter 5", "Equipment," in the "Player's Handbook" for descriptions of these tools.

After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.

> [!note] The Magic of Artifice
> 
> As an artificer, you use tools when you cast your spells. When describing your spellcasting, think about how you're using a tool to perform the spell effect. If you cast [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md) using [alchemist's supplies](/3-Mechanics/CLI/Compendium/items/alchemists-supplies.md), you could be quickly producing a salve. If you cast it using [tinker's tools](/3-Mechanics/CLI/Compendium/items/tinkers-tools.md), you might have a miniature mechanical spider that binds wounds. When you cast [poison spray](/3-Mechanics/CLI/Compendium/spells/poison-spray.md), you could fling foul chemicals or use a wand that spits venom. The effect of the spell is the same as for a spellcaster of any other class, but your method of spellcasting is special.
> 
> The same principle applies when you prepare your spells. As an artificer, you don't study a spellbook or pray to prepare your spells. Instead, you work with your tools and create the specialized items you'll use to produce your effects. If you replace [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md) with [heat metal](/3-Mechanics/CLI/Compendium/spells/heat-metal.md), you might be altering the device you use to heal—perhaps modifying a tool so that it channels heat instead of healing energy.
> 
...
When you gain this feature, pick four artificer infusions to learn, choosing from the "Artificer Infusions^[Optional features from [Artificer Infusion](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ai.md); defined in Tasha's Cauldron of Everything]" section at the end of the class's description. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.
...
If an infusion ends on an item that contains other things, like a [bag of holding](/3-Mechanics/CLI/Compendium/items/bag-of-holding.md), its contents harmlessly appear in and around its space.
...
You've learned how to produce exactly the tool you need: with [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) or [artisan's tools](/3-Mechanics/CLI/Compendium/items/artisans-tools.md) in hand, you can magically create one set of [artisan's tools](/3-Mechanics/CLI/Compendium/items/artisans-tools.md) in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.
...
> ![Artificer Infusion](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ai.md#Artificer%20Infusion)
^list-optfeature-ai