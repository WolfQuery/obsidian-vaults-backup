...
- (a) a [quarterstaff](/3-Mechanics/CLI/Compendium/items/quarterstaff.md) or (b) a [dagger](/3-Mechanics/CLI/Compendium/items/dagger.md)
...
- (a) a [scholar's pack](/3-Mechanics/CLI/Compendium/items/scholars-pack.md) or (b) an [explorer's pack](/3-Mechanics/CLI/Compendium/items/explorers-pack.md)
- A [spellbook](/3-Mechanics/CLI/Compendium/items/spellbook.md)
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](/3-Mechanics/CLI/Compendium/backgrounds/sage.md) background. Third, choose the [mage hand](/3-Mechanics/CLI/Compendium/spells/mage-hand.md), [light](/3-Mechanics/CLI/Compendium/spells/light.md), and [ray of frost](/3-Mechanics/CLI/Compendium/spells/ray-of-frost.md) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md), [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md), [feather fall](/3-Mechanics/CLI/Compendium/spells/feather-fall.md), [mage armor](/3-Mechanics/CLI/Compendium/spells/mage-armor.md), [magic missile](/3-Mechanics/CLI/Compendium/spells/magic-missile.md), and [sleep](/3-Mechanics/CLI/Compendium/spells/sleep.md).
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/3-Mechanics/CLI/Compendium/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](/3-Mechanics/CLI/Compendium/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
