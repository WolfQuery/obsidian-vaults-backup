...
- You know the [guidance](/3-Mechanics/CLI/Compendium/spells/guidance.md) cantrip.  
- You have the [guiding bolt](/3-Mechanics/CLI/Compendium/spells/guiding-bolt.md) spell prepared. It counts as a druid spell for you, and it doesn't count against the number of spells you can have prepared.  
- You can cast [guiding bolt](/3-Mechanics/CLI/Compendium/spells/guiding-bolt.md) without expending a spell slot. You can do so a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.  
