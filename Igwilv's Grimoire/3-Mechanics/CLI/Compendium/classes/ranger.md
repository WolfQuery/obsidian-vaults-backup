...
- (a) [scale mail](/3-Mechanics/CLI/Compendium/items/scale-mail.md) or (b) [leather armor](/3-Mechanics/CLI/Compendium/items/leather-armor.md)
- (a) two [shortswords](/3-Mechanics/CLI/Compendium/items/shortsword.md) or (b) two simple melee weapons
...
- A [longbow](/3-Mechanics/CLI/Compendium/items/longbow.md) and a [quiver](/3-Mechanics/CLI/Compendium/items/quiver.md) of [20 arrows](/3-Mechanics/CLI/Compendium/items/arrows-20.md)
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](/3-Mechanics/CLI/Compendium/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/3-Mechanics/CLI/Compendium/bestiary/humanoid/gnoll.md) and [orcs](/3-Mechanics/CLI/Compendium/bestiary/humanoid/orc.md)) as favored enemies.
...
- [Archery](/3-Mechanics/CLI/Compendium/optional-features/archery.md)  
- [Defense](/3-Mechanics/CLI/Compendium/optional-features/defense.md)  
...
For example, if you know the 1st-level spell [animal friendship](/3-Mechanics/CLI/Compendium/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/3-Mechanics/CLI/Compendium/spells/animal-friendship.md) using either slot.
...
You can use a [druidic focus](/3-Mechanics/CLI/Compendium/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](/3-Mechanics/CLI/Compendium/spells/speak-with-animals.md) |
| 5th | [beast sense](/3-Mechanics/CLI/Compendium/spells/beast-sense.md) |
| 9th | [speak with plants](/3-Mechanics/CLI/Compendium/spells/speak-with-plants.md) |
| 13th | [locate creature](/3-Mechanics/CLI/Compendium/spells/locate-creature.md) |
| 17th | [commune with nature](/3-Mechanics/CLI/Compendium/spells/commune-with-nature.md) |
^primal-awareness-spells
...
> ![Fighting Style, Ranger](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-fs-r.md#Fighting%20Style,%20Ranger)
