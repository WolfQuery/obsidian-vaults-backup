...
At 6th level, you gain the ability to channel your ki into searing waves of energy. Immediately after you take the [Attack](/3-Mechanics/CLI/Rules/actions.md#Attack) action on your turn, you can spend 2 ki points to cast the [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md) spell as a bonus action.

You can spend additional ki points to cast [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md) as a higher-level spell. Each additional ki point you spend increases the spell's level by 1. The maximum number of ki points (2 plus any additional points) that you can spend on the spell equals half your monk level.
