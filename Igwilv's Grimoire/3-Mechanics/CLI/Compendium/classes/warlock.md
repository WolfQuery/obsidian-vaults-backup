...
- (a) a [scholar's pack](/3-Mechanics/CLI/Compendium/items/scholars-pack.md) or (b) a [dungeoneer's pack](/3-Mechanics/CLI/Compendium/items/dungeoneers-pack.md)
- [Leather armor](/3-Mechanics/CLI/Compendium/items/leather-armor.md), any simple weapon, and two [daggers](/3-Mechanics/CLI/Compendium/items/dagger.md)
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](/3-Mechanics/CLI/Compendium/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](/3-Mechanics/CLI/Compendium/spells/eldritch-blast.md) and [chill touch](/3-Mechanics/CLI/Compendium/spells/chill-touch.md) cantrips, along with the 1st-level spells [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md) and [witch bolt](/3-Mechanics/CLI/Compendium/spells/witch-bolt.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/3-Mechanics/CLI/Compendium/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/3-Mechanics/CLI/Compendium/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ei.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
> ![Eldritch Invocation](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei

> [!example]- Optional Features: Pact Boon
> ![Pact Boon](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-pb.md#Pact%20Boon)
^list-optfeature-pb