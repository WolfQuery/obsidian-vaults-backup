...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md) |
| 5th | [rope trick](/3-Mechanics/CLI/Compendium/spells/rope-trick.md) |
| 9th | [fear](/3-Mechanics/CLI/Compendium/spells/fear.md) |
| 13th | [greater invisibility](/3-Mechanics/CLI/Compendium/spells/greater-invisibility.md) |
| 17th | [seeming](/3-Mechanics/CLI/Compendium/spells/seeming.md) |
^gloom-stalker-spells
...
At the start of your first turn of each combat, your walking speed increases by 10 feet, which lasts until the end of that turn. If you take the [Attack](/3-Mechanics/CLI/Rules/actions.md#Attack) action on that turn, you can make one additional weapon attack as part of that action. If that attack hits, the target takes an extra `dice:1d8|noform|noparens|avg` (`d8`) damage of the weapon's damage type.
