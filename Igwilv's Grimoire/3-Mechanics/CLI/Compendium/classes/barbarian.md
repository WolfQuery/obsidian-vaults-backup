...
- (a) a [greataxe](/3-Mechanics/CLI/Compendium/items/greataxe.md) or (b) any martial melee weapon
- (a) two [handaxes](/3-Mechanics/CLI/Compendium/items/handaxe.md) or (b) any simple weapon
- An [explorer's pack](/3-Mechanics/CLI/Compendium/items/explorers-pack.md), and four [javelins](/3-Mechanics/CLI/Compendium/items/javelin.md)
...
- **Armor**: [shields](/3-Mechanics/CLI/Compendium/items/shield.md)
- **Weapons**: simple weapons, martial weapons
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](/3-Mechanics/CLI/Compendium/backgrounds/outlander.md) background.
