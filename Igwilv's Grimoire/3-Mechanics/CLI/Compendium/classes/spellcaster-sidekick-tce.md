...
- **Mage.** [mage hand](/3-Mechanics/CLI/Compendium/spells/mage-hand.md), [ray of frost](/3-Mechanics/CLI/Compendium/spells/ray-of-frost.md), [thunderwave](/3-Mechanics/CLI/Compendium/spells/thunderwave.md)  
- **Healer.** [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md), [guidance](/3-Mechanics/CLI/Compendium/spells/guidance.md), [sacred flame](/3-Mechanics/CLI/Compendium/spells/sacred-flame.md)  
- **Prodigy.** [eldritch blast](/3-Mechanics/CLI/Compendium/spells/eldritch-blast.md), [healing word](/3-Mechanics/CLI/Compendium/spells/healing-word.md), [light](/3-Mechanics/CLI/Compendium/spells/light.md)  
...
The sidekick can use a focus for its spells depending on the choice you made on the Spellcasting table. A Mage can use an arcane focus, a Healer can use a holy symbol, and a Prodigy can use an arcane focus or a [musical instrument](/3-Mechanics/CLI/Compendium/items/musical-instrument.md).
