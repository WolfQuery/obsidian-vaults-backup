...
Beginning at 10th level, when you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in [counterspell](/3-Mechanics/CLI/Compendium/spells/counterspell.md) and [dispel magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md)), you add your proficiency bonus to that ability check.
