...
- **Weapons**: simple weapons, [hand crossbows](/3-Mechanics/CLI/Compendium/items/hand-crossbow.md), [longswords](/3-Mechanics/CLI/Compendium/items/longsword.md), [rapiers](/3-Mechanics/CLI/Compendium/items/rapier.md), [shortswords](/3-Mechanics/CLI/Compendium/items/shortsword.md)
- **Tools**: three [musical instruments](/3-Mechanics/CLI/Compendium/items/musical-instrument.md) of your choice
- **Skills**: choose any 3 [skills](/3-Mechanics/CLI/Rules/skills.md)

You start with the following items, plus anything provided by your background.

- (a) a [rapier](/3-Mechanics/CLI/Compendium/items/rapier.md), (b) a [longsword](/3-Mechanics/CLI/Compendium/items/longsword.md), or (c) any simple weapon
- (a) a [diplomat's pack](/3-Mechanics/CLI/Compendium/items/diplomats-pack.md) or (b) an [entertainer's pack](/3-Mechanics/CLI/Compendium/items/entertainers-pack.md)
- (a) a [lute](/3-Mechanics/CLI/Compendium/items/lute.md) or (b) any other musical instrument
- [Leather armor](/3-Mechanics/CLI/Compendium/items/leather-armor.md), and a [dagger](/3-Mechanics/CLI/Compendium/items/dagger.md)
...
- **Armor**: [light armor](/3-Mechanics/CLI/Rules/item-types.md#Light%20Armor)
- **Tools**: one [musical instrument](/3-Mechanics/CLI/Compendium/items/musical-instrument.md) of your choice
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](/3-Mechanics/CLI/Compendium/backgrounds/entertainer.md) background. Third, choose the [dancing lights](/3-Mechanics/CLI/Compendium/spells/dancing-lights.md) and [vicious mockery](/3-Mechanics/CLI/Compendium/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md), [detect magic](/3-Mechanics/CLI/Compendium/spells/detect-magic.md), [healing word](/3-Mechanics/CLI/Compendium/spells/healing-word.md), and [thunderwave](/3-Mechanics/CLI/Compendium/spells/thunderwave.md).
...
| 2 | A mithral [horn](/3-Mechanics/CLI/Compendium/items/horn.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](/3-Mechanics/CLI/Compendium/items/drum.md) |
...
| 6 | When you sat on your [lute](/3-Mechanics/CLI/Compendium/items/lute.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](/3-Mechanics/CLI/Compendium/items/musical-instrument.md) as a spellcasting focus for your bard spells.
