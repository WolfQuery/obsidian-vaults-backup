...
- **Tools**: [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)
...
- (a) a [rapier](/3-Mechanics/CLI/Compendium/items/rapier.md) or (b) a [shortsword](/3-Mechanics/CLI/Compendium/items/shortsword.md)
- (a) a [shortbow](/3-Mechanics/CLI/Compendium/items/shortbow.md) and [quiver](/3-Mechanics/CLI/Compendium/items/quiver.md) of [20 arrows](/3-Mechanics/CLI/Compendium/items/arrows-20.md) or (b) a [shortsword](/3-Mechanics/CLI/Compendium/items/shortsword.md)
- (a) a [burglar's pack](/3-Mechanics/CLI/Compendium/items/burglars-pack.md), (b) a [dungeoneer's pack](/3-Mechanics/CLI/Compendium/items/dungeoneers-pack.md), or (c) an [explorer's pack](/3-Mechanics/CLI/Compendium/items/explorers-pack.md)
- [Leather armor](/3-Mechanics/CLI/Compendium/items/leather-armor.md), two [daggers](/3-Mechanics/CLI/Compendium/items/dagger.md), and [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)
...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [charlatan](/3-Mechanics/CLI/Compendium/backgrounds/charlatan.md) background.
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)) to gain this benefit.
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](/3-Mechanics/CLI/Compendium/spells/ice-storm.md) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
