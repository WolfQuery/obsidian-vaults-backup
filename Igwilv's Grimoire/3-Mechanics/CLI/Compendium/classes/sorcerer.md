...
- **Armor**: none
- **Weapons**: [daggers](/3-Mechanics/CLI/Compendium/items/dagger.md), [darts](/3-Mechanics/CLI/Compendium/items/dart.md), [slings](/3-Mechanics/CLI/Compendium/items/sling.md), [quarterstaffs](/3-Mechanics/CLI/Compendium/items/quarterstaff.md), [light crossbows](/3-Mechanics/CLI/Compendium/items/light-crossbow.md)
- **Tools**: none
...
- (a) a [light crossbow](/3-Mechanics/CLI/Compendium/items/light-crossbow.md) and [20 bolts](/3-Mechanics/CLI/Compendium/items/crossbow-bolts-20.md) or (b) any simple weapon
- (a) a [component pouch](/3-Mechanics/CLI/Compendium/items/component-pouch.md) or (b) an [arcane focus](/3-Mechanics/CLI/Compendium/items/arcane-focus.md)
- (a) a [dungeoneer's pack](/3-Mechanics/CLI/Compendium/items/dungeoneers-pack.md) or (b) an [explorer's pack](/3-Mechanics/CLI/Compendium/items/explorers-pack.md)
- Two [daggers](/3-Mechanics/CLI/Compendium/items/dagger.md)
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](/3-Mechanics/CLI/Compendium/spells/light.md), [prestidigitation](/3-Mechanics/CLI/Compendium/spells/prestidigitation.md), [ray of frost](/3-Mechanics/CLI/Compendium/spells/ray-of-frost.md), and [shocking grasp](/3-Mechanics/CLI/Compendium/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](/3-Mechanics/CLI/Compendium/spells/shield.md) and [magic missile](/3-Mechanics/CLI/Compendium/spells/magic-missile.md).
...
For example, if you know the 1st-level spell [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](/3-Mechanics/CLI/Compendium/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](/3-Mechanics/CLI/Compendium/optional-features/careful-spell.md)  
- [Distant Spell](/3-Mechanics/CLI/Compendium/optional-features/distant-spell.md)  
- [Empowered Spell](/3-Mechanics/CLI/Compendium/optional-features/empowered-spell.md)  
- [Extended Spell](/3-Mechanics/CLI/Compendium/optional-features/extended-spell.md)  
- [Heightened Spell](/3-Mechanics/CLI/Compendium/optional-features/heightened-spell.md)  
- [Quickened Spell](/3-Mechanics/CLI/Compendium/optional-features/quickened-spell.md)  
- [Subtle Spell](/3-Mechanics/CLI/Compendium/optional-features/subtle-spell.md)  
- [Twinned Spell](/3-Mechanics/CLI/Compendium/optional-features/twinned-spell.md)  
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-mm.md) available to you.  
...
> ![Metamagic](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-mm.md#Metamagic)
^list-optfeature-mm