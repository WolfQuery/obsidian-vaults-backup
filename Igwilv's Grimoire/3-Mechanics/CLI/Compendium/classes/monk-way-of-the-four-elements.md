...
Once you reach 5th level in this class, you can spend additional ki points to increase the level of an elemental discipline spell that you cast, provided that the spell has an enhanced effect at a higher level, as [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md) does. The spell's level increases by 1 for each additional ki point you spend. For example, if you are a 5th-level monk and use Sweeping Cinder Strike to cast [burning hands](/3-Mechanics/CLI/Compendium/spells/burning-hands.md), you can spend 3 ki points to cast it as a 2nd-level spell (the discipline's base cost of 2 ki points plus 1).
...
- [Breath of Winter](/3-Mechanics/CLI/Compendium/optional-features/breath-of-winter.md)  
- [Clench of the North Wind](/3-Mechanics/CLI/Compendium/optional-features/clench-of-the-north-wind.md)  
- [Elemental Attunement](/3-Mechanics/CLI/Compendium/optional-features/elemental-attunement.md)  
- [Eternal Mountain Defense](/3-Mechanics/CLI/Compendium/optional-features/eternal-mountain-defense.md)  
- [Fangs of the Fire Snake](/3-Mechanics/CLI/Compendium/optional-features/fangs-of-the-fire-snake.md)  
- [Fist of Four Thunders](/3-Mechanics/CLI/Compendium/optional-features/fist-of-four-thunders.md)  
- [Unbroken Air](/3-Mechanics/CLI/Compendium/optional-features/unbroken-air.md)  
- [Flames of the Phoenix](/3-Mechanics/CLI/Compendium/optional-features/flames-of-the-phoenix.md)  
- [Gong of the Summit](/3-Mechanics/CLI/Compendium/optional-features/gong-of-the-summit.md)  
- [Mist Stance](/3-Mechanics/CLI/Compendium/optional-features/mist-stance.md)  
- [Ride the Wind](/3-Mechanics/CLI/Compendium/optional-features/ride-the-wind.md)  
- [River of Hungry Flame](/3-Mechanics/CLI/Compendium/optional-features/river-of-hungry-flame.md)  
- [Rush of the Gale Spirits](/3-Mechanics/CLI/Compendium/optional-features/rush-of-the-gale-spirits.md)  
- [Shape the Flowing River](/3-Mechanics/CLI/Compendium/optional-features/shape-the-flowing-river.md)  
- [Sweeping Cinder Strike](/3-Mechanics/CLI/Compendium/optional-features/sweeping-cinder-strike.md)  
- [Water Whip](/3-Mechanics/CLI/Compendium/optional-features/water-whip.md)  
- [Wave of Rolling Earth](/3-Mechanics/CLI/Compendium/optional-features/wave-of-rolling-earth.md)  
...
> ![Elemental Discipline](/3-Mechanics/CLI/Compendium/lists/list-optfeaturetype-ed.md#Elemental%20Discipline)
^list-optfeature-ed