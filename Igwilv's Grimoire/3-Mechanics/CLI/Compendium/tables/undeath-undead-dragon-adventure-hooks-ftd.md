...
| 3 | A pirate crew under the command of a [ghost dragon](/3-Mechanics/CLI/Compendium/bestiary/undead/ghost-dragon-ftd.md) fights to recover the dead dragon's scattered hoard. |
| 4 | A [hollow dragon](/3-Mechanics/CLI/Compendium/bestiary/undead/hollow-dragon-ftd.md) guards an artifact meant to be used in the dire circumstances foretold in an ancient prophecy. Now the prophecy is coming to pass, but the dragon won't let the artifact be used for its intended purpose. |
| 5 | A gem dragon from another world is searching for the dragon's echo, which has become a [draconic shard](/3-Mechanics/CLI/Compendium/bestiary/undead/draconic-shard-ftd.md). |
