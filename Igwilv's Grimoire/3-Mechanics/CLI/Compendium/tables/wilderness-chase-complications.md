...
| 3 | You run through a [swarm of insects](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-insects.md) (see the Monster Manual for game statistics, with the DM choosing whichever kind of insects makes the most sense). The swarm makes an opportunity attack against you (+3 to hit; `dice:4d4\|noform\|noparens\|avg` (`4d4`) piercing damage on a hit). |
