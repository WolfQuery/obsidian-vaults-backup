...
Characters searching for a safe way down the cliffs discover a staircase carved into a narrow fissure. They can follow these steps all the way down to the shore just east of area T1. Crawling along the beach as they arrive there is a [giant crab](/3-Mechanics/CLI/Compendium/bestiary/beast/giant-crab.md).
...
If the characters agree to help the giant crab, it asks them to lay to rest its dead sea elf master, Miraal, whose spirit haunts a nearby cave (area T1). If the characters do so, the crab thanks them and makes good on its promise, retrieving the [+1 weapon](/3-Mechanics/CLI/Compendium/items/1-weapon.md) from the wreck of the *Star-Crossed Lover* (see the Shipwrecks table).
...
Rough-hewn stairs climb the eastern face of the rocky outcropping. The [harpies](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/harpy.md) in area T5 accost the characters as they climb these steps. See area T5 for details.
...
The lightning rod on the roof (area T8) channels electricity into the altar, which converts that raw elemental power into magical energy. The first character to touch the altar gains the [Charm of the Storm](/3-Mechanics/CLI/Compendium/rewards/charm-of-the-storm-dip.md), described below. Give that character's player the [Charm of the Storm card](/3-Mechanics/CLI/Compendium/decks/magic-charm-cards-dip.md#Charm%20of%20the%20Storm).
...
A ledge enclosed by a 3-foot-high stone retaining wall serves as a nest for [harpies](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/harpy.md). The harpies line their nest with rotting vegetation and the bones of previous meals, which they hunt up and down the coast. The number of harpies present equals the number of characters in the party, including sidekicks (maximum three harpies). A harpy reduced to 10 hit points or fewer tries to fly away on its next turn, hoping to live to fight another day.

##### Treasure

Characters who search through the harpies' nest find a [potion of water breathing](/3-Mechanics/CLI/Compendium/items/potion-of-water-breathing.md). If the characters acquire this potion, give them the [Potion of Water Breathing](/3-Mechanics/CLI/Compendium/items/potion-of-water-breathing.md) [card](/3-Mechanics/CLI/Compendium/decks/magic-item-cards-dip.md#Potion%20of%20Water%20Breathing) or they can reference it in the Magic Items Listing.
...
This 15-foot-high room has two north-facing windows. A barnacle-encrusted chair stands against the south wall. Sitting in the chair is Moesko, an [anchorite of Talos](/3-Mechanics/CLI/Compendium/bestiary/humanoid/anchorite-of-talos-dip.md) clad in armor made from giant octopus hide. Resting in his lap is an opalescent conch he took from Miraal the sea elf (see area T1).
...
When a magic item is found and identified, give the players the corresponding [magic item card](/3-Mechanics/CLI/Compendium/decks/magic-item-cards-dip.md) or they can reference it in the Magic Items Listing. In the case of the [+1 weapon](/3-Mechanics/CLI/Compendium/items/1-weapon.md) in area T10, choose from among the weapons available ([+1 battleaxe](/3-Mechanics/CLI/Compendium/items/1-weapon.md), [+1 longbow](/3-Mechanics/CLI/Compendium/items/1-weapon.md), [+1 mace](/3-Mechanics/CLI/Compendium/items/1-weapon.md), or [+1 shortsword](/3-Mechanics/CLI/Compendium/items/1-weapon.md)). Only one [+1 weapon](/3-Mechanics/CLI/Compendium/items/1-weapon.md) can be found, so choose a weapon with which at least one party member has proficiency.

**Shipwrecks**

| Area | Ship Name | Treasure |
|------|-----------|----------|
| T10 | *Star-Crossed Lover* | [+1 weapon](/3-Mechanics/CLI/Compendium/items/1-weapon.md) of your choice, found in the grip of a skeleton that used to be the ship's captain |
...
| T12 | *Vainglory* | [Cloak of many fashions](/3-Mechanics/CLI/Compendium/items/cloak-of-many-fashions-xge.md) worn by the skeleton of the ship's captain |
| T13 | *Golden Gull* | Locked chest containing 120 ep and six pearls (100 gp each) in a black silk pouch |
| T14 | *Orca* | Locked chest that holds a fully charged [wand of secrets](/3-Mechanics/CLI/Compendium/items/wand-of-secrets.md) and a leather-bound spellbook that contains the wizard spells [blur](/3-Mechanics/CLI/Compendium/spells/blur.md), [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md), [comprehend languages](/3-Mechanics/CLI/Compendium/spells/comprehend-languages.md), [hold person](/3-Mechanics/CLI/Compendium/spells/hold-person.md), [mage armor](/3-Mechanics/CLI/Compendium/spells/mage-armor.md), [sleep](/3-Mechanics/CLI/Compendium/spells/sleep.md), and [spider climb](/3-Mechanics/CLI/Compendium/spells/spider-climb.md) |
^shipwrecks