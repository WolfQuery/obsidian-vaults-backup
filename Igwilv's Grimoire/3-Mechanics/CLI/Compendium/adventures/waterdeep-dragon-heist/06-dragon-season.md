...
"Laeral" tells the characters that Fenerus had a sentient magic item in his possession called the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), which knows the location of a large cache of gold that was embezzled from the city by its previous Open Lord. She asks the characters to retrieve the stone, for the good of Waterdeep, and deliver it to her at the Seven Masks Theater in the Dock Ward. "Laeral" offers no reward other than the gratitude of Waterdeep's Open Lord.
...
Any creature in the crowd has half cover, and any attack that misses the creature because of the cover hits an innocent [commoner](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md) instead.
...
Earlier, [Grinda Garloth](/3-Mechanics/CLI/Compendium/bestiary/npc/grinda-garloth-wdh.md)'s rat familiar arrived to find the mausoleum open and grave robbers inside. They killed the rat, took the stone, and fled along with the skeletal remains of Grinda's ancestors. Characters who search the plundered crypts find neither the rat nor the stone, but they do find a clue left behind by one of the grave robbers (see "Crypt Clue" below). As the characters make their way out, Xanathar Guild members attack them in an attempt to retrieve the stone.
...
The characters are chasing two [drow gunslingers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B) across windy rooftops in the Dock Ward. The drow stick together as they run, but each one acts on his own initiative count.
...
The kenku clutches the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in one clawed hand and [Squiddly](/3-Mechanics/CLI/Compendium/bestiary/npc/squiddly-wdh.md) the tiefling in the other. When cornered, the creature mimics the sound of a screaming child-its way of threatening to harm the boy unless the characters leave at once. The kenku doesn't respond to verbal threats or attempts at persuasion, but it can be bribed with coin, gemstones, or shiny baubles. It gives up both the stone and the boy in return for 100 gp worth of treasure.

If the characters and the kenku reach an impasse, [Squiddly](/3-Mechanics/CLI/Compendium/bestiary/npc/squiddly-wdh.md) kicks the kenku in the shin, causing it to release him, and hides under some old furniture. This act initiates combat as the kenku draws its sword.

If he has a clear path to the stairs, [Squiddly](/3-Mechanics/CLI/Compendium/bestiary/npc/squiddly-wdh.md) runs down them and rejoins his friends. The three children flee the tower together, disappearing into a nearby alley.

#### Gazer Attack

When the characters finally obtain the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), three [gazers](/3-Mechanics/CLI/Compendium/bestiary/aberration/gazer-mpmm.md) (see appendix B) enter O3 through the arrow slits and attack. They try to incapacitate whichever character has the stone and use their telekinetic rays to steal it. If successful, the gazers take the stone to a nearby alley.

#### Next Encounter

Whether the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) leaves the tower in the possession of the characters or the gazers, proceed with encounter 1, "Alley."

### Old Tower: Summer

The old tower, formerly owned by a wizard, was recently bought by Esvele Rosznar, a young noblewoman with a fascinating alter ego (see "The [Black Viper](/3-Mechanics/CLI/Compendium/bestiary/npc/black-viper-wdh.md)" in appendix B).

#### House Rosznar Guards

Esvele has brought four [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) with her to the tower. They wear the livery of House Rosznar and stand guard in O1.

#### Bought and Paid For

Through her network of spies, Esvele learned about Lord Neverember's friendship with the tower's previous owner. Not long thereafter, she found the entrance to the Vault of Dragons beneath the tower. Unfortunately for her, she doesn't know what keys are needed to enter it or what lies within. When the characters arrive, Esvele is in O2, meeting with the following three guild representatives ([commoners](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)):
...
The characters come to this crumbling tower in the Dock Ward looking for the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). Members of Bregan D'aerthe follow them invisibly. Superstitious locals think the tower is haunted, so they avoid it.

#### Antimagic Field

The interior of the tower is subject to a permanent [antimagic field](/3-Mechanics/CLI/Compendium/spells/antimagic-field.md) spell. Consequently, no magic functions inside the tower. This effect was left behind by the tower's previous occupant, a wizard hermit who dabbled in "wild magic" and could no longer control it. Because of the antimagic field, the magic lights that normally illuminate the tower have been suppressed. Only a [wish](/3-Mechanics/CLI/Compendium/spells/wish.md) spell or similar magic can end this antimagic effect.

#### Tower Swords

Scattered on the floors throughout the tower are six longswords with no traces of rust or blood on them. These blades are [flying swords](/3-Mechanics/CLI/Compendium/bestiary/construct/flying-sword.md) rendered inert by the antimagic field. If a flying sword is taken from the tower, it animates and attacks.

#### Where's the Stone?

Fenerus hid the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in the cauldron that hangs in the fireplace on the upper level (O3). But it's not there anymore.

Before the characters reach O3, three [drow gunslingers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B) under the effect of [potions of invisibility](/3-Mechanics/CLI/Compendium/items/potion-of-invisibility.md) use their [levitate](/3-Mechanics/CLI/Compendium/spells/levitate.md) spells to scale the outside of the tower and crawl through the arrow slits. While they are inside the tower, their [invisibility](/3-Mechanics/CLI/Compendium/spells/invisibility.md) spells are negated by the antimagic field. One of the drow quickly finds the stone and takes it before the characters show up.

Unless they were defeated earlier in the adventure, these drow are Jarlaxle's lieutenants: [Fel'rekt Lafeen](/3-Mechanics/CLI/Compendium/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](/3-Mechanics/CLI/Compendium/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](/3-Mechanics/CLI/Compendium/bestiary/npc/soluun-xibrindas-wdh.md). Replace any that were killed earlier in the adventure with other drow gunslingers, and roll initiative for each drow. Soluun (or his replacement) can't resist a good fight and attacks the characters, buying time for the other drow to escape. Once they're outside the tower, the fleeing drow become [invisible](/3-Mechanics/CLI/Rules/conditions.md#Invisible) again as they leap onto a nearby rooftop, but the potions wear off at the end of their next turns, enabling characters to chase after them.
...
The characters have learned that the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) is with Amath Sercent, a priest of Bane who is allied with [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md). She and her acolytes reside in Yellowspire, a Castle Ward tower so named because its bricks have a pale yellow tinge to them. Amath is in the midst of converting the tower into a temple of Bane. A teleportation circle in the basement allows for swift transport to and from Kolat Towers and [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)'s extradimensional sanctum.

#### House of Tyranny

Amath Sercent (LE female Mulan [priest](/3-Mechanics/CLI/Compendium/bestiary/humanoid/priest.md)) and her four followers (LE male and female [acolytes](/3-Mechanics/CLI/Compendium/bestiary/humanoid/acolyte.md) of mixed ethnicities) dress in common clothing when outside the tower. Inside the structure, they wear fur-lined robes to stay warm. They refer to the tower as the House of Tyranny, and black prints of their right hands, with fingers and thumb held together, cover every interior surface. These handprints mimic the symbol of Bane.

Amath and her followers assemble here for worship but sleep elsewhere. When the characters first arrive, all five have gathered in prayer on the upper floor of the tower (O3). Three black [flying snakes](/3-Mechanics/CLI/Compendium/bestiary/beast/flying-snake.md) nest in the rafters and join any battle here. During this ceremony, Amath and her acolytes hold candles and form a circle around a gagged and blindfolded broadsheet publisher named Shan Chien (N male Shou human [commoner](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)). The imperious, middle-aged man is shackled to the floor, and Amath carries the key to the shackles. The shackles can be broken by a creature that uses an action to make a successful DC 20 Strength (Athletics) check. Picking the shackles' lock requires thieves' tools and a successful DC 15 Dexterity check.

The Banites' ritual is designed to break Shan's will, making him subservient to Bane. Amath has been using this ritual to "turn" broadsheet publishers as part of a larger plot to control the flow of information in the city-a critical element of [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)'s takeover. Shan was abducted by Amath's acolytes the night before while walking to his home in the Trades Ward. He publishes *The Targe*, a broadsheet that offers up vitriolic rants on all manner of local topics, including politics.

Amath has the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in her pocket. She is expecting [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) or his simulacrum to arrive and retrieve it shortly.
...
The characters must fight Amath and her acolytes to get the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). When they finally obtain it, fate deals them an unkind hand as [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)'s simulacrum (see "[Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)" in appendix B) arrives by way of the teleportation circle in O5. If the characters had the opportunity and the foresight to destroy the circle prior to obtaining the stone, the simulacrum instead must travel to Yellowspire on foot, giving the characters ample time to get away before it arrives as long as they leave within 1 hour after obtaining the stone. The simulacrum tirelessly pursues the stone, and characters who flee would do themselves well not to leave tracks in the snow.

#### Next Encounter

If a character becomes attuned to the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), it reveals the location of the Vault of Dragons, under the Brandath family mausoleum in the City of the Dead, and the three keys needed to enter it. When the characters are ready to visit the mausoleum, proceed with encounter 4, "Mausoleum."
...
- Two [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) stand outside each of the front and back doors (leading to areas H1 and H6) at all hours.  
...
- All areas are brightly lit by [continual flame](/3-Mechanics/CLI/Compendium/spells/continual-flame.md) spells cast on wall sconces.  
...
> [!gallery]
> ![Courthouse](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/courthouse-dm.webp#gallery)
> ![Courthouse, Main Level (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/courthouse-main-players.webp#gallery)
> ![Courthouse, Lower Level (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/courthouse-lower-players.webp#gallery)

#### H1. Upstairs Waiting Room

This room has the following features:

- Two [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) stand outside the doors to the records rooms (H2) at all hours. Behind a desk sits a court clerk ([commoner](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)). Uncomfortable wood benches line the walls. A copper plaque mounted above each bench says, in Common, "Please have a seat. Someone will be with you shortly."  
...
Two desks pushed together in the middle of the room hold quills, ink, and sheets of paper. Two court clerks ([commoners](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)) work here, supporting the magister on duty. Each clerk holds a key to the records rooms (H2).
...
When not overseeing a trial, a magister on duty at the courthouse reviews cases and holds meetings here. If a magister is here, so is a [knight](/3-Mechanics/CLI/Compendium/bestiary/humanoid/knight.md) who serves as a bodyguard.

#### H5. Courtroom

This room has the following features:

- Two [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) are stationed here at all times.  
...
- Two [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) are on duty in this room at all times.  
...
Two [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) are stationed in this hall at all times.
...
- Two [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md), members of the City Watch, are here at all times.  
...
After obtaining the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), the characters are arrested by the City Watch soon after they emerge from the sewers.

#### Under Arrest

The arresting force consists of twelve [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md), a Watch [sergeant](/3-Mechanics/CLI/Compendium/bestiary/humanoid/sergeant-wdh.md) and eleven constables. They demand that the characters surrender their weapons and come along quietly. For guidance on how to handle character arrests, see "Breaking the Law,".
...
![The Code Legal](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/the-code-legal.webp#center)

Characters who give up their visible weapons without a fuss aren't searched, but those who give the Watch a hard time are searched for hidden weapons (and stripped of anything that could potentially cause harm). A character can conceal a Tiny object from the Watch with a successful DC 12 Dexterity (Sleight of Hand) check. If the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) is found during a search, the Watch [sergeant](/3-Mechanics/CLI/Compendium/bestiary/humanoid/sergeant-wdh.md) inspects it, concludes that it's nothing of consequence, and returns it to its owner.

#### Dock Ward Courthouse

Arrested characters are brought to a courthouse in the Dock Ward and confined to cells (H8) until their trial. Any items taken from them during their arrest are entrusted to the front desk clerk (H1) pending the trial's outcome. A character can take a short rest while incarcerated and use that time to attune to the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). After `dice:1d6|noform|noparens|avg` (`d6`) hours, word comes down that the magister is prepared to hear the characters' testimony, whereupon the guards in H8 unlock the characters' cells and escort them to the courtroom (H5), where the magister is waiting.

#### False Captain

If Lord Cassalanter's [doppelganger](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/doppelganger.md) valet is still at large, it kills a Watch captain and uses the victim's uniform to impersonate another Watch captain the characters have met before. Then, in the guise of Hyustus Staget (see "The Watch Arrives"), the doppelganger kills the guards in H8 with its bare hands and uses their keys to open the characters' cells. "Hyustus" warns them that the magister is corrupt and suggests they flee the city before they're sentenced to death. "Hyustus" offers to deliver messages or items of import on their behalf while they make good their escape. The doppelganger is hoping that the characters will entrust the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) to it for safekeeping. Failing that, it hopes to wrest the stone from them during the chaos of the jailbreak.

If the characters refuse to play along, the doppelganger cries out in alarm, bringing the full weight of the courthouse garrison (ten [guards](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) and two [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md)) down upon the characters, whom "Hyustus" accuses of beating the cell block guards to death. These reinforcements have no reason to believe that Captain Staget isn't who he appears to be, and they side with him in any conflict.

If the doppelganger obtains the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), it promptly delivers it to [Victoro Cassalanter](/3-Mechanics/CLI/Compendium/bestiary/npc/victoro-cassalanter-wdh.md). If the characters extricate themselves from the mess they're in, they can retrieve the stone from Cassalanter Villa (see chapter 6).
...
[Magister Umbero Zastro](/3-Mechanics/CLI/Compendium/bestiary/npc/magister-umbero-zastro-wdh.md) has the statistics of a [noble](/3-Mechanics/CLI/Compendium/bestiary/humanoid/noble.md), with these changes:
...
- A character who has at least 4 renown in the Harpers can convince [Mirt](/3-Mechanics/CLI/Compendium/bestiary/npc/mirt-wdh.md) (see appendix B) to use his authority as a Lord of Waterdeep to secure Fenerus's release. [Mirt](/3-Mechanics/CLI/Compendium/bestiary/npc/mirt-wdh.md) has personally lost coin to the Blood Hawk Posse, so helping Fenerus squirm out of jail stings him deeply.  
- A character who has at least 4 renown in the Lords' Alliance can arrange a meeting with [Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md) (see appendix B) at Piergeiron's Palace and convince her to give Fenerus what he wants in exchange for information on the stone's whereabouts. The safe return of Neverember's cache of dragons is more important to her than the fate of one brigand.  
...
- **Meeting with the Magister.** The courthouse magister is [Hester Barch](/3-Mechanics/CLI/Compendium/bestiary/npc/hester-barch-wdh.md) (LG female Turami human [acolyte](/3-Mechanics/CLI/Compendium/bestiary/humanoid/acolyte.md) with Insight +4), a petite woman in her seventies. Magister Barch is slow to anger and fond of sharing lengthy educational anecdotes and parables. Unknown to all but her closest aides, the magister has the innate psionic ability to cast the [detect thoughts](/3-Mechanics/CLI/Compendium/spells/detect-thoughts.md) spell without somatic or material components. After using it once, the magister must finish a short or long rest before she can cast the spell again. Wisdom is her spellcasting ability (spell save DC 12).  
    ...
    The magister is disinclined to agree to any request for a private meeting with Fenerus, on the grounds that he's a shady, unrepentant person and a flight risk. The conditions under which she will permit a meeting are as follows:  
        ...
        - A character who is impersonating a noble or an official makes a good argument and succeeds on a DC 15 Charisma (Deception) check. If the check fails, Magister Barch sees through the ruse and uses her [detect thoughts](/3-Mechanics/CLI/Compendium/spells/detect-thoughts.md) spell to verify that the character is in fact disguised as a noble or an official-a crime that carries a punishment of flogging followed by imprisonment for up to a tenday, plus a fine of up to 500 gp.    
        - A character tells the magister about the hidden cache of dragons and Fenerus's role in finding it.    
- **Talking to Fenerus.** Fenerus Stormcastle (N male Tethyrian [bandit captain](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bandit-captain.md)) is confined to a cell in H8, waiting to stand trial. He is charged with multiple counts of theft (highway banditry) and assaults against Waterdavian citizens. Fenerus knew it was only a matter of time until someone tipped off the City Watch; he suspects that another member of the Blood Hawk Posse gave him up. The timing is unfortunate for him, since he was planning to earn a small fortune by turning over the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) to his Luskanite contact. Now, he plans to use the stone to escape imprisonment and wipe his criminal record clean.  
...
> [!gallery]
> ![Cellar Complex](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/cellar-complex-dm.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/cellar-complex-players.webp#gallery)
...
A plain wooden door opens into a room containing dusty furnishings in storage. The furniture includes a scratched wooden desk, several wobbly chairs, a coat rack, two small tables, and an empty wooden trunk. There's a 25 percent chance that one piece of furniture (determined randomly) is a [mimic](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/mimic.md) that usually feeds on rats but never passes up a bigger meal.
...
| dice: d100 | result |
|------------|--------|
| 1-25 | A [Mimic](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/mimic.md) is present |
...
The characters have learned that a halfling necromancer named [Losser Mirklav](/3-Mechanics/CLI/Compendium/bestiary/npc/losser-mirklav-wdh.md) took the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). He lives in a cellar complex under a powdered wig shop in the Trades Ward. The shop, Dandymops, is closed and locked with an iron gate. The lock can be picked by a character who makes a successful DC 15 Dexterity check using thieves' tools, or the gate can be forced open with a successful DC 25 Strength (Athletics) check. Since the shop is in a highly visible location, an attempt to break into it is 75 percent likely to be noticed by someone who alerts the City Watch. Two [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md) of the City Watch arrive in `dice:1d10|noform|noparens|avg` (`d10`) minutes to investigate the shop and talk to witnesses.

[Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md)'s [gazer](/3-Mechanics/CLI/Compendium/bestiary/aberration/gazer-mpmm.md) (see appendix B) doesn't follow characters into the shop. It remains outside and waits for Xanathar Guild forces to arrive. If the characters destroyed the gazer in an earlier encounter, another one arrives with the Xanathar Guild forces.
...
[Losser Mirklav](/3-Mechanics/CLI/Compendium/bestiary/npc/losser-mirklav-wdh.md) is a lightfoot halfling [mage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/mage.md), with these changes:

- He is chaotic evil and has `dice:9d6|noform|noparens|avg|text(31)` (`9d6`) hit points.  
...
- He has the [animate dead](/3-Mechanics/CLI/Compendium/spells/animate-dead.md) and [blight](/3-Mechanics/CLI/Compendium/spells/blight.md) spells prepared, instead of [counterspell](/3-Mechanics/CLI/Compendium/spells/counterspell.md) and [greater invisibility](/3-Mechanics/CLI/Compendium/spells/greater-invisibility.md). All his spell slots are currently expended.  

Losser carries a spellbook bound in stitched flesh that contains all his prepared spells. He also has a key to the padlocked door in B8 and `dice:4d10|noform|noparens|avg` (`4d10`) gp in a pouch made of elf skin and cinched with a rope made of woven dwarf hair.
...
- B10 contains twelve [skeletons](/3-Mechanics/CLI/Compendium/bestiary/undead/skeleton.md) that attack anyone other than Losser and his apprentices.  
- B11 contains piles of human bones stolen from the City of the Dead. Losser hasn't gotten around to animating them yet.  

#### Where's the Stone?

Before the characters reach Losser, kenku members of the Xanathar Guild break down the door leading into the cellar complex via B8 and confront the necromancer. The characters find Losser cowering in one corner of B7. Two [skeletons](/3-Mechanics/CLI/Compendium/bestiary/undead/skeleton.md) stand between him and three [kenku](/3-Mechanics/CLI/Compendium/bestiary/humanoid/kenku.md). The kenku aim to kill the halfling. Lying on the floor around them are four dead kenku and the remains of two destroyed (and previously animated) skeletons.

If the characters demand the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), Losser tells them the truth: he surrendered it to the kenku, two of which fled south with it. In B8, the characters see one [kenku](/3-Mechanics/CLI/Compendium/bestiary/humanoid/kenku.md) standing over the bodies of Losser's murdered human apprentices, Retchyn and Kreela. This kenku is joined by [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md)'s [gazer](/3-Mechanics/CLI/Compendium/bestiary/aberration/gazer-mpmm.md) (see appendix B). The kenku and the gazer try to hold off the characters for as long as possible, buying time for a second kenku to flee with the Stone of Golorr.

If the characters pursue the stone and leave Losser alive, he eventually slips away and retreats to B11.

#### Next Encounter

Once the characters defeat [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md)'s forces in the cellar, they can chase after the fleeing kenku that has the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in its clutches. Proceed with encounter 3, "Street Chase."
...
The street urchins took the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) to B7 (which serves as their clubhouse), entering the room through a secret door (B3). The eldest child, [Nat](/3-Mechanics/CLI/Compendium/bestiary/npc/nat-wdh.md), attuned to the stone, but contact with the aboleth so terrified her that she dropped it, screamed, and ran away. The boys were panicked by her reaction and fled as well, leaving the stone in B7. If the characters open the door at B4, they startle the children on the other side, causing them to scream at the top of their lungs.

Communicating through the other children, [Nat](/3-Mechanics/CLI/Compendium/bestiary/npc/nat-wdh.md) tells the characters where she dropped the stone and warns them that it's "alive." Neither she nor the boys are eager to see it again.

#### Chair Today, Gone Tomorrow

If the characters head to B7, they see the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) underneath a wooden rocking chair. If the street urchins are present, one of them asks, "Where'd that rocking chair come from?"

The rocking chair is the [mimic](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/mimic.md) from B9b. It heard the urchins' screams and investigated, hoping to snare an easy meal. It attacks anyone who harms it or reaches for the stone.

#### Next Encounter

Once the characters obtain the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), they can leave the cellar complex. Proceed with encounter 8, "Courthouse."
...
| Area | Creature(s) |
|------|-------------|
| B5 | 2 [goblins](/3-Mechanics/CLI/Compendium/bestiary/humanoid/goblin.md) behind arrow slits |
| B6 | 1 [half-ogre](/3-Mechanics/CLI/Compendium/bestiary/giant/half-ogre-ogrillon.md) that became [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned) after drinking six casks of cheap wine |
| B7 | 3 [duergar](/3-Mechanics/CLI/Compendium/bestiary/humanoid/duergar.md) and 1 [gazer](/3-Mechanics/CLI/Compendium/bestiary/aberration/gazer-mpmm.md) (see appendix B) standing guard while [Thorvin Twinbeard](/3-Mechanics/CLI/Compendium/bestiary/npc/thorvin-twinbeard-wdh.md) (see appendix B) works on a mechanical beholder (see "Mechanical Beholder" below) |
| B8 | Korgstrod Uxgulm, the [duergar](/3-Mechanics/CLI/Compendium/bestiary/humanoid/duergar.md) leader (40 hit points), seated in a stone chair and attended by 3 [kobolds](/3-Mechanics/CLI/Compendium/bestiary/humanoid/kobold.md) (see "Stone of Deception" below) |
| B10 | 7 [troglodytes](/3-Mechanics/CLI/Compendium/bestiary/humanoid/troglodyte.md) lurking in the shadows |
| B11a | 1 [gibbering mouther](/3-Mechanics/CLI/Compendium/bestiary/aberration/gibbering-mouther.md) guarding a treasure chest in B11b (see "Treasure Chest" below) |
^xanathar-guild-roster

#### Mechanical Beholder

A mechanical beholder built for the Day of Wonders parade lies on its side in B7. [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) wants this mechanical version of itself to hover over the crowd, reminding the Lords of Waterdeep of the beholder's superiority, but no one can figure out how to make it fly. A character can use an action to try to activate the machine, doing so with a successful DC 10 Intelligence check. The activated beholder shoots dazzling lights from its eyestalks for 1 minute and then stops working.

If combat breaks out in the cellar complex, [Thorvin Twinbeard](/3-Mechanics/CLI/Compendium/bestiary/npc/thorvin-twinbeard-wdh.md) flees up the stairs in B8 and uses a key to unlock the door leading outside. He has no loyalty to the other creatures stationed here.

#### Stone of Deception

Korgstrod Uxgulm, the duergar leader, has what he believes to be the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). He found it during a search of Fenerus's house in the Trades Ward. This stone is a clever imitation. It's gray and ovoid with streaks of black, but has no magical powers. Korgstrod has been unable to attune to it and assumes he's unworthy of it, not that the stone is fake.

Korgstrod plans to deliver the stone to [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) in due time and won't willingly part with it before then. He uses a whip to flog his kobold lackeys and keep them in line. The cowardly kobolds flee into the sewers if Korgstrod is attacked and cower in his presence otherwise.

#### Treasure Chest

An old, locked chest in the back of B11b can be opened by someone who makes a successful DC 13 Dexterity check using thieves' tools. The chest contains 277 cp, 135 sp, a spherical gold beholder pendant with tiny gems for eyes (worth 250 gp), and a [spell scroll](/3-Mechanics/CLI/Compendium/items/spell-scroll.md) of [darkvision](/3-Mechanics/CLI/Compendium/spells/darkvision.md).
...
> [!gallery]
> ![Windmill](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/windmill-dm.webp#gallery)
> ![Windmill, Ground Floor (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/windmill-first-players.webp#gallery)
> ![Windmill, Upper Floor (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/windmill-second-players.webp#gallery)
...
During the spring, summer, and winter, each of these rooms is home to `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) squatters ([commoners](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)) who have made dens for themselves out of old furnishings and things salvaged from garbage piles. The squatters aren't looking for trouble.
...
The key that the characters found in the mausoleum leads them to an old windmill in the Southern Ward. Volkarr Kibbens and Urlaster Ghann (NE male Illuskan human [commoners](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md)) are hiding out in a secure apartment on the upper floor (W7). In combat, they wield shovels that deal damage as clubs. Each carries `dice:3d6|noform|noparens|avg` (`3d6`) gp in a pouch.
...
- [Losser Mirklav](/3-Mechanics/CLI/Compendium/bestiary/npc/losser-mirklav-wdh.md) and his two human apprentices, Retchyn and Kreela, live in a cellar complex under the Trades Ward. The way to their lair is through Retchyn's powdered wig shop, which is called Dandymops.  
...
The characters head to a decrepit building in the Southern Ward that used to be a windmill. Therein, they expect to find the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in the clutches of two treacherous [cult fanatics](/3-Mechanics/CLI/Compendium/bestiary/humanoid/cult-fanatic.md) named Arn Xalrondar (LE male Tethyrian human) and Seffia Naelryke (LE female Tethyrian human).
...
Lord Cassalanter sent Arn and Seffia on a mission to retrieve the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) from his family's mausoleum. He also gave them secret orders to dispose of three other members of the cult whom he couldn't trust to keep quiet about the stone. Arn and Seffia would be horrified to learn that they failed in so simple a task; they try to correct their mistake by killing Vaelle Lurval if she's with the party (see "Mausoleum: Summer").

#### Devils' Arrival

As characters try to break into the cult fanatics' apartment, three [spined devils](/3-Mechanics/CLI/Compendium/bestiary/fiend/spined-devil.md) arrive. The devils fly to the tower, knock on the apartment window, and are let inside by Seffia, whereupon Arn gives one of them the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md). When the characters enter, they see the devils fly off with the stone. The cult fanatics do everything in their power to enable the devils to escape.
...
The outside doors are always locked. A lock can be picked with a successful DC 15 Dexterity check by a character using thieves' tools, or a door can be smashed open with a successful DC 15 Strength (Athletics) check. Any attempt to break into the tower is 75 percent likely to be seen or heard by one of [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md)'s neighbors. Eight [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md) of the City Watch arrive 10 minutes later to investigate the intrusion.

#### Let Me Paint You a Picture

[Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md), a famous Waterdavian painter, was commissioned to paint a portrait of Lord Dagult Neverember, then Waterdeep's Open Lord, in 1475 DR. Her meeting with Neverember marked the beginning of a torrid love affair that lasted over a year. One of the many gifts he lavished on her was an estate in the Sea Ward.

Their relationship faltered as Dagult's visits to Neverwinter became more frequent and extended. He made promises to [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) that he failed to keep, and when she raised the subject of faithful commitment, he treated her poorly, for his true love was Neverwinter. [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) became enraged after Dagult's rejection and turned to painting monsters that, in her mind, represented him. Her power to harness the Weave clings to the fabric of her works, giving her the ability to bring these monsters to life on command.

Ultimately, Neverember used his influence to ruin [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) and divorce her from Waterdeep's high society. She was allowed to keep her home, but her works and her reputation were destroyed, slowly and methodically. [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md)'s spirit was broken, leading to the onset of madness. Now she locks herself away, content to let time erode the last of her conscience. She always saw Dagult and Waterdeep as one and the same, and now they are both her mortal enemies.

#### Visiting the Residence

[Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) is unable to behave politely before strangers, for she believes they're all assassins sent by Dagult Neverember to murder her. The only person with whom she's civil is Vhaspar Holmdreg (LG male Illuskan human [priest](/3-Mechanics/CLI/Compendium/bestiary/humanoid/priest.md)), who rents a room in the west wing of the residence and works in the North Ward at the Hospice of St. Laupsenn, a temple of Ilmater, god of suffering. Vhaspar is an old man in his seventies, half blind with cataracts, who brings her food twice a week, firewood three times a week in the winter, and painting supplies every few months. Vhaspar has a key that unlocks the outer doors of [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md)'s residence.

Displayed in every room except W5 is one of [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md)'s paintings. To determine the subject of any given painting, roll a `dice:d12|noform|noparens|avg` (`d12`) and consult the Painting Subjects table. It's possible for a subject to appear more than once. The residence is also crawling with rats. If [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) is attacked, these vermin form six [swarms of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md) that defend her.
...
[Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) spends most of her time in W5, which serves as her studio. It contains moldy scraps of food, empty pots stained with colored paint, discarded brushes, and her easel, which is situated in front of a large, lead-paned window in the north wall. Upon the easel rests a fresh painting of a [displacer beast](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/displacer-beast.md). If the characters confront her, [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) accuses them of being assassins, brings the displacer beast to life, and commands it to attack them.

[Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) is a half-elf [bard](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bard-mpmm.md) (see appendix B), with these changes:
...
[Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) touches one of her paintings and causes its subject to spring forth, becoming a creature of that kind provided its CR is 3 or lower. The creature appears in an unoccupied space within 5 feet of the painting, which becomes blank. The creature is friendly toward [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) and hostile toward all others. It rolls initiative to determine when it acts. It disappears after 1 minute, when it is reduced to 0 hit points, or when [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) dies or falls [unconscious](/3-Mechanics/CLI/Rules/conditions.md#Unconscious).

#### Path to the Vault

A heavy stone trapdoor in the floor of area W4a can be found with a thorough search of the room and a successful DC 12 Wisdom (Perception) check. Pulling open the door reveals a stone staircase that descends 120 feet to a 20-foot-wide corridor, which extends for another 60 feet and ends before the doors to the Vault of Dragons. [Kalain](/3-Mechanics/CLI/Compendium/bestiary/npc/kalain-wdh.md) and Vhaspar know nothing of the vault or the trapdoor that leads to it.

### Converted Windmill: Winter

An evil dragonborn named [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) has converted an old, fire-scorched windmill in the Field Ward into a butcher's shop. A member of the Guild of Butchers, [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) has a lucrative side business. Zhents loyal to [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) pay [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) to chop up people they kill, and he sells the meat on the sly. As Deadwinter Day approaches, this meat is in high demand. The corpses are brought to him in the dead of night, most often delivered by Sidra Romeir (see chapter 8, K2) in a covered cart pulled by a draft horse.

#### Butchery

A red wooden sign carved to look like a butcher's cleaver hangs above the door of [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md)'s butchery, which occupies the westernmost room of the west wing. The butchery is ice cold in the winter and reeks of meat and blood. A bloodstained chopping block dominates the room, and shelves of cut meat wrapped in bloody parchment line the walls. The floor is streaked with blood and covered with bits of gore.

[Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) padlocks the door at night. Picking the lock requires a successful DC 15 Dexterity check using thieves' tools. The door can also be forced open with a successful DC 18 Strength (Athletics) check.

#### Larder

The chamber next to the butchery has been converted into a larder, the doors to which are padlocked at all hours. The locked doors are otherwise identical to the butchery door (see above). Like the butchery, the larder is frigid in the winter and smells of meat and blood. Six half-frozen humanoid carcasses are stacked under a 10-foot-square canvas tarpaulin near the western wall. [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) hasn't gotten around to cutting them up yet.

#### Squatters

The dragonborn allows squatters to dwell in his home. Those who can perform menial chores are spared and fed scraps of cooked meat; the rest end up on the chopping block. These homeless sods are too [frightened](/3-Mechanics/CLI/Rules/conditions.md#Frightened) of [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) to speak ill of him, and the City Watch doesn't seem to care about crimes committed in the Field Ward.

#### Thrakkus the Butcher

The butcher has no time to suffer fools, and the characters are fools for meddling in his business. [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) spends most of the day in the butchery. At dusk, he retires to his apartment, where he stays until dawn or until someone comes knocking with a body to dispose of. [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) carries keys to the butchery, the larder, and his apartment (W7).

[Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) is a dragonborn [berserker](/3-Mechanics/CLI/Compendium/bestiary/humanoid/berserker.md) of red dragon ancestry, with these changes:

- He is chaotic evil.  
- He has these racial traits: He can use his action to exhale a 15-foot cone of fire (but can't do this again until he finishes a short or long rest); each creature in the cone must make a DC 13 Dexterity saving throw, taking `dice:2d6|noform|noparens|avg` (`2d6`) fire damage on a failed save, or half as much damage on a successful one. He has resistance to fire damage. He speaks Common and Draconic.  

#### Where's the Stone?

[Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) hid the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) in a recent meat delivery to an alley in the Trades Ward. [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) doesn't keep records of his illegal transactions, so the characters must interrogate him or one of the commoners that dwell in his residence.

[Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) is belligerent and not eager to give up his Zhent friends. A [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md) spell or similar magic is needed to compel him to talk. His squatters are another matter; they roll over on [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) quickly to save their own skins once the dragonborn butcher no longer becomes a factor in their well-being. Either approach yields the following information:

- [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md)'s last shipment of meat was taken to a shop in the Trades Ward called Cuttle's Meat Pies. It's located in an alley.  
- The meat was delivered by a member of the Guild of Butchers named Justyn Rassk. [Thrakkus](/3-Mechanics/CLI/Compendium/bestiary/npc/thrakkus-wdh.md) paid extra coin to see it delivered "quickly and quietly."  
...
![](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-door.webp#center)

At the end of an encounter chain, a character who is attuned to the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) can learn the location of the Vault of Dragons and what three keys are needed to open its doors. The artifact also reveals that an adult gold dragon named [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) guards the vault.
...
- [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) sends either five [goblins](/3-Mechanics/CLI/Compendium/bestiary/humanoid/goblin.md) dressed up as children wearing Trolltide masks and a [bugbear](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bugbear.md) (70 percent chance), or four [wererats](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md) in human form (30 percent chance).  
- The Cassalanters send two [imps](/3-Mechanics/CLI/Compendium/bestiary/fiend/imp.md) in raven form, three human [cultists](/3-Mechanics/CLI/Compendium/bestiary/humanoid/cultist.md), and either a human [cult fanatic](/3-Mechanics/CLI/Compendium/bestiary/humanoid/cult-fanatic.md) (70 percent chance), or four [spined devils](/3-Mechanics/CLI/Compendium/bestiary/fiend/spined-devil.md) (30 percent chance).  
- [Jarlaxle Baenre](/3-Mechanics/CLI/Compendium/bestiary/npc/jarlaxle-baenre-wdh.md) sends [Fel'rekt Lafeen](/3-Mechanics/CLI/Compendium/bestiary/npc/felrekt-lafeen-wdh.md) and [Krebbyg Masq'il'yr](/3-Mechanics/CLI/Compendium/bestiary/npc/krebbyg-masqilyr-wdh.md), or two other Bregan D'aerthe [drow gunslingers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B), and six [drow](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow.md).  
- [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) sends four Zhent [martial arts adepts](/3-Mechanics/CLI/Compendium/bestiary/humanoid/martial-arts-adept-mpmm.md) (see appendix B). There's a 50 percent chance that these Zhents are led by one of [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)'s lieutenants, either Vevette Blackwater or Agorn Fuoco, if they're still alive (see chapter 8, E8).  
...
The characters can purchase a 10-pound adamantine bar for 1,000 gp. The genasi smiths [Embric](/3-Mechanics/CLI/Compendium/bestiary/npc/embric-wdh.md) and [Avi](/3-Mechanics/CLI/Compendium/bestiary/npc/avi-wdh.md) (see chapter 2, T3) can acquire one if the characters think to ask them.

#### Animated Construct

Any creature of the construct type works as this key, provided the creature hasn't been destroyed or rendered inoperable. If the characters have befriended [Valetta](/3-Mechanics/CLI/Compendium/bestiary/npc/valetta-wdh.md), the dragonborn priest of Gond (see chapter 3), she happily releases Nim the [nimblewright](/3-Mechanics/CLI/Compendium/bestiary/construct/nimblewright-wdh.md) into their custody until they no longer have need of it. An object animated by the [animate objects](/3-Mechanics/CLI/Compendium/spells/animate-objects.md) spell also qualifies as this key.
...
The eyestalk need not come from a true, living beholder. It can be plucked from a stuffed beholder (see "Old Xoblob Shop") or obtained from a lesser form of beholderkin, such as a gazer or a spectator. The eyestalk also need not be detached. [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) (see appendix B) gladly accompanies characters to the vault if that's the way to guarantee getting its share of the treasure. Regardless of the arrangement it makes with the characters, "its share" equates to all the treasure. In other words, [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) turns on the party once the vault is unlocked, unless a powerful NPC (such as [Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md) or [Vajra Safahr](/3-Mechanics/CLI/Compendium/bestiary/npc/vajra-safahr-wdh.md)) is present to keep the mad beholder in check.

#### Bronze Dragon Scale

Zelifarn, a young bronze dragon, has taken up residence in Deepwater Harbor. Many sailors and dock workers have seen the dragon, and [Grinda Garloth](/3-Mechanics/CLI/Compendium/bestiary/npc/grinda-garloth-wdh.md) (see "Encounter 2: Mistshore"), owns an apparatus of Kwalish that characters can use to search for the dragon. Characters who go looking for Zelifarn find him lurking inside a shipwreck 120 feet underwater. As the characters approach the wreck, Zelifarn comes out and tries to scare them away. (He's not done searching the wreck for treasure.) He inflicts harm only in self-defense. A successful DC 15 Charisma (Persuasion) check or an offer of treasure worth at least 1,000 gp convinces the dragon to talk with the characters and part with one of his scales. If the characters mention the contents of the Vault of Dragons, Zelifarn demands a promise of 10 percent of the gold before he gives them what they came for.
...
[Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md), the Open Lord of Waterdeep, was once the queen of an ancient kingdom called Stornanter. The characters can recall this fact with a successful DC 20 Intelligence (History) check or learn it through information gathering. They can request an audience with Laeral through [Jalester Silvermane](/3-Mechanics/CLI/Compendium/bestiary/npc/jalester-silvermane-wdh.md) or [Mirt](/3-Mechanics/CLI/Compendium/bestiary/npc/mirt-wdh.md). Laeral gives them a gift—a feather quill given to her by the archmage Elminster himself—if they promise to return the stolen gold to Waterdeep's coffers.

#### Invisible creature

Any creature under the effect of an [invisibility](/3-Mechanics/CLI/Compendium/spells/invisibility.md) spell counts as this key, as do naturally [invisible](/3-Mechanics/CLI/Rules/conditions.md#Invisible) creatures.

#### Painting of a dwarf miner

A painting of a dwarf miner priced at `dice:5d10|noform|noparens|avg` (`5d10`) gp can be found each day a character spends searching art shops. A character proficient with painter's supplies can create a painting that qualifies as this key. It takes `dice:3d6|noform|noparens|avg` (`3d6`) hours to finish the painting.

#### Pair of bugbear ears

The Xanathar Guild employs [bugbears](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bugbear.md), and characters can chop the ears off any of them. A live bugbear also counts as this key.
...
This ghastly key can be forcibly obtained from a member of Bregan D'aerthe or some other dark elf. If the characters have encountered no drow, they might hear rumors that [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) employs a drow advisor.

#### Shapechanger

Any living creature of the shapechanger subtype, such as a [doppelganger](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/doppelganger.md) or a [wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md), serves as this key. [Bonnie](/3-Mechanics/CLI/Compendium/bestiary/npc/bonnie-wdh.md) the doppelganger (see "Familiar Faces") can be persuaded to accompany the characters if she is friendly toward one or more of them. The characters can also reach out to the Shard Shunners, a local gang of halfling wererats. For an up-front payment of 500 gp, the wererats happily oblige.

#### Silvered warhammer

The characters can buy a [silvered warhammer](/3-Mechanics/CLI/Compendium/items/silvered-weapon.md) for 115 gp, or they can give a silver bar to [Embric](/3-Mechanics/CLI/Compendium/bestiary/npc/embric-wdh.md) and [Avi](/3-Mechanics/CLI/Compendium/bestiary/npc/avi-wdh.md) (see chapter 2, T3) and have the genasi smiths craft one.

#### Sunlight

Since the vault lies deep underground, natural sunlight is difficult to come by. Clever characters can buy twenty steel mirrors (5 gp each) and arrange them in places (and at the proper angles) so that sunlight from outside can be reflected underground and shone upon the vault entrance. Setting up these mirrors and getting their alignment just right takes `dice:2d4+2|noform|noparens|avg` (`2d4 + 2`) hours regardless of the number of characters involved.

#### Unicorn

Although conjuring up a real unicorn is likely beyond the abilities of the characters, they could ask [Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md) or [Vajra Safahr](/3-Mechanics/CLI/Compendium/bestiary/npc/vajra-safahr-wdh.md) to cast the [conjure celestial](/3-Mechanics/CLI/Compendium/spells/conjure-celestial.md) spell. The characters can gain an audience with Laeral or Vajra through [Renaer Neverember](/3-Mechanics/CLI/Compendium/bestiary/npc/renaer-neverember-wdh.md) or another well-connected NPC. If the characters tell Laeral or Vajra the truth about the Vault of Dragons and promise to turn the gold over to the authorities, either one agrees to accompany the characters to the vault and cast the spell. The unicorn need not be a real unicorn to serve as this key. The Sea Maidens Faire (see chapter 7) uses a unicorn float in its parades, and a stuffed unicorn can be found in Cassalanter Villa (see chapter 6, C18).

![A gold dragon guards a pile of golden dragons](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-of-dragons.webp#center)

## Vault of Dragons

Once the characters have the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md), they can use it to determine the location of the Vault of Dragons and the keys needed to enter it.
...
> [!gallery]
> ![Vault of Dragons](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-of-dragons-dm.webp#gallery)
> ![Vault of Dragons, Main Level (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-main-players.webp#gallery)
> ![Vault of Dragons, Lower Level (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-lower-players.webp#gallery)
> ![Vault of Dragons, Upper Level (Player Version)](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/vault-upper-players.webp#gallery)
...
- The west wall bears a cracked mosaic that depicts a dwarf smith at a forge, crafting dwarves out of black metal and [diamonds](/3-Mechanics/CLI/Compendium/items/diamond.md). (In the south end of the wall is a secret door.)  
...
A little more than halfway down the hall, a section of the western mural has broken off, forming a heap of shattered tile on the floor. A crack in the wall conceals a [black pudding](/3-Mechanics/CLI/Compendium/bestiary/ooze/black-pudding.md) that gushes out and attacks characters who inspect the damage.

##### Secret Door

A character who searches the hall for secret doors and succeeds on a DC 17 Wisdom (Perception) check notices the outline of a secret door that leads to V5. The door opens automatically when a dwarf (or a creature transformed into a dwarf with an [alter self](/3-Mechanics/CLI/Compendium/spells/alter-self.md) spell or similar magic) touches it; otherwise, a successful DC 17 Strength (Athletics) check is needed to push open the heavy door.
...
This room holds five copper urns (worth 25 gp each). Urn 1 contains five tourmalines (worth 100 gp each) mixed in with 200 cp. Urn 2 contains a [ring of warmth](/3-Mechanics/CLI/Compendium/items/ring-of-warmth.md) mixed in with ten ordinary gold rings (worth 25 gp each) and 650 sp. Urn 3 is piled high with 250 gp. Urn 4 holds 33 blue quartz gemstones (worth 10 gp each). Urn 5 holds a 9-inch-tall silver statuette of a dwarf priest of Moradin with amethyst eyes (worth 250 gp and weighing 10 pounds).

#### V6. Hammer and Anvil

The adamantine door to this room has an [arcane lock](/3-Mechanics/CLI/Compendium/spells/arcane-lock.md) spell cast on it, but it swings open when a dwarf or a creature transformed into a dwarf touches it. Another creature can force it open with a successful DC 21 Strength (Athletics) check. A [knock](/3-Mechanics/CLI/Compendium/spells/knock.md) spell or similar magic also opens it. The door swings into the room on stiff adamantine hinges.
...
A successful DC 17 Intelligence (Religion) check enables a character to recognize the statue as a depiction of Gorm Gulthyn, the dwarven god of vigilance also known as Fire Eyes. The statue melds seamlessly with the floor and can't be toppled. It also seems impervious to damage. A [detect magic](/3-Mechanics/CLI/Compendium/spells/detect-magic.md) spell reveals an aura of evocation magic on the statue.

The trapdoor is false and can't be lifted. Anyone who touches the trapdoor or its pull ring must succeed on a DC 18 Dexterity saving throw or be struck by rays of magical fire that spring from the statue's eyes, dealing `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) fire damage. The trap doesn't trigger if the target has total cover.

![Barok Clanghammer](/3-Mechanics/CLI/Compendium/adventures/waterdeep-dragon-heist/img/aurinax.webp#center)
...
The dwarf, who calls himself Barok Clanghammer, is really the [adult gold dragon](/3-Mechanics/CLI/Compendium/bestiary/dragon/adult-gold-dragon.md) [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) (see appendix B) in disguise. He guards the gold for Lord Dagult Neverember and holds the [dragonstaff of Ahghairon](/3-Mechanics/CLI/Compendium/items/dragonstaff-of-ahghairon-wdh.md) (see appendix A) in exchange for his services. Dealing with the gold dragon presents an unusual challenge for the characters, and a peaceful resolution is more likely to benefit them than a violent one.

[Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) is patient, wise, merciful, and vigilant. He remains in humanoid form until combat breaks out, since he can't easily carry the [dragonstaff of Ahghairon](/3-Mechanics/CLI/Compendium/items/dragonstaff-of-ahghairon-wdh.md) in dragon form. The dragon attacks only in defense of itself, the staff, or the gold. The only individuals authorized to remove the gold under [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md)'s watch are Dagult Neverember and his appointed vassals, none of whom are currently in Waterdeep.

The characters can try to convince [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) that they have come on Neverember's behalf. Since he has never met them before or heard Neverember mention them by name, [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) is doubtful of their story. Fooling the dragon requires each character within his line of sight to succeed on a Charisma (Deception) check contested by the dragon's Wisdom (Insight) check. If even one character loses the contest, [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) senses that the group is lying to him. These checks are made with advantage if [Renaer Neverember](/3-Mechanics/CLI/Compendium/bestiary/npc/renaer-neverember-wdh.md) is with the party, since the dragon remembers meeting Renaer when he was but a child and can easily imagine a scenario in which Dagult Neverember might use his son as his vassal. (The dragon knows nothing of the animosity between Renaer and his father.)

The characters can try to convince the noble dragon that Lord Neverember embezzled the gold from the people of Waterdeep, and that it would be fair and just to see the coin safely returned to its rightful owners. Deep down, [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) knows where the gold came from, but the dragon has allowed his greed and his agreement with Lord Neverember to cloud his moral judgment. With a successful DC 18 Charisma (Persuasion) check, a character can talk the dragon into allowing the gold to be returned to the people to whom it rightfully belongs. The check is made with advantage if the characters brought a prominent city official with them, such as [Mirt](/3-Mechanics/CLI/Compendium/bestiary/npc/mirt-wdh.md) or [Vajra Safahr](/3-Mechanics/CLI/Compendium/bestiary/npc/vajra-safahr-wdh.md), or if one of the characters professes to be a worshiper of Bahamut.

Any Charisma (Intimidation) check made to influence [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) automatically fails. After the first such attempt, all future Charisma checks made by the party to influence [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) have disadvantage.

[Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) uses Legendary Resistance to avoid being [charmed](/3-Mechanics/CLI/Rules/conditions.md#Charmed). If a character tries to charm him with a spell and fails, all future Charisma checks made by the party to influence [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) have disadvantage.

##### Treasure

Choose two alcoves in the vault. Piled in one alcove are 500,000 gp, the combined weight of which is 10,000 pounds. Scattered on the floor of the second alcove are sixty-five 100 gp gemstones-all that remains of [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md)'s current food supply.

[Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) won't give up his gemstones or the [dragonstaff of Ahghairon](/3-Mechanics/CLI/Compendium/items/dragonstaff-of-ahghairon-wdh.md) willingly, since they are his payment for guarding the gold. If need be, however, the dragon is willing to use the staff's power on behalf of the city in exchange for more gemstones.
...
- If [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) is the main villain, [Noska Ur'gray](/3-Mechanics/CLI/Compendium/bestiary/npc/noska-urgray-wdh.md) (see appendix B) arrives with six [bugbears](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bugbear.md) and a [gazer](/3-Mechanics/CLI/Compendium/bestiary/aberration/gazer-mpmm.md) (see appendix B). If Noska is dead or otherwise indisposed, the beholder replaces him with [Nar'l Xibrindas](/3-Mechanics/CLI/Compendium/bestiary/npc/narl-xibrindas-wdh.md) (see appendix B) and his [grell](/3-Mechanics/CLI/Compendium/bestiary/aberration/grell.md) bodyguard.  
- If the Cassalanters are the villains, they send three [cult fanatics](/3-Mechanics/CLI/Compendium/bestiary/humanoid/cult-fanatic.md) and three [cultists](/3-Mechanics/CLI/Compendium/bestiary/humanoid/cultist.md). Victoro's [doppelganger](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/doppelganger.md) manservant, [Willifort Crowelle](/3-Mechanics/CLI/Compendium/bestiary/npc/willifort-crowelle-wdh.md), leads the group in his tiefling guise unless the characters killed him or otherwise disposed of him earlier in this chapter or in chapter 6.  
- If [Jarlaxle Baenre](/3-Mechanics/CLI/Compendium/bestiary/npc/jarlaxle-baenre-wdh.md) (see appendix B) is the villain, he arrives with three [drow gunslingers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B). Replace no-name drow gunslingers with [Fel'rekt Lafeen](/3-Mechanics/CLI/Compendium/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](/3-Mechanics/CLI/Compendium/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](/3-Mechanics/CLI/Compendium/bestiary/npc/soluun-xibrindas-wdh.md) if they are alive and free.  
- If [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) is the main villain, he sends his simulacrum (see appendix B) along with Agorn Fuoco (NE male Turami human [bard](/3-Mechanics/CLI/Compendium/bestiary/humanoid/bard-mpmm.md); see appendix B), Vevette Blackwater (CE female Tethyrian human [swashbuckler](/3-Mechanics/CLI/Compendium/bestiary/humanoid/swashbuckler-mpmm.md); see appendix B), and three Zhent [thugs](/3-Mechanics/CLI/Compendium/bestiary/humanoid/thug.md). If Agorn and Vevette were killed or otherwise disposed of earlier in this chapter or in chapter 8, replace each of them with one additional [thug](/3-Mechanics/CLI/Compendium/bestiary/humanoid/thug.md).  

The forces sent by [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md), the Cassalanters, and [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) attack the characters on sight. Jarlaxle, on the other hand, congratulates characters for unlocking the Vault of Dragons and allows them to leave on the condition that they go empty-handed. He intends to see the gold safely returned to the city of Waterdeep but also demands the [dragonstaff of Ahghairon](/3-Mechanics/CLI/Compendium/items/dragonstaff-of-ahghairon-wdh.md) for his trouble.

If [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) is alive, the characters can lure enemies to the dragon. [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) attacks any creature that attacks him or tries to steal his staff or the gold. He also defends the characters if he has made a deal with them.
...
If [Jarlaxle Baenre](/3-Mechanics/CLI/Compendium/bestiary/npc/jarlaxle-baenre-wdh.md) (see appendix B) isn't the main villain, he arrives with his lieutenants, [Fel'rekt Lafeen](/3-Mechanics/CLI/Compendium/bestiary/npc/felrekt-lafeen-wdh.md), [Krebbyg Masq'il'yr](/3-Mechanics/CLI/Compendium/bestiary/npc/krebbyg-masqilyr-wdh.md), and [Soluun Xibrindas](/3-Mechanics/CLI/Compendium/bestiary/npc/soluun-xibrindas-wdh.md), or three other [drow gunslingers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B). Jarlaxle offers to help the characters if they agree to help him secure the gold for Waterdeep and the [dragonstaff of Ahghairon](/3-Mechanics/CLI/Compendium/items/dragonstaff-of-ahghairon-wdh.md) for himself.

##### Harpers

[Mirt](/3-Mechanics/CLI/Compendium/bestiary/npc/mirt-wdh.md) (see appendix B) arrives with two female human [swashbucklers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/swashbuckler-mpmm.md) (see appendix B). If he's still alive and not already with the characters, [Renaer Neverember](/3-Mechanics/CLI/Compendium/bestiary/npc/renaer-neverember-wdh.md) (see appendix B) replaces one of the swashbucklers.

##### Emerald Enclave

Jeryth Phaulkon sends three [swarms of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md) to assist the characters. Once the characters are no longer in peril, the rats disperse throughout the vault.

##### Force Grey

[Vajra Safahr](/3-Mechanics/CLI/Compendium/bestiary/npc/vajra-safahr-wdh.md) sends [Meloon Wardragon](/3-Mechanics/CLI/Compendium/bestiary/npc/meloon-wardragon-wdh.md) (see appendix B) to help the characters secure the vault, unaware that Meloon has fallen under [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md)'s sway. If [Xanathar](/3-Mechanics/CLI/Compendium/bestiary/npc/xanathar-wdh.md) is the main villain, Meloon helps the beholder's forces defeat the characters.

##### Lords' Alliance

Open Lord [Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md) (see appendix B) arrives with [Jalester Silvermane](/3-Mechanics/CLI/Compendium/bestiary/npc/jalester-silvermane-wdh.md) (see appendix B) and six City Guard [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md) to help characters secure the gold. Laeral's arrival forces Jarlaxle to be on his best behavior. After assuring Laeral of his good intentions, Jarlaxle cuts his losses and withdraws peacefully. If she is able to speak with [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md), Laeral convinces the dragon to relinquish the gold into her custody.

##### Order of the Gauntlet

[Hlam](/3-Mechanics/CLI/Compendium/bestiary/npc/hlam-wdh.md) (see appendix B) arrives and aids the characters as best he can. He and [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) met each other many years ago, and they are on fair speaking terms. [Aurinax](/3-Mechanics/CLI/Compendium/bestiary/npc/aurinax-wdh.md) is fond of the monk, and characters who negotiate with the dragon in [Hlam](/3-Mechanics/CLI/Compendium/bestiary/npc/hlam-wdh.md)'s presence gain advantage on their Charisma (Persuasion) checks.

##### Zhentarim

The Doom Raiders (see appendix B) arrive to help secure the vault, less any members who have been arrested or killed. If [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) is the main villain, [Skeemo Weirdbottle](/3-Mechanics/CLI/Compendium/bestiary/npc/skeemo-weirdbottle-wdh.md) betrays his fellow Doom Raiders and fights alongside [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md)'s simulacrum. If they and the characters emerge victorious, the surviving Doom Raiders propose to split the take evenly with the characters. If the characters refuse this offer and the Doom Raiders outnumber them, the Zhents turn against them, putting characters who are Zhentarim members in a predicament.
...
If the characters die in the Vault of Dragons with the [Stone of Golorr](/3-Mechanics/CLI/Compendium/items/stone-of-golorr-wdh.md) and the main villain doesn't know the vault's location, the secrets of the vault die with them. Though they succumbed in the process, they succeeded in keeping the gold out of the villain's clutches-a bittersweet victory, indeed.
...
[Laeral Silverhand](/3-Mechanics/CLI/Compendium/bestiary/npc/laeral-silverhand-wdh.md) is prepared to let the characters keep one-tenth of the treasure (50,000 gp) for themselves. Even that much coin attracts unwanted attention, in the form of several people who beg loans or donations from them:

- [Emmek Frewn](/3-Mechanics/CLI/Compendium/bestiary/npc/emmek-frewn-wdh.md) (see "Business Rival: [Emmek Frewn](/3-Mechanics/CLI/Compendium/bestiary/npc/emmek-frewn-wdh.md)") needs 1,500 gp to pay off a loan with interest. If he doesn't repay the coin in a tenday, [Istrid Horn](/3-Mechanics/CLI/Compendium/bestiary/npc/istrid-horn-wdh.md) (see appendix B) sends Zhentarim thugs to threaten, if not hurt, him. Emmek comes to the characters with hat in hand, preying on their generosity while denying any wrongdoing on his part.  
- [Davil Starsong](/3-Mechanics/CLI/Compendium/bestiary/npc/davil-starsong-wdh.md) (see appendix B) asks the characters for a donation of 5,000 gp to keep his branch of the Zhentarim afloat in Waterdeep. Recent altercations and legal issues have drained the Doom Raiders' coffers. If the characters refuse, the Doom Raiders are driven out of the city, yielding control of the Zhentarim in Waterdeep to [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md) (if he's alive).  
- [Floon Blagmaar](/3-Mechanics/CLI/Compendium/bestiary/npc/floon-blagmaar-wdh.md) (see appendix B) asks the characters to give him 500 gp to cover a hefty gambling debt. If the characters refuse to give Floon the gold, he vanishes without a trace `dice:1d10|noform|noparens|avg` (`d10`) days later.  
- [Volothamp Geddarm](/3-Mechanics/CLI/Compendium/bestiary/npc/volothamp-volo-geddarm-toa.md) (see appendix B) asks the characters for 5,000 gp to fund an expedition that he hopes will inspire a future book, for which he'll give them special mention in said masterwork. If the characters seem hesitant, Volo reminds them that were it not for his starting them off on this adventure, they wouldn't have the gold in the first place.  
- Jelenn Urmbrusk, a Masked Lord in debt to [Manshoon](/3-Mechanics/CLI/Compendium/bestiary/npc/manshoon-wdh.md), requests an interest-free loan of 10,000 gp, which she vows to repay within a year. In exchange, she promises to use her "considerable influence with the Lords of Waterdeep" to help them in the future. If the characters oblige, she makes good on her promise to pay them back and grants them a special favor (see "Marks of Prestige" in chapter 7 of the "Dungeon Master's Guide"). If they refuse, they will have made an enemy of the secret Masked Lord.  
