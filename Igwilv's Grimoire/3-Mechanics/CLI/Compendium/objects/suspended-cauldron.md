...
Cauldrons can be filled with other liquids, such as acid or [green slime](/3-Mechanics/CLI/Compendium/traps-hazards/green-slime.md), with different effects.

```ad-statblock
title: Suspended Cauldron
![](/3-Mechanics/CLI/Compendium/objects/token/suspended-cauldron.webp#token)
*Large Siege weapon*
