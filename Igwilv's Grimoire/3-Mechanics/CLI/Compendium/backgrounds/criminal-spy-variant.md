...
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)  
- **Equipment.** A [crowbar](/3-Mechanics/CLI/Compendium/items/crowbar.md), a set of dark [common clothes](/3-Mechanics/CLI/Compendium/items/common-clothes.md) including a hood, and a belt [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 15 gp  
