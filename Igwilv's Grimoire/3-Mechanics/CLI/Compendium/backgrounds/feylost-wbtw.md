...
![](/3-Mechanics/CLI/Compendium/backgrounds/img/feylost.webp#right)
...
- **Equipment.** A musical instrument (one of your choice), a [set of traveler's clothes](/3-Mechanics/CLI/Compendium/items/travelers-clothes.md), three trinkets (each determined by rolling on the [Feywild Trinkets](/3-Mechanics/CLI/Compendium/items/feywild-trinket-wbtw.md) table), and a [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 8 gp  
...
| dice: d8 | Visitor |
|----------|---------|
| 1 | Awakened creature (a Beast or an ordinary plant that has had the [awaken](/3-Mechanics/CLI/Compendium/spells/awaken.md) spell cast on it) |
| 2 | [Centaur](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/centaur.md) |
| 3 | [Dryad](/3-Mechanics/CLI/Compendium/bestiary/fey/dryad.md) |
| 4 | [Faerie dragon](/3-Mechanics/CLI/Compendium/bestiary/dragon/faerie-dragon-violet.md) |
| 5 | [Pixie](/3-Mechanics/CLI/Compendium/bestiary/fey/pixie.md) |
| 6 | [Satyr](/3-Mechanics/CLI/Compendium/bestiary/fey/satyr.md) |
| 7 | [Sprite](/3-Mechanics/CLI/Compendium/bestiary/fey/sprite.md) |
| 8 | [Unicorn](/3-Mechanics/CLI/Compendium/bestiary/celestial/unicorn.md) |
^feywild-visitor
