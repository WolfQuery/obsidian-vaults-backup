...
- **Tool Proficiencies.** [Disguise kit](/3-Mechanics/CLI/Compendium/items/disguise-kit.md), [Forgery kit](/3-Mechanics/CLI/Compendium/items/forgery-kit.md)  
- **Equipment.** A set of [fine clothes](/3-Mechanics/CLI/Compendium/items/fine-clothes.md), a [disguise kit](/3-Mechanics/CLI/Compendium/items/disguise-kit.md), tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 15 gp  
