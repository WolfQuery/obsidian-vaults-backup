...
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](/3-Mechanics/CLI/Compendium/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](/3-Mechanics/CLI/Compendium/items/mule.md) and [cart](/3-Mechanics/CLI/Compendium/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](/3-Mechanics/CLI/Compendium/items/travelers-clothes.md), and a belt [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 15 gp  
