...
- **Equipment.** An insignia of rank, a trophy taken from a fallen enemy (a [dagger](/3-Mechanics/CLI/Compendium/items/dagger.md), broken blade, or piece of a banner), a bone [dice set](/3-Mechanics/CLI/Compendium/items/dice-set.md) or [playing card set](/3-Mechanics/CLI/Compendium/items/playing-card-set.md), a set of [common clothes](/3-Mechanics/CLI/Compendium/items/common-clothes.md), and a belt [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 10 gp  
