...
- **Equipment.** A [holy symbol](/3-Mechanics/CLI/Compendium/items/holy-symbol.md) (a gift to you when you entered the priesthood), a prayer [book](/3-Mechanics/CLI/Compendium/items/book.md) or prayer wheel, 5 sticks of incense, vestments, a set of [common clothes](/3-Mechanics/CLI/Compendium/items/common-clothes.md), and a belt [pouch](/3-Mechanics/CLI/Compendium/items/pouch.md) containing 15 gp  
