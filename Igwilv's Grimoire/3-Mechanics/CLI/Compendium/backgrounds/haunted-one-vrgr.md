...
![](/3-Mechanics/CLI/Compendium/backgrounds/img/haunted-one.webp#right)
...
- **Equipment.** [Monster hunter's pack](/3-Mechanics/CLI/Compendium/items/monster-hunters-pack-vrgr.md) (containing a [chest](/3-Mechanics/CLI/Compendium/items/chest.md), a [crowbar](/3-Mechanics/CLI/Compendium/items/crowbar.md), a [hammer](/3-Mechanics/CLI/Compendium/items/hammer.md), three wooden stakes, a [holy symbol](/3-Mechanics/CLI/Compendium/items/holy-symbol.md), a [flask of holy water](/3-Mechanics/CLI/Compendium/items/holy-water-flask.md), a [set of manacles](/3-Mechanics/CLI/Compendium/items/manacles.md), a [steel mirror](/3-Mechanics/CLI/Compendium/items/steel-mirror.md), a [flask of oil](/3-Mechanics/CLI/Compendium/items/oil-flask.md), a [tinderbox](/3-Mechanics/CLI/Compendium/items/tinderbox.md), and 3 [torches](/3-Mechanics/CLI/Compendium/items/torch.md)), a set of [common clothes](/3-Mechanics/CLI/Compendium/items/common-clothes.md), one trinket of special significance (choose one or roll on the [Horror Trinkets](/3-Mechanics/CLI/Compendium/items/horror-trinket-vrgr.md) table), and 1 sp  
