...
![](/3-Mechanics/CLI/Compendium/backgrounds/img/investigator.webp#right)
...
- **Tool Proficiencies.** [Disguise kit](/3-Mechanics/CLI/Compendium/items/disguise-kit.md), [Thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md)  
- **Equipment.** A [magnifying glass](/3-Mechanics/CLI/Compendium/items/magnifying-glass.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](/3-Mechanics/CLI/Compendium/items/horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](/3-Mechanics/CLI/Compendium/items/common-clothes.md), and 10 gp  
