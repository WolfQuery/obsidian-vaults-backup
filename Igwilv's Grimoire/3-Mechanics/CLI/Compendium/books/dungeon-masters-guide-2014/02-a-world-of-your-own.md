...
![A Sample Pantheon; Dawn War Deities](/3-Mechanics/CLI/Compendium/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](/3-Mechanics/CLI/Compendium/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](/3-Mechanics/CLI/Compendium/tables/government-sample-hierarchy-of-noble-titles.md)
...
![World-Shaking Events](/3-Mechanics/CLI/Compendium/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](/3-Mechanics/CLI/Compendium/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](/3-Mechanics/CLI/Compendium/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](/3-Mechanics/CLI/Compendium/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](/3-Mechanics/CLI/Compendium/tables/extinction-or-depletion.md)
...
![New Organizations](/3-Mechanics/CLI/Compendium/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](/3-Mechanics/CLI/Compendium/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](/3-Mechanics/CLI/Compendium/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](/3-Mechanics/CLI/Compendium/spells/fireball.md) and [lightning bolt](/3-Mechanics/CLI/Compendium/spells/lightning-bolt.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](/3-Mechanics/CLI/Compendium/spells/teleportation-circle.md), [scrying](/3-Mechanics/CLI/Compendium/spells/scrying.md), [flame strike](/3-Mechanics/CLI/Compendium/spells/flame-strike.md), [legend lore](/3-Mechanics/CLI/Compendium/spells/legend-lore.md), and [raise dead](/3-Mechanics/CLI/Compendium/spells/raise-dead.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](/3-Mechanics/CLI/Compendium/spells/disintegrate.md), [blade barrier](/3-Mechanics/CLI/Compendium/spells/blade-barrier.md), and [heal](/3-Mechanics/CLI/Compendium/spells/heal.md), for example-but behind-the-scenes spells such as [word of recall](/3-Mechanics/CLI/Compendium/spells/word-of-recall.md), [find the path](/3-Mechanics/CLI/Compendium/spells/find-the-path.md), [contingency](/3-Mechanics/CLI/Compendium/spells/contingency.md), [teleport](/3-Mechanics/CLI/Compendium/spells/teleport.md), and [true seeing](/3-Mechanics/CLI/Compendium/spells/true-seeing.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](/3-Mechanics/CLI/Compendium/spells/wish.md), [gate](/3-Mechanics/CLI/Compendium/spells/gate.md), [storm of vengeance](/3-Mechanics/CLI/Compendium/spells/storm-of-vengeance.md), and [astral projection](/3-Mechanics/CLI/Compendium/spells/astral-projection.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](/3-Mechanics/CLI/Compendium/items/vorpal-sword.md) or a [staff of the magi](/3-Mechanics/CLI/Compendium/items/staff-of-the-magi.md).
...
![Starting at Higher Level; Starting Equipment](/3-Mechanics/CLI/Compendium/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](/3-Mechanics/CLI/Compendium/tables/wuxia-weapon-names.md)
