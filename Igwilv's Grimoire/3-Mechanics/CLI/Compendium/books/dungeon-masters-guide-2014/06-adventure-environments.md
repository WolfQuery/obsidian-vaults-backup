...
![Dungeon Location](/3-Mechanics/CLI/Compendium/tables/dungeon-location.md)

![Dungeon Location; Exotic Location](/3-Mechanics/CLI/Compendium/tables/dungeon-location-exotic-location.md)
...
![Dungeon Creator](/3-Mechanics/CLI/Compendium/tables/dungeon-creator.md)

![Dungeon Creator; Cults and Religions](/3-Mechanics/CLI/Compendium/tables/dungeon-creator-cults-and-religions.md)

![Dungeon Creator; NPC Alignment](/3-Mechanics/CLI/Compendium/tables/dungeon-creator-npc-alignment.md)

![Dungeon Creator; NPC Class](/3-Mechanics/CLI/Compendium/tables/dungeon-creator-npc-class.md)
...
![Dungeon Purpose](/3-Mechanics/CLI/Compendium/tables/dungeon-purpose.md)
...
![Dungeon History](/3-Mechanics/CLI/Compendium/tables/dungeon-history.md)
...
Characters who don't have the key to a locked door can pick the lock with a successful Dexterity check (doing so requires [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) and proficiency in their use). They can also force the door with a successful Strength check, smash the door to pieces by dealing enough damage to it, or use a knock spell or similar magic. Chapter 8 provides guidelines for setting the DCs and assigning statistics to doors and other objects.
...
![Monuments](/3-Mechanics/CLI/Compendium/tables/monuments.md)
...
![Weird Locales](/3-Mechanics/CLI/Compendium/tables/weird-locales.md)
...
![Weather](/3-Mechanics/CLI/Compendium/tables/weather.md)

![Weather; Wind](/3-Mechanics/CLI/Compendium/tables/weather-wind.md)

![Weather; Precipitation](/3-Mechanics/CLI/Compendium/tables/weather-precipitation.md)
...
![Foraging DCs](/3-Mechanics/CLI/Compendium/tables/foraging-dcs.md)
...
![Food and Water Needs](/3-Mechanics/CLI/Compendium/tables/food-and-water-needs.md)
...
If the Wisdom ([Survival](/3-Mechanics/CLI/Rules/skills.md#Survival)) check succeeds, the party travels in the desired direction without becoming lost. If the check fails, the party inadvertently travels in the wrong direction and becomes lost. The party's navigator can repeat the check after the party spends `dice:1d6|noform|noparens|avg` (`d6`) hours trying to get back on course.

![Becoming Lost; Wilderness Navigation](/3-Mechanics/CLI/Compendium/tables/becoming-lost-wilderness-navigation.md)
...
![Random Settlements; Race Relations](/3-Mechanics/CLI/Compendium/tables/random-settlements-race-relations.md)

![Random Settlements; Ruler's Status](/3-Mechanics/CLI/Compendium/tables/random-settlements-rulers-status.md)

![Random Settlements; Notable Traits](/3-Mechanics/CLI/Compendium/tables/random-settlements-notable-traits.md)

![Random Settlements; Known For Its...](/3-Mechanics/CLI/Compendium/tables/random-settlements-known-for-its.md)

![Random Settlements; Current Calamity](/3-Mechanics/CLI/Compendium/tables/random-settlements-current-calamity.md)
...
![Random Buildings; Building Type](/3-Mechanics/CLI/Compendium/tables/random-buildings-building-type.md)

![Random Buildings; Residence](/3-Mechanics/CLI/Compendium/tables/random-buildings-residence.md)

![Random Buildings; Religious Building](/3-Mechanics/CLI/Compendium/tables/random-buildings-religious-building.md)

![Random Buildings; Tavern](/3-Mechanics/CLI/Compendium/tables/random-buildings-tavern.md)

![Random Buildings; Tavern Name Generator](/3-Mechanics/CLI/Compendium/tables/random-buildings-tavern-name-generator.md)

![Random Buildings; Warehouse](/3-Mechanics/CLI/Compendium/tables/random-buildings-warehouse.md)

![Random Buildings; Shop](/3-Mechanics/CLI/Compendium/tables/random-buildings-shop.md)
...
![Random Urban Encounters](/3-Mechanics/CLI/Compendium/tables/random-urban-encounters.md)
...
You can determine the trinket by rolling on the [Trinkets table](/3-Mechanics/CLI/Compendium/items/trinket.md) in the *Player's Handbook*.
...
![Random Undersea Encounters](/3-Mechanics/CLI/Compendium/tables/random-undersea-encounters.md)
...
![Underwater Encounter Distance](/3-Mechanics/CLI/Compendium/tables/underwater-encounter-distance.md)
...
![Random Encounters at Sea](/3-Mechanics/CLI/Compendium/tables/random-encounters-at-sea.md)
...
![Owning a Ship; Airborne and Waterborne Vehicles](/3-Mechanics/CLI/Compendium/tables/owning-a-ship-airborne-and-waterborne-vehicles.md)
...
![Trap Effects; Trap Save DCs and Attack Bonuses](/3-Mechanics/CLI/Compendium/tables/trap-effects-trap-save-dcs-and-attack-bonuses.md)

![Trap Effects; Damage Severity by Level](/3-Mechanics/CLI/Compendium/tables/trap-effects-damage-severity-by-level.md)
