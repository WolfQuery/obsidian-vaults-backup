...
![Explosives](/3-Mechanics/CLI/Compendium/tables/explosives.md)
...
![Speed Factor Initiative Modifiers](/3-Mechanics/CLI/Compendium/tables/speed-factor-initiative-modifiers.md)
...
![Lingering Injuries](/3-Mechanics/CLI/Compendium/tables/lingering-injuries.md)
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](/3-Mechanics/CLI/Compendium/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](/3-Mechanics/CLI/Compendium/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](/3-Mechanics/CLI/Compendium/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](/3-Mechanics/CLI/Compendium/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
![Creating a Monster Stat Block; Monster Features](/3-Mechanics/CLI/Compendium/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](/3-Mechanics/CLI/Compendium/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](/3-Mechanics/CLI/Compendium/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](/3-Mechanics/CLI/Compendium/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](/3-Mechanics/CLI/Compendium/races/aasimar-dmg.md).
