...
![Ability Checks](/3-Mechanics/CLI/Compendium/tables/ability-checks.md)
...
![Saving Throws](/3-Mechanics/CLI/Compendium/tables/saving-throws.md)
...
![Difficulty Class; Typical DCs](/3-Mechanics/CLI/Compendium/tables/difficulty-class-typical-dcs.md)
...
Rolling a 20 or a 1 on an ability check or a saving throw doesn't normally have any special effect. However, you can choose to take such an exceptional roll into account when adjudicating the outcome. It's up to you to determine how this manifests in the game. An easy approach is to increase the impact of the success or failure. For example, rolling a 1 on a failed attempt to pick a lock might break the [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) being used, and rolling a 20 on a successful Intelligence ([Investigation](/3-Mechanics/CLI/Rules/skills.md#Investigation)) check might reveal an extra clue.
...
![Using a Map; Map Travel Pace](/3-Mechanics/CLI/Compendium/tables/using-a-map-map-travel-pace.md)
...
![Tracking DCs](/3-Mechanics/CLI/Compendium/tables/tracking-dcs.md)
...
![Object Armor Class](/3-Mechanics/CLI/Compendium/tables/object-armor-class.md)
...
![Object Hit Points](/3-Mechanics/CLI/Compendium/tables/object-hit-points.md)
...
Krag ([ogre](/3-Mechanics/CLI/Compendium/bestiary/giant/ogre.md) w/ scar): 59  
Thod ([ogre](/3-Mechanics/CLI/Compendium/bestiary/giant/ogre.md) w/ helm): 59  
Mur ([ogre](/3-Mechanics/CLI/Compendium/bestiary/giant/ogre.md) who smells like poo): 59  
...
![Improvising Damage; Damage Severity and Level](/3-Mechanics/CLI/Compendium/tables/improvising-damage-damage-severity-and-level.md)
...
![Adjudicating Areas of Effect; Targets in Areas of Effect](/3-Mechanics/CLI/Compendium/tables/adjudicating-areas-of-effect-targets-in-areas-of-effect.md)
...
![Handling Mobs; Mob Attacks](/3-Mechanics/CLI/Compendium/tables/handling-mobs-mob-attacks.md)
...
![Creature Size on Squares and Hexes; Creature Size and Space](/3-Mechanics/CLI/Compendium/tables/creature-size-on-squares-and-hexes-creature-size-and-space.md)

![](/3-Mechanics/CLI/Compendium/books/dungeon-masters-guide-2014/img/monster_size_chart.webp#center)

![](/3-Mechanics/CLI/Compendium/books/dungeon-masters-guide-2014/img/creature_size_on_squares_and_hexes.webp#center)
...
![](/3-Mechanics/CLI/Compendium/books/dungeon-masters-guide-2014/img/flanking_and_cover_squares.webp#center)
...
![](/3-Mechanics/CLI/Compendium/books/dungeon-masters-guide-2014/img/flanking_and_cover_hexes.webp#center)
...
![Ending a Chase; Escape Factors](/3-Mechanics/CLI/Compendium/tables/ending-a-chase-escape-factors.md)
...
![Urban Chase Complications](/3-Mechanics/CLI/Compendium/tables/urban-chase-complications.md)

![Wilderness Chase Complications](/3-Mechanics/CLI/Compendium/tables/wilderness-chase-complications.md)
...
- [Ballista](/3-Mechanics/CLI/Compendium/objects/ballista.md)  
- [Cannon](/3-Mechanics/CLI/Compendium/objects/cannon.md)  
- [Suspended Cauldron](/3-Mechanics/CLI/Compendium/objects/suspended-cauldron.md)  
- [Mangonel](/3-Mechanics/CLI/Compendium/objects/mangonel.md)  
- [Ram](/3-Mechanics/CLI/Compendium/objects/ram.md)  
- [Siege Tower](/3-Mechanics/CLI/Compendium/objects/siege-tower.md)  
- [Trebuchet](/3-Mechanics/CLI/Compendium/objects/trebuchet.md)  
...
![Poisons](/3-Mechanics/CLI/Compendium/tables/poisons.md)

### Sample Poisons

Each type of poison has its own debilitating effects.

- [Assassin's blood](/3-Mechanics/CLI/Compendium/items/assassins-blood.md)  
- [Burnt othur fumes](/3-Mechanics/CLI/Compendium/items/burnt-othur-fumes.md)  
- [Carrion crawler mucus](/3-Mechanics/CLI/Compendium/items/carrion-crawler-mucus.md)  
- [Drow poison](/3-Mechanics/CLI/Compendium/items/drow-poison.md)  
- [Essence of ether](/3-Mechanics/CLI/Compendium/items/essence-of-ether.md)  
- [Malice](/3-Mechanics/CLI/Compendium/items/malice.md)  
- [Midnight tears](/3-Mechanics/CLI/Compendium/items/midnight-tears.md)  
- [Oil of taggit](/3-Mechanics/CLI/Compendium/items/oil-of-taggit.md)  
- [Pale tincture](/3-Mechanics/CLI/Compendium/items/pale-tincture.md)  
- [Purple worm poison](/3-Mechanics/CLI/Compendium/items/purple-worm-poison.md)  
- [Serpent venom](/3-Mechanics/CLI/Compendium/items/serpent-venom.md)  
- [Torpor](/3-Mechanics/CLI/Compendium/items/torpor.md)  
- [Truth serum](/3-Mechanics/CLI/Compendium/items/truth-serum.md)  
- [Wyvern poison](/3-Mechanics/CLI/Compendium/items/wyvern-poison.md)  
...
During downtime between adventures, a character can use the crafting rules in the Player's Handbook to create basic poison if the character has proficiency with a [poisoner's kit](/3-Mechanics/CLI/Compendium/items/poisoners-kit.md). At your discretion, the character can craft other kinds of poison. Not all poison ingredients are available for purchase, and tracking down certain ingredients might form the basis of an entire adventure.

A character can instead attempt to harvest poison from a poisonous creature, such as a snake, wyvern, or carrion crawler. The creature must be incapacitated or dead, and the harvesting requires `dice:1d6|noform|noparens|avg` (`d6`) minutes followed by a DC 20 Intelligence ([Nature](/3-Mechanics/CLI/Rules/skills.md#Nature)) check. (Proficiency with the [poisoner's kit](/3-Mechanics/CLI/Compendium/items/poisoners-kit.md) applies to this check if the character doesn't have proficiency in Nature.) On a successful check, the character harvests enough poison for a single dose. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
