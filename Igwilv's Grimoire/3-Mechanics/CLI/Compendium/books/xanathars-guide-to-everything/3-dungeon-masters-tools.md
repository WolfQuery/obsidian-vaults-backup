...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `dice:1d6|noform|noparens|avg` (`d6`) bludgeoning damage for every 10 feet you fell, to a maximum of `dice:20d6|noform|noparens|avg` (`20d6`). You also land [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone), unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.

### Rate of Falling

The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/griffon.md) or on board an [airship](/3-Mechanics/CLI/Compendium/items/airship.md)? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](/3-Mechanics/CLI/Compendium/spells/fly.md) spell.
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2001.webp#center)
...
![Determine Numbers and Challenge Ratings; Solo Monster Challenge Rating](/3-Mechanics/CLI/Compendium/tables/determine-numbers-and-challenge-ratings-solo-monster-challenge-rating-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 1st-5th Level](/3-Mechanics/CLI/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-1st-5th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 6th-10th Level](/3-Mechanics/CLI/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-6th-10th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](/3-Mechanics/CLI/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 16th-20th Level](/3-Mechanics/CLI/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-16th-20th-level-xge.md)
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2005.webp#center)
...
![Monster Personality](/3-Mechanics/CLI/Compendium/tables/monster-personality-xge.md)
...
![Monster Relationships](/3-Mechanics/CLI/Compendium/tables/monster-relationships-xge.md)
...
![Quick Matchups](/3-Mechanics/CLI/Compendium/tables/quick-matchups-xge.md)
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2021.webp#center)
...
- [Bear Trap](/3-Mechanics/CLI/Compendium/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](/3-Mechanics/CLI/Compendium/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](/3-Mechanics/CLI/Compendium/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](/3-Mechanics/CLI/Compendium/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](/3-Mechanics/CLI/Compendium/traps-hazards/net-trap-xge.md)  
- [Pit Trap](/3-Mechanics/CLI/Compendium/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](/3-Mechanics/CLI/Compendium/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](/3-Mechanics/CLI/Compendium/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](/3-Mechanics/CLI/Compendium/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2022.webp#center)
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](/3-Mechanics/CLI/Compendium/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)

![Level and Lethality; Damage Severity by Level](/3-Mechanics/CLI/Compendium/tables/level-and-lethality-damage-severity-by-level-xge.md)

![Level and Lethality; Spell Equivalent by Level](/3-Mechanics/CLI/Compendium/tables/level-and-lethality-spell-equivalent-by-level-xge.md)
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md), a Strength ([Athletics](/3-Mechanics/CLI/Rules/skills.md#Athletics)) check, and an Intelligence ([Arcana](/3-Mechanics/CLI/Rules/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) can apply to any trap that has a mechanical element. [Thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2024.webp#center)
...
![Experience for Complex Traps; Complex Trap Experience Awards](/3-Mechanics/CLI/Compendium/tables/experience-for-complex-traps-complex-trap-experience-awards-xge.md)

### Example Complex Traps

The following complex traps can be used to challenge characters or to inspire your own creations.

- [Path of Blades](/3-Mechanics/CLI/Compendium/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](/3-Mechanics/CLI/Compendium/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](/3-Mechanics/CLI/Compendium/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
![Creating a Rival; Rival](/3-Mechanics/CLI/Compendium/tables/creating-a-rival-rival-xge.md)
...
![Buying a Magic Item; Buying Magic Items](/3-Mechanics/CLI/Compendium/tables/buying-a-magic-item-buying-magic-items-xge.md)

![Buying a Magic Item; Magic Item Price](/3-Mechanics/CLI/Compendium/tables/buying-a-magic-item-magic-item-price-xge.md)
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2025.webp#center)
...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](/3-Mechanics/CLI/Compendium/items/disguise-kit.md) and the [Deception](/3-Mechanics/CLI/Rules/skills.md#Deception) skill to pass as a noble visiting from a distant city.
...
![Carousing](/3-Mechanics/CLI/Compendium/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](/3-Mechanics/CLI/Compendium/tables/lower-class-carousing-complications-xge.md)

![Middle-Class Carousing Complications](/3-Mechanics/CLI/Compendium/tables/middle-class-carousing-complications-xge.md)

![Upper-Class Carousing Complications](/3-Mechanics/CLI/Compendium/tables/upper-class-carousing-complications-xge.md)
...
![Crafting an Item; Resources and Resolution](/3-Mechanics/CLI/Compendium/tables/crafting-an-item-resources-and-resolution-xge.md)
...
![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2026.webp#center)
...
![Crafting Magic Items; Magic Item Ingredients](/3-Mechanics/CLI/Compendium/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
![Crafting Magic Items; Magic Item Crafting Time and Cost](/3-Mechanics/CLI/Compendium/tables/crafting-magic-items-magic-item-crafting-time-and-cost-xge.md)
...
![Crafting Complications](/3-Mechanics/CLI/Compendium/tables/crafting-complications-xge.md)
...
![Brewing Potions of Healing; Potion of Healing Creation](/3-Mechanics/CLI/Compendium/tables/brewing-potions-of-healing-potion-of-healing-creation-xge.md)
...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](/3-Mechanics/CLI/Rules/skills.md#Stealth)), Dexterity using [thieves' tools](/3-Mechanics/CLI/Compendium/items/thieves-tools.md), and the player's choice of Intelligence ([Investigation](/3-Mechanics/CLI/Rules/skills.md#Investigation)), Wisdom ([Perception](/3-Mechanics/CLI/Rules/skills.md#Perception)), or Charisma ([Deception](/3-Mechanics/CLI/Rules/skills.md#Deception)).
...
![Crime; Loot Value](/3-Mechanics/CLI/Compendium/tables/crime-loot-value-xge.md)
...
![Crime Complications](/3-Mechanics/CLI/Compendium/tables/crime-complications-xge.md)
...
![Pit Fighting Results](/3-Mechanics/CLI/Compendium/tables/pit-fighting-results-xge.md)
...
![Pit Fighting Complications](/3-Mechanics/CLI/Compendium/tables/pit-fighting-complications-xge.md)
...
![Religious Service](/3-Mechanics/CLI/Compendium/tables/religious-service-xge.md)
...
![Religious Service Complications](/3-Mechanics/CLI/Compendium/tables/religious-service-complications-xge.md)
...
![Research Outcomes](/3-Mechanics/CLI/Compendium/tables/research-outcomes-xge.md)

![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2027.webp#center)
...
![Research Complications](/3-Mechanics/CLI/Compendium/tables/research-complications-xge.md)
...
![Selling a Magic Item; Magic Item Base Prices](/3-Mechanics/CLI/Compendium/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](/3-Mechanics/CLI/Compendium/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![Magic Item Sale Complications](/3-Mechanics/CLI/Compendium/tables/magic-item-sale-complications-xge.md)

![](/3-Mechanics/CLI/Compendium/books/xanathars-guide-to-everything/img/c2028.webp#center)
...
![Training Complications](/3-Mechanics/CLI/Compendium/tables/training-complications-xge.md)
...
![Distribution by Rarity; Magic Items Awarded by Tier](/3-Mechanics/CLI/Compendium/tables/distribution-by-rarity-magic-items-awarded-by-tier-xge.md)
...
![Magic Items Awarded by Rarity - Minor](/3-Mechanics/CLI/Compendium/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](/3-Mechanics/CLI/Compendium/tables/magic-items-awarded-by-rarity-major-xge.md)
