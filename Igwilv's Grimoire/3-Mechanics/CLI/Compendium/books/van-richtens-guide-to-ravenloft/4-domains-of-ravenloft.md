...
![Dr. Viktra Mordenheim, Dar...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/038-03-001-intro-splash.webp#center "Dr. Viktra Mordenheim, Darklord of Lamordia, crafts the perfect body for her newest band of golem-hunting mercenaries")
...
If a domain's borders are open, the domain is still not easy to escape from. The area within the Mists remains heavily obscured, but the Mists don't cause creatures to gain levels of [exhaustion](/3-Mechanics/CLI/Rules/conditions.md#Exhaustion). Characters intent on passing through the Mists travel for `dice:1d6|noform|noparens|avg` (`d6`) hours, then roll on the Wandering the Mists table to determine what happens.

![Wandering the Mists](/3-Mechanics/CLI/Compendium/tables/wandering-the-mists-vrgr.md)
...
![Eerie vendors such as thos...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/039-03-002-eerie-vendors.webp#center "Eerie vendors such as those at the Carnival's Litwick Market deal in unique Mist talismans")
...
The Dark Powers influence magical effects, imparting them with sinister qualities. How these changes manifest are for you to decide and can shift from domain to domain. Do summoned creatures appear undead in one domain or violently mutated in another? Do divination spells rasp in the voices of otherworldly ancients? Do the effects of drinking a [potion of healing](/3-Mechanics/CLI/Compendium/items/potion-of-healing.md) feel like grubs weaving wounds shut from within? Magic looks menacing in the Domains of Dread, but descriptive embellishments shouldn't change the actual effects of spells or magic items.
...
Each domain is its own demiplane, isolated from all other planes including the Material Plane. No spell—not even [wish](/3-Mechanics/CLI/Compendium/spells/wish.md)—allows escape from the Domains of Dread. Spells such as [astral projection](/3-Mechanics/CLI/Compendium/spells/astral-projection.md), [plane shift](/3-Mechanics/CLI/Compendium/spells/plane-shift.md), [teleport](/3-Mechanics/CLI/Compendium/spells/teleport.md), and similar magic cast for the purpose of escaping a domain simply fail, as do effects that banish a creature to another plane. These restrictions apply to all other effects, including magic items and artifacts that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](/3-Mechanics/CLI/Compendium/spells/etherealness.md) spell and the Etherealness feature of ghosts, is the exception to this rule. A creature that enters the Border Ethereal from a domain is pulled back into the domain it left upon leaving the Ethereal.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](/3-Mechanics/CLI/Compendium/spells/sending.md)), each domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally, as does magic that involves an extradimensional space. Spells cast within an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](/3-Mechanics/CLI/Compendium/spells/mordenkainens-magnificent-mansion.md)) are subject to the same restrictions as magic cast within a domain.
...
> [!gallery]
> ![Map 3.1: Barovia](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/040-map-3-1-barovia.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/041-map-3-1-barovia-player.webp#gallery)
...
![In the halls of Castle Rav...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/042-03-003-count-strahd.webp#center "In the halls of Castle Ravenloft, Count Strahd von Zarovich clings to ancient obsessions")
...
Little is known of the origins of the Domains of Dread, but what's certain is that they began here. Strahd's villainy, his connection to his land, and his entanglement with the sinister [priests of Osybus](/3-Mechanics/CLI/Compendium/bestiary/humanoid/priest-of-osybus-vrgr.md) (detailed in "chapter 5") drew all of Barovia into the Shadowfell. This began a succession of torments that haunt the Count still and spill forth to drag others into the Land of the Mists.

#### Strahd's Powers and Dominion

Strahd is a patient and dramatic mastermind. His statistics are similar to those of a [vampire](/3-Mechanics/CLI/Compendium/bestiary/undead/vampire.md) and his spellcasting prowess is formidable, enabling him to face most threats directly. Strahd ever seeks to escape his boredom and draws challenges out for as long as it entertains him. However, if insulted, the Darklord can turn all of Barovia against his foes.
...
![Barovia Adventures](/3-Mechanics/CLI/Compendium/tables/barovia-adventures-vrgr.md)
...
![Who Is Tatyana?; Tatyana's Incarnation](/3-Mechanics/CLI/Compendium/tables/who-is-tatyana-tatyanas-incarnation-vrgr.md)
...
![Connection to Strahd; Avoiding Strahd](/3-Mechanics/CLI/Compendium/tables/connection-to-strahd-avoiding-strahd-vrgr.md)

![Connection to Strahd; Hunting Strahd](/3-Mechanics/CLI/Compendium/tables/connection-to-strahd-hunting-strahd-vrgr.md)
...
![Beyond Barovia; Lost Tatyana](/3-Mechanics/CLI/Compendium/tables/beyond-barovia-lost-tatyana-vrgr.md)

![Tatyana might be reborn in...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/043-03-004-tatyana.webp#center "Tatyana might be reborn in any number of guises, such as Ireena Kolyana or Lyssa von Zarovich")

## Bluetspur

![Memories of Bluetspur prov...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/044-03-005-bluetspur.webp#center "Memories of Bluetspur prove as impossible as they are inescapable")
...
The God-Brain commands untold numbers of [mind flayers](/3-Mechanics/CLI/Compendium/bestiary/aberration/mind-flayer.md), [intellect devourers](/3-Mechanics/CLI/Compendium/bestiary/aberration/intellect-devourer.md), and other creatures. Within Bluetspur, it is constantly telepathically linked with all its servants and knows anything that they know. The God-Brain delegates broad goals to its most effective servants, encouraging them to indulge all manner of radical experiments.
...
![Bluetspur Adventures](/3-Mechanics/CLI/Compendium/tables/bluetspur-adventures-vrgr.md)
...
Both the mind flayers of Bluetspur and the Mists surrounding the domain employ methods similar to the [modify memory](/3-Mechanics/CLI/Compendium/spells/modify-memory.md) spell to obscure victims' memories of their abduction, replacing them with hazy events or gaps of missing time. A character's true memories can be restored by a [remove curse](/3-Mechanics/CLI/Compendium/spells/remove-curse.md) or [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md) spell. A victim of the mind flayers might have endured dozens of memory modifications, each requiring its own magical removal, resulting in the recovery of a few traumatic memories at a time.
...
![Alien Artifacts; Aberrant Evidence](/3-Mechanics/CLI/Compendium/tables/alien-artifacts-aberrant-evidence-vrgr.md)
...
![Lost Memories; Suppressed Memories](/3-Mechanics/CLI/Compendium/tables/lost-memories-suppressed-memories-vrgr.md)
...
> [!gallery]
> ![Map 3.2: Borca](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/045-map-3-2-borca.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/046-map-3-2-borca-player.webp#gallery)
...
![Misericordia and Other Noble Estates; Noble Families and Estates](/3-Mechanics/CLI/Compendium/tables/misericordia-and-other-noble-estates-noble-families-and-estates-vrgr.md)
...
![Ivana Boritsi welcomes gue...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/047-03-007-ivana-boritsi.webp#center "Ivana Boritsi welcomes guests to the poisonous conservatories of Misericordia")
...
Ivana appears to be a young human woman with statistics similar to a [spy](/3-Mechanics/CLI/Compendium/bestiary/humanoid/spy.md). Since her arrival in the Land of the Mists, her blood has been tainted with poison, and angry red-and-black veins visibly show through her pale skin. While this discoloration is unignorable, the toxins grant her immunity to poison damage and being [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned). Her genius and ambition define her manipulations.
...
![](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/048-03-006.webp#center)
...
![Ivan Dilisnya in his favorite clockwork pram](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/049-03-008-ivan-dilisnya.webp#center)

#### Ivan's Powers and Dominion

Ivan isn't a physically or magically powerful Darklord. He's an extremely old man, but supernaturally he remains as physically fit as he was in the prime of life and has the statistics of a human [noble](/3-Mechanics/CLI/Compendium/bestiary/humanoid/noble.md). His menace manifests in the form of psychological manipulation, making others doubt reality, and causing victims to overestimate his control.
...
![Borca Adventures](/3-Mechanics/CLI/Compendium/tables/borca-adventures-vrgr.md)
...
![Ignoble Bonds; Ignoble Request](/3-Mechanics/CLI/Compendium/tables/ignoble-bonds-ignoble-request-vrgr.md)
...
![Lethal Leverage](/3-Mechanics/CLI/Compendium/tables/lethal-leverage-vrgr.md)
...
![Deceitful fey lure the unw...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/050-03-009-deceitful-fey.webp#center "Deceitful fey lure the unwary from the Carnival's midway")
...
> 
> **How did you join the Carnival?** Did you run away to join? Were you an outcast who found a home with the Carnival? Did [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) or a trouper save you from danger?
^carnival-characters
...
- **Tindal the Barker.** Tindal, the Carnival's cynical, fast-talking lead barker ([mage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/mage.md)), tours the grounds with visitors. At their last stop, he reveals his own uniqueness as the Amazing Soul-less Man: he casts no reflection and claims to lack a soul.  
- **Alti the Werehare.** A quick-tongued rapper and dancer, Alti ([wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md)) is a bombastic performer who turns into a rabbit on nights of the full moon.  
- **Amelia the Vampire.** Amelia ([scout](/3-Mechanics/CLI/Compendium/bestiary/humanoid/scout.md) with a flying speed of 30 feet) is a cheery acrobat aided in her performances by a pair of leathery wings that allows her to fly. Before stepping on stage, she powders her face, affects a somber accent, and pretends to be undead.  
- **Charlotte the Fire Eater.** This juggling daredevil ([veteran](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md)) performs with a dizzying array of flaming knives and other deadly objects. She claims that her blood is flammable and that she's burned the hair off eighteen hecklers.  
- **The Organ Grinder.** This somber clown grinds an ornate barrel organ ([scout](/3-Mechanics/CLI/Compendium/bestiary/humanoid/scout.md)). An attendant group of mischievous, half-trained, not-quite-identifiable animals caper to this music. The clown never speaks but allows visitors to guess at the animals' nature for a copper piece.  
- **Silessa the Snake.** A dancer and animal tamer, Silessa ([druid](/3-Mechanics/CLI/Compendium/bestiary/humanoid/druid.md)) performs with a collection of rare serpents. She claims she was born a snake and magically transformed into an elf.  

#### Hall of Horrors

A severe, bespectacled academic, Professor Pacali runs the Carnival's Hall of Horrors. This sizable, sinister tent contains a maze of taxidermic creatures, cabinets of curiosity, peculiar specimens in jars, and the occasional true wonder. Pacali hides a personal unsettling secret. During his time as a researcher at the Brautslava Institute in Darkon, Pacali was cursed: his worst impulses now grow from his body as terrible creatures. He bottles these murderous homunculi and touts them as "Professor Pacali's Pickled Punks," but every now and then one "escapes." Pacali persistently criticizes Hermos and [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), but rarely acts against them directly.
...
[Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), the Carnival's leader, is an eladrin (an elf native to the Feywild). She is a Fey who otherwise uses the [cambion](/3-Mechanics/CLI/Compendium/bestiary/fiend/cambion.md) stat block. She is never seen without her [holy avenger](/3-Mechanics/CLI/Compendium/items/holy-avenger.md) longsword, [Nepenthe](/3-Mechanics/CLI/Compendium/items/nepenthe-vrgr.md), which glows red with hate. Nepenthe, not [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), is the Carnival's Darklord.

#### Isolde

![Isolde with the sword Nepenthe](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/051-03-010-isolde-with-the-sword-nepenthe.webp#center)

[Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) was a holy warrior devoted to a pantheon of elven deities called the Seldarine. In this role, she defended the Feywild against dragons, demons, and other threats. In time, her heroics caught the eye of an archfey named Zybilna, who had forged secret pacts with some of the fiends [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) and her companions had slain. Rather than be angry at [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), Zybilna was impressed by her. She enlisted a powerful fiend known only as "the Caller" to corrupt and slay all of [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md)'s companions, leaving [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) alone, bitter, and vulnerable. The insidious archfey then befriended [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) and offered to help her forget her terrible losses. [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) became the master of a traveling fey carnival that served as a gateway to Zybilna's domain. The carnival did what Zybilna hoped it would do: it brought comfort to [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) and quelled her thirst for vengeance.

Zybilna and [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) enjoyed a strong partnership for years, but as time wore on, they grew distant until their relationship finally soured. Eladrin crave change, yet [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) felt like she was frozen in time. She wished to leave the fey carnival and pursue other dreams, but Zybilna wouldn't hear of it and secretly used [wish](/3-Mechanics/CLI/Compendium/spells/wish.md) spells to make [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) place her devotion to the carnival above her desire to leave it.

When [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md)'s fey carnival crossed paths with another carnival from the Shadowfell, the eladrin found the escape she longed for. [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) orchestrated a trade with the other carnival's owners, a pair of shadar-kai (elves native to the Shadowfell). [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) would become the master of their carnival, and they would become the masters of hers. To appease Zybilna, this arrangement would remain in place only until the two carnivals crossed paths again.

Zybilna was intrigued enough by the shadar-kai to let [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) go, but not without casting a spell that made [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) forget about Zybilna and her Feywild domain, thus preventing the eladrin from divulging the archfey's secrets. As a further punishment, Zybilna sent malevolent fey creatures to hound [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) and her Shadowfell carnival. [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) doesn't know who is behind this petty torment, nor does she care. Her hunt for the Caller and her thirst for vengeance have become all-consuming.

#### Nepenthe

The [holy avenger](/3-Mechanics/CLI/Compendium/items/holy-avenger.md) named [Nepenthe](/3-Mechanics/CLI/Compendium/items/nepenthe-vrgr.md) was crafted by shadar-kai to mete out justice as an executioner's weapon. In its lifetime, the sword has beheaded thousands of criminals, not all of whom were guilty of the crimes for which they were convicted. The sword cannot distinguish the guilty from the innocent. With each beheading, it hungers for more justice and blood.

Nepenthe came to the Carnival in the hands of a retired half-ogre who moonlighted as a sword-swallower. When the half-ogre died of old age, the sword was deemed the property of the Carnival. It was given to [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) by the Carnival's previous owners, who claimed that the sword would help her protect the Carnival against any threat.

In [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), the sword found a partner who shared its blind malice toward the guilty. [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) uses Nepenthe to behead anyone found guilty of stealing from the Carnival or inflicting harm upon it.

As soon as [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) took up the blade, it rekindled the grief and fury she had suppressed for so long, awakening the desire to avenge her long-dead companions by slaying the fiend she knows as "the Caller" (see ""Mist Wanderers"" later in this chapter for details). [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) always chooses the Carnival's stops based on her predictions of the Caller's next steps, and if her pursuit forces the Carnival into danger, so be it. Only by ridding [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) of Nepenthe can she truly escape the Dark Powers' clutches. But [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) will never part with the blade willingly, and if it is taken from the Carnival, the sword will always find its way back.

In addition to having the properties of a [holy avenger](/3-Mechanics/CLI/Compendium/items/holy-avenger.md), Nepenthe is a sentient, neutral evil weapon with an Intelligence of 10, a Wisdom of 8, and a Charisma of 18. It has hearing and [darkvision](/3-Mechanics/CLI/Rules/senses.md#Darkvision) out to a range of 60 feet. It can read and understand Elvish. It can also speak Elvish, but only through the voice of its wielder, with whom the sword can communicate telepathically. When using its telepathy to speak to [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), the sword can mimic the voices of [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md)'s fallen companions as it drives her to catch their fiendish killer. Unlike [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md), whose motives are good, the sword is corrupt and irredeemable.

#### Freedom of the Mists

The Carnival travels through the Mists and between other Domains of Dread as [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) pleases—though the Dark Powers occasionally send it off course. The Carnival provides one of the few means of escaping from another Darklord's domain, since it ignores the closed borders of other domains. Other Darklords cannot travel with the Carnival to escape their own domains, however.

#### Closing the Borders

Nepenthe can close the borders of its domain, as detailed in ""The Mists"" at the start of this chapter. With the sword's consent, [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) can do the same. When the Carnival's borders close, the Mists are filled with eerie, colorful lights and distant music, echoing memories of past carnivals.

#### Isolde's Torment

[Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) is both protector and prisoner of the Carnival.

The following truths endlessly weigh upon her:

- The Carnival constantly grows, bringing additional souls dependent on [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md)'s guardianship. She's tortured by her obligation toward the Carnival's troupers and her vow to avenge her murdered companions.  
...
- [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) dreads the day when the Carnival crosses paths with its fey counterpart for a second time. Were that to happen, [Isolde](/3-Mechanics/CLI/Compendium/bestiary/npc/isolde-vrgr.md) would be forced to relinquish the Carnival to its true shadar-kai masters, and Nepenthe along with it.  
...
> [!gallery]
> ![Map 3.3: Darkon](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/052-map-3-3-darkon.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/053-map-3-3-darkon-player.webp#gallery)
...
![Alcio &quot;Baron&quot; Metus](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/054-03-011-alcid.webp#center)
...
Alcio is a flashy, passionate, and fantastically violent [vampire](/3-Mechanics/CLI/Compendium/bestiary/undead/vampire.md). As the head of the Kargat and the region's criminal operations, she rules the Jagged Coast using information and intimidation. She's quick to punish incompetence and quicker to reward daring, but she reserves her greatest rewards for those who further her plots for revenge against Rudolph van Richten.
...
Darcalus Rex is a [necrichor](/3-Mechanics/CLI/Compendium/bestiary/undead/necrichor-vrgr.md) (see "chapter 5") who cares little for the survival of Darkon—and might not even be the ancient ruler. The elf [archmage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/archmage.md) Cardinna Artazas desperately believes she's doing what must be done—including corrupting her order—to save her homeland.
...
![Castle Avernus, frozen at ...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/055-03-012-castle-avernus.webp#center "Castle Avernus, frozen at the moment of its destruction")
...
![Darkon Adventures](/3-Mechanics/CLI/Compendium/tables/darkon-adventures-vrgr.md)
...
![Darkon's Destruction](/3-Mechanics/CLI/Compendium/tables/darkons-destruction-vrgr.md)

![The Secret of Darkon's Doom; Azalin's Fate](/3-Mechanics/CLI/Compendium/tables/the-secret-of-darkons-doom-azalins-fate-vrgr.md)
...
![Darkon's Salvation](/3-Mechanics/CLI/Compendium/tables/darkons-salvation-vrgr.md)

![Means to Save Darkon](/3-Mechanics/CLI/Compendium/tables/means-to-save-darkon-vrgr.md)
...
![Darkon Allies](/3-Mechanics/CLI/Compendium/tables/darkon-allies-vrgr.md)

![Darkon Rivals](/3-Mechanics/CLI/Compendium/tables/darkon-rivals-vrgr.md)
...
![Dread in Darkon](/3-Mechanics/CLI/Compendium/tables/dread-in-darkon-vrgr.md)
...
![Darkon Finale](/3-Mechanics/CLI/Compendium/tables/darkon-finale-vrgr.md)
...
> [!gallery]
> ![Map 3.4: Dementlieu](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/056-map-3-4-dementlieu.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/057-map-3-4-dementlieu-player.webp#gallery)
...
![Duchess d'Honaire punishes...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/058-03-013-duchess.webp#center "Duchess d'Honaire punishes the unworthy who sneak into the Grand Masquerade")

#### Saidra's Powers and Dominion

Saidra's form is a vaporous as her claims to nobility. She's a crimson spirit with statistics similar to a [wraith](/3-Mechanics/CLI/Compendium/bestiary/undead/wraith.md). She can cast the [disintegrate](/3-Mechanics/CLI/Compendium/spells/disintegrate.md) spell (save DC 18) on any creature that reveals themself to be lying about who they are. In her guise as duchess, Saidra dons a bird-like mask and fashionable scarlet gowns. As the Red Death, she is nothing more than a crimson-tinged shadow.
...
![Dementlieu Adventures](/3-Mechanics/CLI/Compendium/tables/dementlieu-adventures-vrgr.md)
...
![The Grand Masquerade; Grand Masquerade Objectives](/3-Mechanics/CLI/Compendium/tables/the-grand-masquerade-grand-masquerade-objectives-vrgr.md)
...
![Random Complications; Grand Masquerade Complications](/3-Mechanics/CLI/Compendium/tables/random-complications-grand-masquerade-complications-vrgr.md)
...
> [!gallery]
> ![Map 3.5: Falkovnia](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/059-map-3-5-falkovnia.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/060-map-3-5-falkovnia-player.webp#gallery)
...
Vladeska Drakov is an experienced military commander with statistics similar to those of a [knight](/3-Mechanics/CLI/Compendium/bestiary/humanoid/knight.md). While her martial skill is considerable, her true might comes in the form of the obedient army that unquestioningly enacts her every whim.

##### The Falcon's Talons

Vladeska's military forces are both completely overwhelming and entirely outnumbered. As an occupying force, the Talons are terrifying. Their numbers are relatively few, but they're organized enough to oppress Lekar's ragged survivors and enforce Drakov's totalitarian laws. In the face of zombie hordes, though, they're fighting a losing battle against foes whose numbers only grow. And every time a Talon falls, Lekar's final defeat grows closer. Talon soldiers use the [guard](/3-Mechanics/CLI/Compendium/bestiary/humanoid/guard.md) stat block, while commanders are [veterans](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md).
...
![Vladeska Drakov and her Ta...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/061-03-014-vladeska.webp#center "Vladeska Drakov and her Talons struggle to defend Lekar from endless zombie hordes")
...
When creating zombie encounters, consider the average level of your group and what threats you want to represent. The ""Zombie"" entry in "chapter 5" presents a variety of zombie types to complement the shambling [zombie](/3-Mechanics/CLI/Compendium/bestiary/undead/zombie.md) of the "Monster Manual", posing greater threats or terrifying surprises. The horde can also include other corporeal Undead such as [skeletons](/3-Mechanics/CLI/Compendium/bestiary/undead/skeleton.md), [ghouls](/3-Mechanics/CLI/Compendium/bestiary/undead/ghoul.md), or [wights](/3-Mechanics/CLI/Compendium/bestiary/undead/wight.md). Alternatively, the "zombies" might not be Undead at all but another group attempting to lay claim to Falkovnia—perhaps a forgotten human culture or relentless giants.
...
![Falkovnia Adventures](/3-Mechanics/CLI/Compendium/tables/falkovnia-adventures-vrgr.md)
...
However the characters become enlisted in Lekar's defense, they face a hopeless battle. They join hundreds of unprepared defenders, including [commoners](/3-Mechanics/CLI/Compendium/bestiary/humanoid/commoner.md) holding clubs or longbows for the first time.
...
The siege lasts as long as you like. Use frantic rushes between emergencies to describe small horrors and victories while wearing down the characters' resources with brief zombie attacks. If the characters feel completely overwhelmed, Talon [priests](/3-Mechanics/CLI/Compendium/bestiary/humanoid/priest.md) with [potions of healing](/3-Mechanics/CLI/Compendium/items/potion-of-healing.md) might appear, or an officer can enlist characters to deliver orders from General Drakov (likely related to the siege's climax).
...
![During the Siege; Zombie Siege Encounters](/3-Mechanics/CLI/Compendium/tables/during-the-siege-zombie-siege-encounters-vrgr.md)
...
![Concluding the Siege; Zombie Siege Climax](/3-Mechanics/CLI/Compendium/tables/concluding-the-siege-zombie-siege-climax-vrgr.md)

Drakov's scheme might be even more alarming, involving magical or monstrous secret weapons.

Once you've determined how the siege will unfold, start foreshadowing Drakov's scheme, giving the characters the opportunity to aid it, enact a less destructive plan, or save innocents. Use missives intercepted from messengers or a [sending stone](/3-Mechanics/CLI/Compendium/items/sending-stones.md) taken from a fallen Talon officer to clue the party in on Drakov's strategy.
...
> [!gallery]
> ![Map 3.6: Har'Akir](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/062-map-3-6-har-akir.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/063-map-3-6-har-akir-player.webp#gallery)
...
![Pharaoh Ankhtepot envisions his missing ka](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/064-03-015-pharaoh.webp#center)
...
A fantastically ancient Undead, Ankhtepot has statistics similar to a [mummy lord](/3-Mechanics/CLI/Compendium/bestiary/undead/mummy-lord.md). Beyond this, he rules as pharaoh, national leader, and voice of the gods. None in Har'Akir, among the living or the dead, denies his will, but the Darklord's wishes are few. He cares only for order and to find his lost ka.

##### Children of Ankhtepot

The Darklord is served by many of the same priests who died alongside him in ages past. He resurrected these [mummies](/3-Mechanics/CLI/Compendium/bestiary/undead/mummy.md) and [mummy lords](/3-Mechanics/CLI/Compendium/bestiary/undead/mummy-lord.md) with the heads of animals, painting them as spirits and harbingers of his fictitious gods of Har'Akir. As Ankhtepot has grown bored with mortal concerns, the Children of Ankhtepot have pursued their own vices. Many dream and despair in their crypts. Others foment small cults of their own. And still others seek to undermine the pharaoh and claim his position—including the treacherous [mummy lord](/3-Mechanics/CLI/Compendium/bestiary/undead/mummy-lord.md) Senmet.
...
![Har'Akir Adventures](/3-Mechanics/CLI/Compendium/tables/harakir-adventures-vrgr.md)
...
![The Soul's Shape; Ankhtepot's Soul](/3-Mechanics/CLI/Compendium/tables/the-souls-shape-ankhtepots-soul-vrgr.md)
...
![The Hunters' Role; Hunt for the Ka](/3-Mechanics/CLI/Compendium/tables/the-hunters-role-hunt-for-the-ka-vrgr.md)
...
![The Pharaoh's Return; Ankhtepot Reborn](/3-Mechanics/CLI/Compendium/tables/the-pharaohs-return-ankhtepot-reborn-vrgr.md)
...
- Creatures warped by magical experiments infest the domain, including magic-hungry [gremishkas](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/gremishka-vrgr.md) (see "chapter 5") and ravenous [purple worms](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/purple-worm.md).  
...
> [!gallery]
> ![Map 3.7: Hazlan](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/065-map-3-7-hazlan.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/066-map-3-7-hazlan-player.webp#gallery)
...
![Hazlik](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/067-03-016-hazlik.webp#center)
...
Hazlik is a vain, egotistical overlord, convinced he is the supreme being in his domain. His statistics echo those of an [archmage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/archmage.md), but he favors using an array of magic items rather than his own spells.
...
![Hazlan Adventures](/3-Mechanics/CLI/Compendium/tables/hazlan-adventures-vrgr.md)
...
![Hazlan Wild Magic](/3-Mechanics/CLI/Compendium/tables/hazlan-wild-magic-vrgr.md)

### The Eye of Hazlik

![The wizard Eleni's most re...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/068-03-017-wizard-eleni.webp#center "The wizard Eleni's most recent experiment: dominating the worm Gravedrinker")
...
- At any time, Hazlik can use any Eye of Hazlik in his domain as a stationary eye created by the [arcane eye](/3-Mechanics/CLI/Compendium/spells/arcane-eye.md) spell. He can spy through the eye whenever and for as long as he pleases. The eye radiates magic while Hazlik spies through it.  
...
- [Jiangshi](/3-Mechanics/CLI/Compendium/bestiary/undead/jiangshi-vrgr.md) haunt the streets of I'Cath, tearing down whole districts and rebuilding them.  
...
![Tsien Chiang](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/069-03-018-tsien-chiang.webp#center)
...
Tsien Chiang's statistics are similar to those of a [mage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/mage.md) with access to a variety of magic items—her favorite being an ornate robe that functions similarly to a [Heward's handy haversack](/3-Mechanics/CLI/Compendium/items/hewards-handy-haversack.md) and [wings of flying](/3-Mechanics/CLI/Compendium/items/wings-of-flying.md). She uses this robe to store scrolls detailing her most recent plans for I'Cath's renovation. Additionally, Tsien Chiang enforces her will upon her domain in a variety of other ways.
...
![I'Cath Adventures](/3-Mechanics/CLI/Compendium/tables/icath-adventures-vrgr.md)
...
- **Tsien Lei-An.** Voiceless Tsien Lei-An is made entirely of eyes and has the statistics of a [scarecrow](/3-Mechanics/CLI/Compendium/bestiary/construct/scarecrow.md). She wishes for a robe of ghost hair silk or a jiangshi's slippers. She spends much of her time wandering the Mansions, rooting through the possessions of sleeping city-dwellers.  
- **Tsien Man-Yi.** Made of pale wood, Tsien Man-Yi must remain near the willow tree in the courtyard of the Palace of Bones, and has the statistics of a [dryad](/3-Mechanics/CLI/Compendium/bestiary/fey/dryad.md). She wishes for flowers from the Gemstone Garden or for a friend to fall asleep under her tree's boughs.  
- **Tsien Seu-Mei.** Voiceless Tsien Seu-Mei is made entirely of teeth and has the statistics of a [ghoul](/3-Mechanics/CLI/Compendium/bestiary/undead/ghoul.md). She wishes to eat a delicious dessert or care for one of the fish of the Gemstone Gardens. She often wanders the stalls of Gwai-Huit Center.  
- **Tsien Wai-Ching.** Made of living fog, Tsien Wai-Ching is the youngest daughter and has the statistics of a [specter](/3-Mechanics/CLI/Compendium/bestiary/undead/specter.md). She wishes to help a spirit from Ping'On Tower find its family or to play with an incorporeal toy. She regularly explores the memorials in the Gemstone Gardens.  

![A resident of I'Cath attempts to flee a jiangshi](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/070-03-019-resident.webp#center)
...
> [!gallery]
> ![Map 3.8: Kalakeri](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/071-map-3-8-kalakeri.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/072-map-3-8-kalakeri-player.webp#gallery)
...
Kalakeri's most fearsome predators inhabit the Backwaters, including [basilisks](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/basilisk.md), [hydras](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/hydra.md), [stone giants](/3-Mechanics/CLI/Compendium/bestiary/giant/stone-giant.md), and [cloud giants](/3-Mechanics/CLI/Compendium/bestiary/giant/cloud-giant.md).
...
![Maharani Ramya Vasavadan](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/073-03-020-maharani-ramya-vasavadan.webp#center)
...
Kalakeri's armies and the guards of the Cerulean Citadel obey Ramya without question, despite thousands of them having died in her service. These soldiers' loyalty follows them into death. Any living soldier who dies in Ramya's service returns to life as an Undead warrior—a [skeleton](/3-Mechanics/CLI/Compendium/bestiary/undead/skeleton.md) or [wight](/3-Mechanics/CLI/Compendium/bestiary/undead/wight.md)—on the night of the next new moon and rejoins the maharani's army. Ramya's living followers consider this deathless state an honor and the ultimate mark of loyalty.
...
![Kalakeri Adventures](/3-Mechanics/CLI/Compendium/tables/kalakeri-adventures-vrgr.md)
...
![Renown in Kalakeri](/3-Mechanics/CLI/Compendium/tables/renown-in-kalakeri-vrgr.md)
...
![Benefits of Renown; Loyalist Benefits](/3-Mechanics/CLI/Compendium/tables/benefits-of-renown-loyalist-benefits-vrgr.md)
...
![Benefits of Renown; Rebel Benefits](/3-Mechanics/CLI/Compendium/tables/benefits-of-renown-rebel-benefits-vrgr.md)
...
![The crowds at the Crystal ...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/075-03-024-the-crowds.webp#center "The crowds at the Crystal Club in Harmonia have a vicious reputation. Some performers learn why firsthand")
...
> [!gallery]
> ![Map 3.9: Kartakass](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/076-map-3-9-kartakass.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/077-map-3-9-kartakass-player.webp#gallery)
...
![Harkon Lukas](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/078-03-022-harkon-lukas.webp#center)
...
![Kartakass Adventures](/3-Mechanics/CLI/Compendium/tables/kartakass-adventures-vrgr.md)
...
> [!gallery]
> ![Map 3.10: Lamordia](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/080-map-3-10-lamordia.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/081-map-3-10-lamordia-player.webp#gallery)
...
- [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) evades Mordenheim's attempts to find her.  
...
![Lamordia Adventures](/3-Mechanics/CLI/Compendium/tables/lamordia-adventures-vrgr.md)

### Mordenheim's Monsters

The horror at Lamordia's heart is Dr. Mordenheim's bizarre experiments and ceaseless search for [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md).

#### Elise and the Unbreakable Heart

Above all else, Dr. Mordenheim's objectives are finding [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) and recovering or re-creating the Unbreakable Heart.

##### Elise

Dr. Mordenheim's supposed beloved and greatest achievement, [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) is a confused, frustrated soul who never wished for her current circumstances. She's now a [flesh golem](/3-Mechanics/CLI/Compendium/bestiary/construct/flesh-golem.md) with the following adjustments:

- [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) does not have the Berserk or Aversion of Fire traits.  
- She has immunity to cold damage.  

[Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md)'s heart has been replaced with the Unbreakable Heart. If this device is removed, [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) dies, even if it is replaced with another heart. [Elise](/3-Mechanics/CLI/Compendium/bestiary/npc/elise-vrgr.md) is horrified by what Dr. Mordenheim did to her and tries to avoid the doctor and all strangers, fearing they might kill her to learn the Unbreakable Heart's secrets. She roams without destination but keeps a hidden sanctuary at Hope's Heart on the Isles of Agony. Although she has tried to leave Lamordia, the Mists prevent her from doing so.
...
![Within Elise's undying bod...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/083-03-025-dr-mordenheim.webp#center "Within Elise's undying body beats Dr. Mordenheim's greatest creation: the Unbreakable Heart")
...
![Mordenheim's Designs; Serving Dr. Mordenheim](/3-Mechanics/CLI/Compendium/tables/mordenheims-designs-serving-dr-mordenheim-vrgr.md)
...
> [!gallery]
> ![Map 3.11: Mordent](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/084-map-3-11-mordent.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/085-map-3-11-mordent-player.webp#gallery)
...
![Van Richten's Herbalist Shop in Mordentshire](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/086-03-027-van-richten.webp#center)
...
![Mordent Adventures](/3-Mechanics/CLI/Compendium/tables/mordent-adventures-vrgr.md)
...
![Ghost's History](/3-Mechanics/CLI/Compendium/tables/ghosts-history-vrgr.md)
...
![Tragedy; Tragic Elements](/3-Mechanics/CLI/Compendium/tables/tragedy-tragic-elements-vrgr.md)
...
![Romance; Romantic Elements](/3-Mechanics/CLI/Compendium/tables/romance-romantic-elements-vrgr.md)

![All who die in Mordent bec...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/087-03-028-all-who-die.webp#center "All who die in Mordent become captives to the will of Lord Wilfred Godefroy")
...
> [!gallery]
> ![Map 3.12: Richemulot](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/088-map-3-12-richemulot.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/089-map-3-12-richemulot-player.webp#gallery)
...
![Jacqueline Renier](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/090-03-029-jacqueline-renier.webp#center)
...
Finding like-minded souls took Renier years, but she finally became aware of the mysterious Trueblood Council, a secret society of Richemulot's eldest and most esteemed families. Expending a fortune, Renier aggressively pursued membership. Finally she was granted an invitation to join the society's members at their meeting place hidden among the sewers of Pont-a-Museau. But when Renier arrived, she found a throng of filthy commoners, not the dramatic masterminds she'd expected. As she cursed them and set off to fetch the guards, the council members revealed their true [wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md) forms. That night, she was inducted into their ranks.
...
Although Jacqueline Renier has statistics similar to those of a [wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md), she assumes her hybrid or rat form only when forced to defend herself or when pushed to the brink of rage. She is rarely without guards, be they members of the Casques Silencieux, wererat bodyguards, or hidden swarms of rats.

##### Casques Silencieux

The Darklord's silent state police guard Chateau Delanuit and enforce her quarantines across Richemulot. Rather than the soldiers they appear to be, these troops are [animated armor](/3-Mechanics/CLI/Compendium/bestiary/construct/animated-armor.md) filled with rats that mindlessly and mercilessly enact Jacqueline Renier's will. If a guard is defeated, the armor collapses, releasing a [swarm of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md).
...
When Jacqueline Renier wishes to close her domain's borders, the Mists rise at the edge of the lands, as detailed in ""The Mists"" at the start of this chapter. Additionally, the Mists are filled with [swarms of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md); endless waves of them attack any creatures that enter the Mists.
...
![Richemulot Adventures](/3-Mechanics/CLI/Compendium/tables/richemulot-adventures-vrgr.md)
...
The Gnaws is spread when a creature is bitten by a [rat](/3-Mechanics/CLI/Compendium/bestiary/beast/rat.md), [giant rat](/3-Mechanics/CLI/Compendium/bestiary/beast/giant-rat.md), [swarm of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md), or [wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md) that carries the disease, or by coming into physical contact with an infected creature.
...
It takes `dice:1d2|noform|noparens|avg` (`d2`) days for the Gnawing Plague's symptoms to manifest in an infected creature. The infected creature then gains 1 level of [exhaustion](/3-Mechanics/CLI/Rules/conditions.md#Exhaustion), regains only half the normal number of hit points from spending Hit Dice, and regains no hit points from finishing a long rest.
...
![Wearing a mask curtails th...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/091-03-030-wearing-a-mask.webp#center "Wearing a mask curtails the plague but not wererats")
...
![Stage Two: Outbreak; Stage Two Encounters](/3-Mechanics/CLI/Compendium/tables/stage-two-outbreak-stage-two-encounters-vrgr.md)
...
![Stage Three: Illness; Stage Three Encounters](/3-Mechanics/CLI/Compendium/tables/stage-three-illness-stage-three-encounters-vrgr.md)
...
![Stage Four: Pestilence; Stage Four Encounters](/3-Mechanics/CLI/Compendium/tables/stage-four-pestilence-stage-four-encounters-vrgr.md)
...
> [!gallery]
> ![Map 3.13: Tepest](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/092-map-3-13-tepest.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/093-map-3-13-tepest-player.webp#gallery)
...
![Mother Lorinda](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/094-03-031-mother-lorinda.webp#center)
...
Lorinda is a [green hag](/3-Mechanics/CLI/Compendium/bestiary/fey/green-hag.md) of extreme age. In her true form, she carries her darling family—three grim dolls she calls Laveeda, Leticia, and Laoirse. When dealing with the residents of Viktal, she takes on her benevolent illusory guise as Mother.
...
![Tepest Adventures](/3-Mechanics/CLI/Compendium/tables/tepest-adventures-vrgr.md)
...
![A visitor enjoys the hospi...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/095-03-032-a-visitor.webp#center "A visitor enjoys the hospitality of Viktal during the Tithe")

![Welcome to Viktal; Sights in Viktal](/3-Mechanics/CLI/Compendium/tables/welcome-to-viktal-sights-in-viktal-vrgr.md)
...
![Tithe Events](/3-Mechanics/CLI/Compendium/tables/tithe-events-vrgr.md)
...
![Mother's Blessing; Lorinda's Daughter](/3-Mechanics/CLI/Compendium/tables/mothers-blessing-lorindas-daughter-vrgr.md)
...
- Packs of displacer beasts roam the jungle, led by Yana, a preternaturally cunning [displacer beast](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/displacer-beast.md) that serves Chakuna.  
...
> [!gallery]
> ![Map 3.14: Valachan](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/096-map-3-14-valachan.webp#gallery)
> ![Player Version](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/097-map-3-14-valachan-player.webp#gallery)

#### Eirubamba River

Wildflowers, enticing fruits, and medicinal herbs grow in the forests and upon the shorelines around the Eirubamba River. Most rain forest predators won't approach the river, though, fearing the territorial [giant wasps](/3-Mechanics/CLI/Compendium/bestiary/beast/giant-wasp.md) that swarm among the rare plants.
...
Chakuna gained her status as a Darklord when she defeated Urik von Kharkov. In so doing, though, she discovered a terrible truth about the nature of Valachan, and she now lives to maintain the domain and the cycle of predator and prey. Chakuna has statistics similar to a [weretiger](/3-Mechanics/CLI/Compendium/bestiary/humanoid/weretiger.md), but her animal and hybrid forms have the appearance of a panther.
...
The Trial of Hearts anchors the terror in Valachan, but the domain's dangerous wilderness threatens anyone who explores the land. In addition to natural rain-forest predators, dinosaurs and [displacer beasts](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/displacer-beast.md) roam the domain. Its varied Plant creatures include wicked [twig blights](/3-Mechanics/CLI/Compendium/bestiary/plant/twig-blight.md), cruel [treants](/3-Mechanics/CLI/Compendium/bestiary/plant/treant.md), and manipulative [dryads](/3-Mechanics/CLI/Compendium/bestiary/fey/dryad.md) all expressing the land's underlying blood thirst. The people of the land—the werepanthers of Oselo, the Shuaran, and remote groups of lizardfolk—might provide assistance to outsiders, but they don't tolerate those who insult their ways or bring Chakuna's wrath upon them. Parties without experience exploring dangerous wilds can enlist a guide to aid them, a service that the Oselo are particularly willing to provide.
...
![Valachan Adventures](/3-Mechanics/CLI/Compendium/tables/valachan-adventures-vrgr.md)
...
![Chakuna corners her prey in the heart of Valachan](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/098-03-033-chakuna.webp#center)
...
Characters able to fly find their flight slowed by strong winds (effectively difficult terrain), and might face deadly airborne creatures such as [chimeras](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/chimera.md), [harpies](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/harpy.md), and [pteranodons](/3-Mechanics/CLI/Compendium/bestiary/beast/pteranodon.md). Chakuna might also add rules to the Trial of Hearts that deem flight and magical travel off limits. If she does, the Mists aid in enforcing these rules.
...
![Valachan Hunt Complications](/3-Mechanics/CLI/Compendium/tables/valachan-hunt-complications-vrgr.md)
...
![Domains of Ravenloft](/3-Mechanics/CLI/Compendium/tables/domains-of-ravenloft-vrgr.md)
...
![Cyre 1313, The Mourning Ra...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/099-03-034-cyre-1313.webp#center "Cyre 1313, The Mourning Rail, thunders through domains, ever trying to escape the disaster that slew its passengers")
...
![The Ghost Dancer visits ni...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/100-03-035-ghost-dancer.webp#center "The Ghost Dancer visits nightmares upon a sleeping victim")
...
![Pietra van Riese](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/101-03-036-pietra-van-riese.webp#center)
...
Each day, the city of Paridon in Zherisia erupts in riots over food scarcity, taxation, and citizens who go missing by the dozens every night. At least one murderer stalks Paridon: the ancient [doppelganger](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/doppelganger.md) Sodo, who has impersonated so many people that it now finds it impossible to hold a form for more than a few days at a time. As Sodo's flesh runs like hot wax, it staves off dissolution by consuming the organs of humanoids. Paridon's streets serve as the doppelganger's hunting ground, and those who enter the sewers risk attracting the notice of countless [carrion stalkers](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/carrion-stalker-vrgr.md) (see "chapter 5") and their monstrous Hive Queen.
...
![Travelers in the Mists; Strangers in the Mists](/3-Mechanics/CLI/Compendium/tables/travelers-in-the-mists-strangers-in-the-mists-vrgr.md)
...
![Holy Symbol of Ravenkind](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/102-03-036-holy-symbol-of-ravenkind.webp#center)
...
![Keeper Adventures](/3-Mechanics/CLI/Compendium/tables/keeper-adventures-vrgr.md)
...
![Vistani Wayfarers emerge f...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/103-03-037-vistani-wayfarers.webp#center "Vistani Wayfarers emerge from the Mists into a new land.")
...
- **Mother Luba.** The halfling Mother Luba is known for putting unquiet spirits to rest and transporting wayward souls through the Mists to their rightful homes. Those wicked spirits beyond her aid she trapped within her tarokka deck, which became known as [Luba's Tarokka of Souls](/3-Mechanics/CLI/Compendium/items/lubas-tarokka-of-souls-tce.md) (detailed in "Tasha's Cauldron of Everything").  
...
Alanik Ray is an exceptional investigator with an uncanny ability to notice detail and make deductive leaps. Despite his experience with the paranormal, he relies on his husband Arthur to keep him out of true supernatural peril. Still, the detectives manage to find trouble wherever they go. Use the statistics of [spies](/3-Mechanics/CLI/Compendium/bestiary/humanoid/spy.md) to approximate both Alanik Ray and Arthur Sedgwick. Consider the following plots when featuring the detectives in your adventures:
...
The Caller uses statistics similar to a [succubus](/3-Mechanics/CLI/Compendium/bestiary/fiend/succubus.md)/ [incubus](/3-Mechanics/CLI/Compendium/bestiary/fiend/incubus.md), and no matter how many times it's defeated, it always returns. Use the Caller to create adventures involving secret histories, domain-spanning conspiracies, and truths hinting at the nature of the Dark Powers. Consider the following plots when featuring the Caller in an adventure:
...
Erasmus is a [ghost](/3-Mechanics/CLI/Compendium/bestiary/undead/ghost.md) and the heart of the van Richten family. Consider the following plots when featuring Erasmus in an adventure:
...
Use the statistics of an [assassin](/3-Mechanics/CLI/Compendium/bestiary/humanoid/assassin.md) to represent Ez, or you can use her stat block from Curse of Strahd. Consider the following plots when featuring Ez in an adventure:
...
![Firan Zal'honan's mysterio...](/3-Mechanics/CLI/Compendium/books/van-richtens-guide-to-ravenloft/img/104-03-038-mysterious-research.webp#center "Firan Zal'honan's mysterious research leads him to discover an accursed amber sarcophagus")
...
Firan Zal'honan is an arrogant, pragmatic, amoral genius. Furthering his schemes or adopting him as a patron can draw a party into conflict with the most prominent villains in the Domains of Dread. Use the statistics of a human [archmage](/3-Mechanics/CLI/Compendium/bestiary/humanoid/archmage.md) to represent Firan. He is accompanied by an [imp](/3-Mechanics/CLI/Compendium/bestiary/fiend/imp.md) named Skeever, who appears as a piebald raven. Consider the following plots when featuring Firan in an adventure:
...
Jander Sunstar is a [vampire](/3-Mechanics/CLI/Compendium/bestiary/undead/vampire.md) and one of Ravenloft's foremost experts on vampirism. He aids characters hunting vampires and recruits allies to protect him from others of his kind. Consider the following plots when featuring Jander Sunstar in an adventure:
...
Van Richten readily provides mentorship to characters devoted to fighting the creatures of the night. To represent him, use the stat block for a [priest](/3-Mechanics/CLI/Compendium/bestiary/humanoid/priest.md) from the "Monster Manual" or Rictavio from Curse of Strahd. Consider the following plots when featuring van Richten in an adventure:
...
Gennifer and Laurie are skilled and well-prepared adventurers who have the statistics of a [druid](/3-Mechanics/CLI/Compendium/bestiary/humanoid/druid.md) and a [veteran](/3-Mechanics/CLI/Compendium/bestiary/humanoid/veteran.md), respectively. Consider the following plots when featuring the twins in an adventure:
