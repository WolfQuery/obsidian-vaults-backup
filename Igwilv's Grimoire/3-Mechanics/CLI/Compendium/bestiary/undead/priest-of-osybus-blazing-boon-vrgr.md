...
---
# [Priest of Osybus (Blazing Boon)](3-Mechanics\CLI\Compendium\bestiary\undead/priest-of-osybus-blazing-boon-vrgr.md)
...
"traits":
  ...
  - "desc": "The priest sloughs off its flesh, and its skeleton crumbles away, leaving\
      \ only its skull. Its stat block is replaced by that of a [flameskull](/3-Mechanics/CLI/Compendium/bestiary/undead/flameskull.md),\
