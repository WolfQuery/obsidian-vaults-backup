...
"actions":
  ...
  - "desc": "If the commander has taken damage during this combat, it gives itself\
      ...
      \ wraith warriors](/3-Mechanics/CLI/Compendium/bestiary/undead/sword-wraith-warrior-mpmm.md)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/undead/token/sword-wraith-commander-mpmm.webp"
```
^statblock
