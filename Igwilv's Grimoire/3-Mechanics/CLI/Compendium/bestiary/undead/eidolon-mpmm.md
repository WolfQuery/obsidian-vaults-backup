...
To protect sites they deem holy, gods often rely on eidolons, ghostly spirits bound to safeguard a sacred place. Forged from the souls of those with unwavering devotion, eidolons stalk temples and vaults to ensure that no enemy defiles, damages, or plunders these sites. If an enemy sets foot inside a warded location, the [eidolon](/3-Mechanics/CLI/Compendium/bestiary/undead/eidolon-mpmm.md) plunges into a [statue](/3-Mechanics/CLI/Compendium/bestiary/construct/sacred-statue-mpmm.md) specially prepared to house its soul; it then animates this effigy and uses the statue to drive out the intruders.
...
"traits":
  - "desc": "The eidolon can move through other creatures and objects as if they were\
      ...
      \ an object other than a [sacred statue](/3-Mechanics/CLI/Compendium/bestiary/construct/sacred-statue-mpmm.md)."
    "name": "Incorporeal Movement"
  - "desc": "When the eidolon moves into a space occupied by a [sacred statue](/3-Mechanics/CLI/Compendium/bestiary/construct/sacred-statue-mpmm.md),\
      \ the eidolon can disappear, causing the statue to become a creature under the\
      \ eidolon's control. The eidolon uses the [sacred statue's stat block](/3-Mechanics/CLI/Compendium/bestiary/construct/sacred-statue-mpmm.md)\
      \ in place of its own."
...
"actions":
  - "desc": "Each creature within 60 feet of the eidolon that can see it must succeed\
      ...
      \ case the creature also becomes [stunned](/3-Mechanics/CLI/Rules/conditions.md#Stunned)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/undead/token/eidolon-mpmm.webp"
```
^statblock
