...
*Source: Monster Manual p. 148, Lost Mine of Phandelver, Waterdeep: Dungeon of the Mad Mage, Tasha's Cauldron of Everything, The Wild Beyond the Witchlight, Keys from the Golden Vault, Dragon of Icespire Peak. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "KftGV"
  - "DIP"
"image": "/3-Mechanics/CLI/Compendium/bestiary/undead/token/ghoul.webp"
```
^statblock
