...
*Source: Monster Manual p. 300, Waterdeep: Dungeon of the Mad Mage, Dragon of Icespire Peak. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 5\
      ...
      \ slain by this attack rises 24 hours later as a [zombie](/3-Mechanics/CLI/Compendium/bestiary/undead/zombie.md)\
...
"source":
  ...
  - "WDMM"
  - "DIP"
"image": "/3-Mechanics/CLI/Compendium/bestiary/undead/token/wight.webp"
```
^statblock
