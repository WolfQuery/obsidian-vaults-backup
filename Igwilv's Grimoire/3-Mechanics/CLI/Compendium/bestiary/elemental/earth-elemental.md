...
*Source: Monster Manual p. 124, Waterdeep: Dragon Heist, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "WDH"
  - "TCE"
"image": "/3-Mechanics/CLI/Compendium/bestiary/elemental/token/earth-elemental.webp"
```
^statblock
