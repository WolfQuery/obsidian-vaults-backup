...
"traits":
  ...
  - "desc": "The tempest is always at the center of a storm 1d6 + 4 miles in diameter.\
      ...
      \ and imposes disadvantage on Wisdom ([Perception](/3-Mechanics/CLI/Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
      ...
      \ more, the creature is also [stunned](/3-Mechanics/CLI/Rules/conditions.md#Stunned)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/elemental/token/elder-tempest-mpmm.webp"
```
^statblock
