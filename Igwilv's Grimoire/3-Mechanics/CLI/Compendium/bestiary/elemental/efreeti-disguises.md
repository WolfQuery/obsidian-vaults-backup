...
- Efreeti (Disguises)
---
# [Efreeti (Disguises)](3-Mechanics\CLI\Compendium\bestiary\elemental/efreeti-disguises.md)
*Source: Monster Manual p. 145, Waterdeep: Dungeon of the Mad Mage, Tasha's Cauldron of Everything, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"traits":
  - "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC\
      ...
      \ [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md) (often\
      \ with a longer duration than is normal for that spell; see Disguises)\n\n3/day\
      \ each: [enlarge/reduce](/3-Mechanics/CLI/Compendium/spells/enlarge-reduce.md),\
      \ [tongues](/3-Mechanics/CLI/Compendium/spells/tongues.md), [true polymorph](/3-Mechanics/CLI/Compendium/spells/true-polymorph.md)\
      \ (mightier genies only; see Disguises)\n\n1/day each: [conjure elemental](/3-Mechanics/CLI/Compendium/spells/conjure-elemental.md)\
      ...
      \ [invisibility](/3-Mechanics/CLI/Compendium/spells/invisibility.md), [major\
      \ image](/3-Mechanics/CLI/Compendium/spells/major-image.md), [plane shift](/3-Mechanics/CLI/Compendium/spells/plane-shift.md),\
  ...
  - "desc": "Some genies can veil themselves in illusion to pass as other similarly\
      \ shaped creatures. Such genies can innately cast the [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md)\
      \ spell at will, often with a longer duration than is normal for that spell.\
      \ Mightier genies can cast the [true polymorph](/3-Mechanics/CLI/Compendium/spells/true-polymorph.md)\
