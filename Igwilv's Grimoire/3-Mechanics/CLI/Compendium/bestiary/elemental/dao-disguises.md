...
- Dao (Disguises)
---
# [Dao (Disguises)](3-Mechanics\CLI\Compendium\bestiary\elemental/dao-disguises.md)
...
"traits":
  - "desc": "The dao's innate spellcasting ability is Charisma (spell save DC 14,\
      ...
      \ shape](/3-Mechanics/CLI/Compendium/spells/stone-shape.md), [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md)\
      \ (often with a longer duration than is normal for that spell; see Disguises)\n\
      \n3/day each: [passwall](/3-Mechanics/CLI/Compendium/spells/passwall.md),\
      \ [move earth](/3-Mechanics/CLI/Compendium/spells/move-earth.md), [tongues](/3-Mechanics/CLI/Compendium/spells/tongues.md),\
      \ [true polymorph](/3-Mechanics/CLI/Compendium/spells/true-polymorph.md) (mightier\
