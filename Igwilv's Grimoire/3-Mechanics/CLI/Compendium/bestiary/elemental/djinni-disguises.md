...
- Djinni (Disguises)
---
# [Djinni (Disguises)](3-Mechanics\CLI\Compendium\bestiary\elemental/djinni-disguises.md)
...
"traits":
  - "desc": "The djinni's innate spellcasting ability is Charisma (spell save DC 17,\
      ...
      \ each: [create food and water](/3-Mechanics/CLI/Compendium/spells/create-food-and-water.md)\
      \ (can create wine instead of water), [tongues](/3-Mechanics/CLI/Compendium/spells/tongues.md),\
      \ [wind walk](/3-Mechanics/CLI/Compendium/spells/wind-walk.md), [true polymorph](/3-Mechanics/CLI/Compendium/spells/true-polymorph.md)\
