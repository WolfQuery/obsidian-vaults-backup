...
"bonus_actions":
  - "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
      ...
      \ is [concentrating](/3-Mechanics/CLI/Rules/conditions.md#Concentration) must\
      \ succeed on a DC 25 Constitution saving throw or the creature's [concentration](/3-Mechanics/CLI/Rules/conditions.md#Concentration)\
      ...
      \ doesn't fall [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone) or become\
      \ trapped."
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/elemental/token/zaratan-mpmm.webp"
```
^statblock
