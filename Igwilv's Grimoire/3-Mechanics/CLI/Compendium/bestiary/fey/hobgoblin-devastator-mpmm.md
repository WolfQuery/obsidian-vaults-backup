...
"actions":
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      ...
      \ [fly](/3-Mechanics/CLI/Compendium/spells/fly.md), [fog cloud](/3-Mechanics/CLI/Compendium/spells/fog-cloud.md),\
      \ [gust of wind](/3-Mechanics/CLI/Compendium/spells/gust-of-wind.md), [lightning\
      \ bolt](/3-Mechanics/CLI/Compendium/spells/lightning-bolt.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/hobgoblin-devastator-mpmm.webp"
```
^statblock
