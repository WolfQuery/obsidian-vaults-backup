...
"traits":
  - "desc": "Any creature that attempts to damage the nilbog must first succeed on\
      \ a DC 12 Charisma saving throw or be [charmed](/3-Mechanics/CLI/Rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/nilbog-mpmm.webp"
```
^statblock
