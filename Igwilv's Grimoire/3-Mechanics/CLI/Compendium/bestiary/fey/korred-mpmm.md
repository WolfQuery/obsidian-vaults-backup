...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](/3-Mechanics/CLI/Compendium/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
"actions":
  ...
  - "desc": "The korred casts one of the following spells, requiring no spell components\
      ...
      \ (as an action), [meld into stone](/3-Mechanics/CLI/Compendium/spells/meld-into-stone.md),\
...
"bonus_actions":
  - "desc": "The korred has at least one 50-foot-long rope woven out of its hair.\
      ...
      \ must succeed on a DC 13 Dexterity saving throw or become [grappled](/3-Mechanics/CLI/Rules/conditions.md#Grappled)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/korred-mpmm.webp"
```
^statblock
