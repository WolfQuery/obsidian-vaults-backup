...
"actions":
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      ...
      \ [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md), [silent\
      \ image](/3-Mechanics/CLI/Compendium/spells/silent-image.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/hobgoblin-iron-shadow-mpmm.webp"
```
^statblock
