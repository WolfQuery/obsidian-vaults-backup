...
Much as annis hags befriend children in order to corrupt them, they may adopt a group of ogres, trolls, or other creatures ([ogres](/3-Mechanics/CLI/Compendium/bestiary/giant/ogre.md) and [trolls](/3-Mechanics/CLI/Compendium/bestiary/giant/troll.md)), ruling them through brute strength, insults, and superstition.
...
"actions":
  ...
  - "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
      \ ability (spell save DC 13):\n\n3/day each: [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md)\
      \ (including the form of a Medium Humanoid), [Fog cloud](/3-Mechanics/CLI/Compendium/spells/fog-cloud.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/annis-hag-mpmm.webp"
```
^statblock
