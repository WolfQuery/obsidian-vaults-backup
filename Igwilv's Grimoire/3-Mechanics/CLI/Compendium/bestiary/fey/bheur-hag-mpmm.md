...
"cr": "7"
"traits":
  - "desc": "The hag can cast the [control weather](/3-Mechanics/CLI/Compendium/spells/control-weather.md)\
...
"actions":
  ...
  - "desc": "While holding or riding the graystaff, the hag casts one of the following\
      ...
      \n1/day each: [cone of cold](/3-Mechanics/CLI/Compendium/spells/cone-of-cold.md),\
      \ [ice storm](/3-Mechanics/CLI/Compendium/spells/ice-storm.md), [wall of ice](/3-Mechanics/CLI/Compendium/spells/wall-of-ice.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fey/token/bheur-hag-mpmm.webp"
```
^statblock
