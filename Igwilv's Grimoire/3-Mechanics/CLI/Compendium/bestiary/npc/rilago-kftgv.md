...
- Rilago
---
# [Rilago](3-Mechanics\CLI\Compendium\bestiary\npc/rilago-kftgv.md)
...
"actions":
  ...
  - "desc": "One humanoid that Rilago can see within 5 feet of it must succeed on\
      ...
      \ the body drops to 0 hit points, Rilago ends it as a bonus action, or Rilago\
...
"source":
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/rilago-kftgv.webp"
```
^statblock