...
- Fidelio
---
# [Fidelio](3-Mechanics\CLI\Compendium\bestiary\npc/fidelio-wdmm.md)
...
"actions":
  ...
  - "desc": "One humanoid that Fidelio can see within 5 feet of it must succeed on\
      ...
      \ the body drops to 0 hit points, Fidelio ends it as a bonus action, or Fidelio\
      \ is turned or forced out by an effect like the [dispel evil and good](/3-Mechanics/CLI/Compendium/spells/dispel-evil-and-good.md)\
...
"source":
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/fidelio-wdmm.webp"
```
^statblock