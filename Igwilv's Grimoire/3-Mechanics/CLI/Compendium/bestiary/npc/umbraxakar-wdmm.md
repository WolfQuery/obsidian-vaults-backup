...
- Umbraxakar
---
# [Umbraxakar](3-Mechanics\CLI\Compendium\bestiary\npc/umbraxakar-wdmm.md)
...
"actions":
  ...
  - "desc": "The dragon uses one of the following breath weapons.\n\n- Necrotic\
      ...
      \ 66 (12d10) necrotic damage on a failed save, or half as much damage on a successful\
...
"source":
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/umbraxakar-wdmm.webp"
```
^statblock