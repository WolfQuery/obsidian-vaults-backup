...
- Nixylanna Vidorant
---
# [Nixylanna Vidorant](3-Mechanics\CLI\Compendium\bestiary\npc/nixylanna-vidorant-kftgv.md)
...
"traits":
  - "desc": "During its first turn, Nixylanna Vidorant has advantage on attack rolls\
      ...
      \ scores against a [surprised](/3-Mechanics/CLI/Rules/conditions.md#Surprised)\
  ...
  - "desc": "Nixylanna Vidorant deals an extra 14 (4d6) damage when it hits a target\
      ...
      \ is within 5 feet of an ally of Nixylanna Vidorant that isn't [incapacitated](/3-Mechanics/CLI/Rules/conditions.md#Incapacitated)\
...
"source":
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/nixylanna-vidorant-kftgv.webp"
```
^statblock