...
- Valetta
---
# [Valetta](3-Mechanics\CLI\Compendium\bestiary\npc/valetta-wdh.md)
...
"traits":
  - "desc": "Valetta is a 5th-level spellcaster. Her spellcasting ability is Wisdom.\
      ...
      \ level (4 slots): [cure wounds](/3-Mechanics/CLI/Compendium/spells/cure-wounds.md),\
...
"source":
  - "WDH"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/valetta-wdh.webp"
```
^statblock