...
- Ashtyrranthor
---
# [Ashtyrranthor](3-Mechanics\CLI\Compendium\bestiary\npc/ashtyrranthor-wdmm.md)
...
"traits":
  - "desc": "Ashtyrranthor's spellcasting ability is Charisma. She can innately cast\
      ...
      \ [alarm](/3-Mechanics/CLI/Compendium/spells/alarm.md), [detect magic](/3-Mechanics/CLI/Compendium/spells/detect-magic.md),\
      \ [gaseous form](/3-Mechanics/CLI/Compendium/spells/gaseous-form.md), [misty\
      \ step](/3-Mechanics/CLI/Compendium/spells/misty-step.md), [passwall](/3-Mechanics/CLI/Compendium/spells/passwall.md),\
...
"source":
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/ashtyrranthor-wdmm.webp"
```
^statblock