...
- Zox Clammersham
---
# [Zox Clammersham](3-Mechanics\CLI\Compendium\bestiary\npc/zox-clammersham-wdmm.md)
...
"traits":
  - "desc": "Zox is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
      \ (spell save DC 17, +9 to hit with spell attacks). Zox can cast [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md)\
...
"source":
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/npc/token/zox-clammersham-wdmm.webp"
```
^statblock