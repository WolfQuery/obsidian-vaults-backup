...
"actions":
  ...
  - "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
      \ elemental](/3-Mechanics/CLI/Compendium/bestiary/elemental/air-elemental.md).\
      \ Each of the five must use its action and movement on three consecutive turns\
      \ to perform an aerial dance and must maintain [concentration](/3-Mechanics/CLI/Rules/conditions.md#Concentration)\
...
"source":
  - "MM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/aarakocra.webp"
```
^statblock
