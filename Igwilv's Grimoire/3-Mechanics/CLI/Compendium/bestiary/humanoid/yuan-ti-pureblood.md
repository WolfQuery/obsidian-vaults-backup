...
"traits":
  - "desc": "The yuan-ti's spellcasting ability is Charisma (spell save DC 12). The\
      ...
      \ (snakes only)\n\n3/day each: [poison spray](/3-Mechanics/CLI/Compendium/spells/poison-spray.md),\
...
"source":
  - "MM"
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/yuan-ti-pureblood.webp"
```
^statblock
