...
- Rock Gnome Recluse
---
# [Rock Gnome Recluse](3-Mechanics\CLI\Compendium\bestiary\humanoid/rock-gnome-recluse-dip.md)
...
"traits":
  - "desc": "The gnome is a 2nd-level spellcaster. Its spellcasting ability is Intelligence\
      ...
      \ [ray of frost](/3-Mechanics/CLI/Compendium/spells/ray-of-frost.md) (see \"\
      Actions\" below)\n\n1st level (3 slots): [detect magic](/3-Mechanics/CLI/Compendium/spells/detect-magic.md),\
      ...
      \ (see \"Actions\" below), [shield](/3-Mechanics/CLI/Compendium/spells/shield.md)"
    "name": "Spellcasting"
...
"source":
  - "DIP"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/rock-gnome-recluse-dip.webp"
```
^statblock