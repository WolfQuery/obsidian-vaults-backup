...
*Source: Monster Manual p. 186, Lost Mine of Phandelver, Waterdeep: Dungeon of the Mad Mage, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"traits":
  - "desc": "Once per turn, the hobgoblin can deal an extra 7 (2d6) damage to a creature\
      ...
      \ of the hobgoblin that isn't [incapacitated](/3-Mechanics/CLI/Rules/conditions.md#Incapacitated)."
...
"source":
  ...
  - "WDMM"
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/hobgoblin.webp"
```
^statblock
