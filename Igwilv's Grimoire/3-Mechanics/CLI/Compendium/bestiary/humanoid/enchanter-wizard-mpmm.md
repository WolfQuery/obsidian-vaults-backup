...
"actions":
  ...
  - "desc": "The enchanter casts one of the following spells, using Intelligence as\
      \ the spellcasting ability (spell save DC 14):\n\nAt will: [friends](/3-Mechanics/CLI/Compendium/spells/friends.md),\
      ...
      \ [mage armor](/3-Mechanics/CLI/Compendium/spells/mage-armor.md), [hold person](/3-Mechanics/CLI/Compendium/spells/hold-person.md),\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/enchanter-wizard-mpmm.webp"
```
^statblock
