...
Githzerai revere Zerthimon, the founder of their race. Although Gith won their people's freedom, Zerthimon saw her as unfit to lead. He believed that her warmongering would soon make her a tyrant no better than the [mind flayers](/3-Mechanics/CLI/Compendium/bestiary/aberration/mind-flayer.md).
...
"traits":
  - "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
      ...
      \ hand](/3-Mechanics/CLI/Compendium/spells/mage-hand.md) (the hand is invisible)\n\
      \n3/day each: [feather fall](/3-Mechanics/CLI/Compendium/spells/feather-fall.md),\
      \ [jump](/3-Mechanics/CLI/Compendium/spells/jump.md), [see invisibility](/3-Mechanics/CLI/Compendium/spells/see-invisibility.md),\
...
"source":
  - "MM"
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/githzerai-zerth.webp"
```
^statblock