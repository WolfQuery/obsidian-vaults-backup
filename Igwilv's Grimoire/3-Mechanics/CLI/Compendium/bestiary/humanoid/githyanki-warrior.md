...
"traits":
  - "desc": "The githyanki's innate spellcasting ability is Intelligence. It can innately\
      ...
      \n3/day each: [jump](/3-Mechanics/CLI/Compendium/spells/jump.md), [misty\
      \ step](/3-Mechanics/CLI/Compendium/spells/misty-step.md), [nondetection](/3-Mechanics/CLI/Compendium/spells/nondetection.md)\
      \ (self only)"
...
"source":
  - "MM"
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/githyanki-warrior.webp"
```
^statblock