...
*Source: Monster Manual p. 218, Waterdeep: Dragon Heist, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "WDH"
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/humanoid/token/merfolk.webp"
```
^statblock
