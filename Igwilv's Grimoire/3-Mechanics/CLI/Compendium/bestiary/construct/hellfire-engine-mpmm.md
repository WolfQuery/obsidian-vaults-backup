...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ hellfire engine's path. On a failed save, the creature falls [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone)\
      \ and takes 28 (8d6) bludgeoning damage.\n\nIf the hellfire engine remains in\
      \ the [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone) creature's space,\
      \ the creature is also [restrained](/3-Mechanics/CLI/Rules/conditions.md#Restrained)\
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ kills a creature, the creature's soul rises from the River Styx as a [lemure](/3-Mechanics/CLI/Compendium/bestiary/fiend/lemure.md)\
      \ in Avernus in d4 hours. If the creature isn't revived before then, only a\
      \ [wish](/3-Mechanics/CLI/Compendium/spells/wish.md) spell or killing the [lemure](/3-Mechanics/CLI/Compendium/bestiary/fiend/lemure.md)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/hellfire-engine-mpmm.webp"
```
^statblock