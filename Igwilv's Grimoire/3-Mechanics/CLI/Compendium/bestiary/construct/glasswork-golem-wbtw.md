...
- Glasswork Golem
---
# [Glasswork Golem](3-Mechanics\CLI\Compendium\bestiary\construct/glasswork-golem-wbtw.md)
...
"traits":
  - "desc": "If the golem is embedded in a window and motionless at the start of combat,\
      ...
      \ discern that the golem is animate."
...
"bonus_actions":
  - "desc": "Magical, colored light springs from the golem in a 15-foot cone. Each\
      ...
      \ be [blinded](/3-Mechanics/CLI/Rules/conditions.md#Blinded) for 1 minute. A\
      \ creature can repeat the saving throw at the end of each of its turns, ending\
      \ the effect on itself on a success."
    "name": "Dazzling Light (Recharge 5-6)"
"source":
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/glasswork-golem-wbtw.webp"
```
^statblock