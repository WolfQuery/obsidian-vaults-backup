...
"actions":
  ...
  - "desc": "The collector releases paralyzing gas in a 30-foot cone. Each creature\
      ...
      \ A [paralyzed](/3-Mechanics/CLI/Rules/conditions.md#Paralyzed) creature repeats\
...
"bonus_actions":
  - "desc": "The collector calls up the enslaved spirits of those it has slain; d4\
      \ [specters](/3-Mechanics/CLI/Compendium/bestiary/undead/specter.md) (without\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/cadaver-collector-mpmm.webp"
```
^statblock
