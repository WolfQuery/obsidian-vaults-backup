...
"actions":
  ...
  - "desc": "The steel predator casts one of the following spells, requiring no spell\
      ...
      \ [dimension door](/3-Mechanics/CLI/Compendium/spells/dimension-door.md) (self\
      \ only), [plane shift](/3-Mechanics/CLI/Compendium/spells/plane-shift.md) (self\
      \ only)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/steel-predator-mpmm.webp"
```
^statblock
