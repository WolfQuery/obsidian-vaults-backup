...
- Animated Wand
---
# [Animated Wand](3-Mechanics\CLI\Compendium\bestiary\construct/animated-wand-wdmm.md)
...
"actions":
  - "desc": "The animated wand can expend 1 of its charges and target a random creature\
      \ with one of its [randomly determined effects](/3-Mechanics/CLI/Compendium/items/wand-of-wonder.md).\
...
"source":
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/animated-wand-wdmm.webp"
```
^statblock