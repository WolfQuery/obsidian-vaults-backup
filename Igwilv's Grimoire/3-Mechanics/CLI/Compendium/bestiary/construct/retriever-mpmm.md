...
"actions":
  ...
  - "desc": "The retriever casts one of the following spells, requiring no material\
      ...
      \n3/day each: [plane shift](/3-Mechanics/CLI/Compendium/spells/plane-shift.md)\
      \ (only self and up to one incapacitated creature, which is considered willing\
      \ for the spell), [web](/3-Mechanics/CLI/Compendium/spells/web.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/retriever-mpmm.webp"
```
^statblock
