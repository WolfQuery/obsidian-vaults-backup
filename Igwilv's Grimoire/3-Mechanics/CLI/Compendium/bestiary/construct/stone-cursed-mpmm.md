...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 12\
      ...
      \ effect ends if the second save is successful; otherwise the target is [petrified](/3-Mechanics/CLI/Rules/conditions.md#Petrified)\
      \ for 24 hours."
    "name": "Petrifying Claws"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/construct/token/stone-cursed-mpmm.webp"
```
^statblock
