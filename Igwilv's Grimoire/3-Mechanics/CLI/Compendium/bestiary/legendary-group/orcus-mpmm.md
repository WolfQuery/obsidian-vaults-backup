...
- **Deadly Utterance.** Orcus's voice booms throughout the lair. His utterance causes one creature of his choice to be subjected to [power word kill](/3-Mechanics/CLI/Compendium/spells/power-word-kill.md). Orcus needn't see the creature, but he must be aware that the individual is in the lair.  
...
- **Undead Servants.** Orcus causes up to six corpses within the lair to rise as [skeletons](/3-Mechanics/CLI/Compendium/bestiary/undead/skeleton.md), [zombies](/3-Mechanics/CLI/Compendium/bestiary/undead/zombie.md), or [ghouls](/3-Mechanics/CLI/Compendium/bestiary/undead/ghoul.md). These undead obey his telepathic commands, which can reach anywhere in the lair.  
