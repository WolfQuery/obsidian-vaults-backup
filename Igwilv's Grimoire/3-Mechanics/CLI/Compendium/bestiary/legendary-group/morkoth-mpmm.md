...
- **Cast a Spell.** The morkoth casts [darkness](/3-Mechanics/CLI/Compendium/spells/darkness.md), [dispel magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md), or [misty step](/3-Mechanics/CLI/Compendium/spells/misty-step.md), using Intelligence as its spellcasting ability and without expending a spell slot.  
