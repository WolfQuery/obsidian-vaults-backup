...
- **Deep Torpor.** The dragon casts the [slow](/3-Mechanics/CLI/Compendium/spells/slow.md) spell, requiring no spell components and using Charisma as the spellcasting ability (spell save DC 16). The spell ends early if the dragon uses this lair action again or if the dragon dies.  
...
- **Toxic Spores.** The dragon fills a 20-foot cube it can see within 120 feet of itself with toxic spores. Each creature in that area must succeed on a DC 15 Constitution saving throw or take `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) poison damage and be [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned) until the end of its next turn.  
