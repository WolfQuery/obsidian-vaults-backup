...
- The dragon creates fog as if it had cast the [fog cloud](/3-Mechanics/CLI/Compendium/spells/fog-cloud.md) spell. The fog lasts until initiative count 20 on the next round.  
...
- Once per day, the dragon can alter the weather in a 6-mile radius centered on its lair. The dragon doesn't need to be outdoors; otherwise the effect is identical to the [control weather](/3-Mechanics/CLI/Compendium/spells/control-weather.md) spell.  
