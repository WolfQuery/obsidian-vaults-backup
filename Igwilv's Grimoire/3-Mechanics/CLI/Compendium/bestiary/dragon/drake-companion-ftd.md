...
- Drake Companion
---
# [Drake Companion](3-Mechanics\CLI\Compendium\bestiary\dragon/drake-companion-ftd.md)
...
"reactions":
  - "desc": "When another creature within 30 feet of the drake that it can see hits\
      ...
      \ causing the target to take an extra d6 damage of the type determined by its\
      \ Draconic Essence."
    "name": "Infused Strikes"
"source":
  - "FTD"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/drake-companion-ftd.webp"
```
^statblock