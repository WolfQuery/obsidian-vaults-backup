...
"actions":
  ...
  - "desc": "The dragon exhales shadowy fire in a 30-foot cone. Each creature in that\
      ...
      \ to 0 hit points by this damage dies, and an undead [shadow](/3-Mechanics/CLI/Compendium/bestiary/undead/shadow.md)\
...
"source":
  - "MM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/young-red-shadow-dragon.webp"
```
^statblock
