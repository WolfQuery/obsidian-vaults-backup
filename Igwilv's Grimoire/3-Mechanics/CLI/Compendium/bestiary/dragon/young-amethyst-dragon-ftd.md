...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 16\
      \ (2d10 + 5) piercing damage plus 4 (d8) force damage."
    "name": "Bite"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      1/day each: [blink](/3-Mechanics/CLI/Compendium/spells/blink.md), [dispel\
      \ magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md), [protection from\
...
"source":
  - "FTD"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/young-amethyst-dragon-ftd.webp"
```
^statblock