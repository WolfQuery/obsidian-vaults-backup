...
"traits":
  - "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
      ...
      \n1/day each: [dancing lights](/3-Mechanics/CLI/Compendium/spells/dancing-lights.md),\
...
"source":
  - "MM"
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/faerie-dragon-red.webp"
```
^statblock
