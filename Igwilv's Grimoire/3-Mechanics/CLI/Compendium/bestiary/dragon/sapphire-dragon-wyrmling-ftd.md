...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 8 (1d10\
      \ + 3) piercing damage plus 3 (d6) thunder damage."
    "name": "Bite"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      \ and using Intelligence as the spellcasting ability:\n\n1/day each: [alarm](/3-Mechanics/CLI/Compendium/spells/alarm.md),\
      \ [Tenser's floating disk](/3-Mechanics/CLI/Compendium/spells/tensers-floating-disk.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "FTD"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/sapphire-dragon-wyrmling-ftd.webp"
```
^statblock