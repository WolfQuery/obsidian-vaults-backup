...
"actions":
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 9 (1d10\
      \ + 4) piercing damage plus 4 (d8) force damage."
    "name": "Bite"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      1/day each: [protection from evil and good](/3-Mechanics/CLI/Compendium/spells/protection-from-evil-and-good.md),\
...
"source":
  - "FTD"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/amethyst-dragon-wyrmling-ftd.webp"
```
^statblock