...
| 6 | An orphaned deep dragon wyrmling is cared for by a giant constrictor snake that is the recipient of a druid's [awaken](/3-Mechanics/CLI/Compendium/spells/awaken.md) spell. |
^connected-creatures
...
"actions":
  ...
  - "desc": "The dragon exhales a cloud of spores in a 15-foot cone. Each creature\
      ...
      \ creature takes 5 (d10) psychic damage, and it is [frightened](/3-Mechanics/CLI/Rules/conditions.md#Frightened)\
...
"source":
  - "FTD"
"image": "/3-Mechanics/CLI/Compendium/bestiary/dragon/token/deep-dragon-wyrmling-ftd.webp"
```
^statblock