...
"traits":
  - "desc": "The giant's innate spellcasting ability is Charisma. It can innately\
      ...
      \ fall](/3-Mechanics/CLI/Compendium/spells/feather-fall.md), [fly](/3-Mechanics/CLI/Compendium/spells/fly.md),\
      \ [misty step](/3-Mechanics/CLI/Compendium/spells/misty-step.md), [telekinesis](/3-Mechanics/CLI/Compendium/spells/telekinesis.md)\n\
      \n1/day each: [control weather](/3-Mechanics/CLI/Compendium/spells/control-weather.md),\
...
"source":
  - "MM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/giant/token/cloud-giant.webp"
```
^statblock
