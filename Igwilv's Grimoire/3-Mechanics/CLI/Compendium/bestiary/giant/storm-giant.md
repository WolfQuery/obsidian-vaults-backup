...
"traits":
  - "desc": "The giant's innate spellcasting ability is Charisma (spell save DC 17).\
      ...
      \ [feather fall](/3-Mechanics/CLI/Compendium/spells/feather-fall.md), [levitate](/3-Mechanics/CLI/Compendium/spells/levitate.md),\
      \ [light](/3-Mechanics/CLI/Compendium/spells/light.md)\n\n3/day each: [control\
      \ weather](/3-Mechanics/CLI/Compendium/spells/control-weather.md), [water breathing](/3-Mechanics/CLI/Compendium/spells/water-breathing.md)"
...
"source":
  - "MM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/giant/token/storm-giant.webp"
```
^statblock
