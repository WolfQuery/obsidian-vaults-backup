...
As a [vegepygmy](/3-Mechanics/CLI/Compendium/bestiary/plant/vegepygmy-mpmm.md) ages, it grows tougher and develops spore clusters on its body. Other vegepygmies defer to these so-called chiefs. A chief can expel its spores in a burst, infecting nearby creatures. If a creature dies while infected, its corpse produces vegepygmies the same way [russet mold](/3-Mechanics/CLI/Compendium/traps-hazards/russet-mold-vgm.md) does.
...
"actions":
  ...
  - "desc": "A 15-foot-radius cloud of toxic spores extends out from the vegepygmy.\
      ...
      \ Plant must succeed on a DC 12 Constitution saving throw or be [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned).\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/plant/token/vegepygmy-chief-mpmm.webp"
```
^statblock
