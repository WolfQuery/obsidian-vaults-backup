...
"bonus_actions":
  ...
  - "desc": "The corpse flower animates one corpse in its body, turning it into a\
      \ [zombie](/3-Mechanics/CLI/Compendium/bestiary/undead/zombie.md). The zombie\
      \ appears in an unoccupied space within 5 feet of the corpse flower and acts\
      \ immediately after it in the initiative order. The zombie acts as an ally of\
      \ the corpse flower but isn't under its control, and the flower's stench clings\
      \ to it (see Stench of Death)."
    "name": "Reanimate"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/plant/token/corpse-flower-mpmm.webp"
```
^statblock
