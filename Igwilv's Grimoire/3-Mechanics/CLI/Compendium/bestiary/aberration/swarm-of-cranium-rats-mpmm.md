...
"actions":
  ...
  - "desc": "As long as it has more than half of its hit points remaining, the swarm\
      ...
      \ [command](/3-Mechanics/CLI/Compendium/spells/command.md), [comprehend languages](/3-Mechanics/CLI/Compendium/spells/comprehend-languages.md),\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/aberration/token/swarm-of-cranium-rats-mpmm.webp"
```
^statblock
