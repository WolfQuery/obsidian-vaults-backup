...
---
# [Greater Star Spawn Emissary](3-Mechanics\CLI\Compendium\bestiary\aberration/greater-star-spawn-emissary-vrgr.md)
...
"actions":
  ...
  - "desc": "The emissary expels bile that splashes all creatures in a 30-foot-radius\
      ...
      \ creature that fails the saving throw, a [gibbering mouther](/3-Mechanics/CLI/Compendium/bestiary/aberration/gibbering-mouther.md)\
...
"source":
  - "VRGR"
"image": "/3-Mechanics/CLI/Compendium/bestiary/aberration/token/greater-star-spawn-emissary-vrgr.webp"
```
^statblock