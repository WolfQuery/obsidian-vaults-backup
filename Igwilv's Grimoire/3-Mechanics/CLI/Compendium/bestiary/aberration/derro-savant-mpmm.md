...
"actions":
  ...
  - "desc": "The derro casts one of the following spells, using Charisma as the spellcasting\
      ...
      \n1/day each: [invisibility](/3-Mechanics/CLI/Compendium/spells/invisibility.md),\
      \ [sleep](/3-Mechanics/CLI/Compendium/spells/sleep.md), [spider climb](/3-Mechanics/CLI/Compendium/spells/spider-climb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/aberration/token/derro-savant-mpmm.webp"
```
^statblock
