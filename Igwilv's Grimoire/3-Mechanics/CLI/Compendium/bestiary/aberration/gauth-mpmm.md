...
A [beholder](/3-Mechanics/CLI/Compendium/bestiary/aberration/beholder.md) usually drives away or kills any gauths that enter its territory, but it might choose to force them to serve it as lieutenants. Gauths are less xenophobic than beholders, so they might form small clusters and work together, though they're just as likely to ignore each other entirely.
...
"traits":
  - "desc": "When a creature that can see the gauth's central eye starts its turn\
      ...
      \ saving throw if the gauth isn't [incapacitated](/3-Mechanics/CLI/Rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "The gauth shoots three of the following magical eye rays at random (roll\
      ...
      \ Wisdom saving throw or fall asleep and remain [unconscious](/3-Mechanics/CLI/Rules/conditions.md#Unconscious)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/aberration/token/gauth-mpmm.webp"
```
^statblock
