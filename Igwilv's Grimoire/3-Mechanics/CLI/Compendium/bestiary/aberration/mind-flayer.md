...
*Source: Monster Manual p. 222, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Tasha's Cauldron of Everything, Keys from the Golden Vault*  
...
"source":
  ...
  - "TCE"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/aberration/token/mind-flayer.webp"
```
^statblock
