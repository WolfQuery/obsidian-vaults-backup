...
- Giant Lizard
---
# [Giant Lizard](3-Mechanics\CLI\Compendium\bestiary\beast/giant-lizard.md)
*Source: Monster Manual p. 326, Waterdeep: Dungeon of the Mad Mage, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "WDMM"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/giant-lizard.webp"
```
^statblock
