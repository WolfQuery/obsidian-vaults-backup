...
*Source: Monster Manual p. 338, Waterdeep: Dungeon of the Mad Mage. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"actions":
  - "desc": "Melee Weapon Attack: +3 to hit, reach 0 ft., one target in the swarm's\
      ...
      \ points by a swarm of centipedes is stable but [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/swarm-of-centipedes.webp"
```
^statblock
