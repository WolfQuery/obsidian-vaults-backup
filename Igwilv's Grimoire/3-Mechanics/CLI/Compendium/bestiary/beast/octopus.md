...
- Octopus
---
# [Octopus](3-Mechanics\CLI\Compendium\bestiary\beast/octopus.md)
*Source: Monster Manual p. 333, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  - "MM"
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/octopus.webp"
```
^statblock