...
"actions":
  - "desc": "Melee Weapon Attack: +0 to hit, reach 0 ft., one creature in the swarm's\
      ...
      \ target's turns, the target takes 3 (d6) poison damage. Whenever the [poisoned](/3-Mechanics/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/swarm-of-rot-grubs-mpmm.webp"
```
^statblock
