...
"actions":
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d6\
      ...
      \ damage."
    "name": "Gore"
  - "desc": "The rothé casts [dancing lights](/3-Mechanics/CLI/Compendium/spells/dancing-lights.md),\
      \ requiring no spell components and using Wisdom as the spellcasting ability.\n"
    "name": "Dancing Lights"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/deep-rothe-mpmm.webp"
```
^statblock
