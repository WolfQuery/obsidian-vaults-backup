...
- Giant Wolf Spider
---
# [Giant Wolf Spider](3-Mechanics\CLI\Compendium\bestiary\beast/giant-wolf-spider.md)
*Source: Monster Manual p. 330, Tasha's Cauldron of Everything, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "TCE"
  - "WBtW"
"image": "/3-Mechanics/CLI/Compendium/bestiary/beast/token/giant-wolf-spider.webp"
```
^statblock
