...
"actions":
  ...
  - "desc": "The meazel, any equipment it is wearing or carrying, and any creature\
      ...
      \ becomes cursed for 1 hour or until the curse is ended by [remove curse](/3-Mechanics/CLI/Compendium/spells/remove-curse.md)\
      \ or [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md).\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/monstrosity/token/meazel-mpmm.webp"
```
^statblock
