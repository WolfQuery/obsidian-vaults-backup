...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 22\
      ...
      \ froghemoth's gullet can hold up to two creatures at a time. If the froghemoth\
      ...
      \ or regurgitate all swallowed creatures, each of which falls [prone](/3-Mechanics/CLI/Rules/conditions.md#Prone)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/monstrosity/token/froghemoth-mpmm.webp"
```
^statblock
