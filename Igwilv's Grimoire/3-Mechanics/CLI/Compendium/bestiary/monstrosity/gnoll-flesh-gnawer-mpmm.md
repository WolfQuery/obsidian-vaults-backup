...
"actions":
  ...
  - "desc": "Until the end of the turn, the gnoll's speed increases by 60 feet and\
      \ it doesn't provoke [opportunity attacks](/3-Mechanics/CLI/Rules/actions.md#Opportunity%20Attack)."
    "name": "Sudden Rush"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/monstrosity/token/gnoll-flesh-gnawer-mpmm.webp"
```
^statblock
