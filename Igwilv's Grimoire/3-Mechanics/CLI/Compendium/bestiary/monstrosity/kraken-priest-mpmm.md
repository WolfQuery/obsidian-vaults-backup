...
"actions":
  ...
  - "desc": "The priest casts one of the following spells, requiring no material components\
      ...
      \ [command](/3-Mechanics/CLI/Compendium/spells/command.md), [create or destroy\
      ...
      \ [darkness](/3-Mechanics/CLI/Compendium/spells/darkness.md), [water breathing](/3-Mechanics/CLI/Compendium/spells/water-breathing.md),\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/monstrosity/token/kraken-priest-mpmm.webp"
```
^statblock
