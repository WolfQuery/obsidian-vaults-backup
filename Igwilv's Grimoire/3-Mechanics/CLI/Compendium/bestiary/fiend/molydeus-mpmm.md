...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one creature. Hit:\
      ...
      \ The target transforms into a [manes](/3-Mechanics/CLI/Compendium/bestiary/fiend/manes.md)\
  ...
  - "desc": "The molydeus casts one of the following spells, requiring no material\
      ...
      \nAt will: [dispel magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md),\
      \ [polymorph](/3-Mechanics/CLI/Compendium/spells/polymorph.md), [telekinesis](/3-Mechanics/CLI/Compendium/spells/telekinesis.md),\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/molydeus-mpmm.webp"
```
^statblock