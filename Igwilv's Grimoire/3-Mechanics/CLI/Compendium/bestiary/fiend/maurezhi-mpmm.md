...
When Doresain, the King of Ghouls, corrupted a society of elves, he created a new sort of demon—the maurezhi—to lead packs of [ghouls](/3-Mechanics/CLI/Compendium/bestiary/undead/ghoul.md) and [ghasts](/3-Mechanics/CLI/Compendium/bestiary/undead/ghast.md) on the Material Plane.
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 14\
      ...
      \ hours later as a [ghoul](/3-Mechanics/CLI/Compendium/bestiary/undead/ghoul.md)\
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12\
    ...
    "name": "Claw"
  - "desc": "The maurezhi targets one dead ghoul or [ghast](/3-Mechanics/CLI/Compendium/bestiary/undead/ghast.md)\
      \ it can see within 30 feet of it. The target is revived with all its hit points."
    "name": "Raise Ghoul (Recharge 5-6)"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/maurezhi-mpmm.webp"
```
^statblock
