...
"actions":
  ...
  - "desc": "The dybbuk casts one of the following spells, requiring no material components\
      ...
      \ will: [dimension door](/3-Mechanics/CLI/Compendium/spells/dimension-door.md)\n\
      \n3/day: [phantasmal force](/3-Mechanics/CLI/Compendium/spells/phantasmal-force.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/dybbuk-mpmm.webp"
```
^statblock
