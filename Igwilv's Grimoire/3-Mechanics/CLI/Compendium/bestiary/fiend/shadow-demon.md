...
*Source: Monster Manual p. 64, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Keys from the Golden Vault*  
...
"source":
  ...
  - "WDMM"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/shadow-demon.webp"
```
^statblock