...
"actions":
  ...
  - "desc": "The sibriex targets up to three creatures it can see within 120 feet\
      ...
      \ it dies and instantly transforms into a living [manes](/3-Mechanics/CLI/Compendium/bestiary/fiend/manes.md)\
      \ under the sibriex's control. The transformation of the body can be undone\
      \ only by a [wish](/3-Mechanics/CLI/Compendium/spells/wish.md) spell."
    "name": "Warp Creature"
  - "desc": "The sibriex casts one of the following spells, requiring no material\
      ...
      \nAt will: [command](/3-Mechanics/CLI/Compendium/spells/command.md), [dispel\
      \ magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md), [hold monster](/3-Mechanics/CLI/Compendium/spells/hold-monster.md)\n\
      \n1/day: [feeblemind](/3-Mechanics/CLI/Compendium/spells/feeblemind.md)"
    "name": "Spellcasting"
"legendary_actions":
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/sibriex-mpmm.webp"
```
^statblock
