...
"actions":
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 8 (1d12\
      ...
      \ way, the target sports festering boils, coughs up flies, and sheds rotting\
      ...
      \ hit point maximum is reduced by 4 (d8). The target dies if its hit point maximum\
      \ is reduced to 0."
    "name": "Barbed Tail"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/bulezau-mpmm.webp"
```
^statblock