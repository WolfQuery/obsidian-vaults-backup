...
*Source: Monster Manual p. 76, Waterdeep: Dragon Heist. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"traits":
  ...
  - "desc": "A lemure that dies in the Nine Hells comes back to life with all its\
      ...
      \ a [bless](/3-Mechanics/CLI/Compendium/spells/bless.md) spell cast on that\
...
"source":
  - "MM"
  - "WDH"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/lemure.webp"
```
^statblock