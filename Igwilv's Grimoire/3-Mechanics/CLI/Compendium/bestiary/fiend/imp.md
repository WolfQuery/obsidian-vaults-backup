...
*Source: Monster Manual p. 76, Waterdeep: Dragon Heist, Tasha's Cauldron of Everything, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"source":
  ...
  - "TCE"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/imp.webp"
```
^statblock