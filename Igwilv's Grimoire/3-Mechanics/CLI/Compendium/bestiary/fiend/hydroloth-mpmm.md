...
"actions":
  ...
  - "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
      ...
      \ itself on a success. A [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md)\
  ...
  - "desc": "The hydroloth casts one of the following spells, requiring no material\
      ...
      \ DC 16):\n\nAt will: [darkness](/3-Mechanics/CLI/Compendium/spells/darkness.md),\
      ...
      \ (self only)\n\n3/day each: [control water](/3-Mechanics/CLI/Compendium/spells/control-water.md),\
      \ [crown of madness](/3-Mechanics/CLI/Compendium/spells/crown-of-madness.md),\
      \ [fear](/3-Mechanics/CLI/Compendium/spells/fear.md), [suggestion](/3-Mechanics/CLI/Compendium/spells/suggestion.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/hydroloth-mpmm.webp"
```
^statblock