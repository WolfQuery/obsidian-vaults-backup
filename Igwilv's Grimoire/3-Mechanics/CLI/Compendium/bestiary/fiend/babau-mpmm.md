...
"actions":
  ...
  - "desc": "The babau casts one of the following spells, requiring no material components\
      ...
      \ [fear](/3-Mechanics/CLI/Compendium/spells/fear.md), [heat metal](/3-Mechanics/CLI/Compendium/spells/heat-metal.md),\
      \ [levitate](/3-Mechanics/CLI/Compendium/spells/levitate.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/babau-mpmm.webp"
```
^statblock
