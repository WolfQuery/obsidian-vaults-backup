...
"traits":
  ...
  - "desc": "Any creature that isn't a demon that starts its turn within 30 feet of\
      ...
      \ fails by 5 or more, the creature is instead subjected to the [confusion](/3-Mechanics/CLI/Compendium/spells/confusion.md)\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/alkilith-mpmm.webp"
```
^statblock
