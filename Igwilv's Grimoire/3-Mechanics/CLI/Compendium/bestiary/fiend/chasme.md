...
*Source: Monster Manual p. 57, Waterdeep: Dungeon of the Mad Mage, Keys from the Golden Vault*  
...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 16\
      ...
      \ finishes a long rest or until it is affected by a spell like  [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md)."
    "name": "Proboscis"
"source":
  - "MM"
  - "WDMM"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/chasme.webp"
```
^statblock