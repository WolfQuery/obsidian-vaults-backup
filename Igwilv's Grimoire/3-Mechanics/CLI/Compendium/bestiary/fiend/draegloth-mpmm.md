...
A draegloth is a demon created by an elf priest of Lolth in an unholy, dangerous ritual in which it is infused with the fey essence of the creator and the fiendish essence of a [glabrezu](/3-Mechanics/CLI/Compendium/bestiary/fiend/glabrezu.md). This ritual rarely succeeds, but Lolth's faithful consider it worth the risk, as the resulting creature is gifted with innate magic and physical might. The draegloth usually serves its creator, lending its thirst for destruction to the creator's plans to triumph over rivals.
...
"actions":
  ...
  - "desc": "The draegloth casts one of the following spells, requiring no material\
      ...
      \ [confusion](/3-Mechanics/CLI/Compendium/spells/confusion.md), [faerie fire](/3-Mechanics/CLI/Compendium/spells/faerie-fire.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/draegloth-mpmm.webp"
```
^statblock
