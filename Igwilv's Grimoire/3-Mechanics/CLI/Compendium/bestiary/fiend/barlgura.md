...
*Source: Monster Manual p. 56, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Keys from the Golden Vault*  
...
"traits":
  - "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The\
      ...
      \n1/day each: [entangle](/3-Mechanics/CLI/Compendium/spells/entangle.md),\
...
"source":
  ...
  - "WDMM"
  - "KftGV"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/barlgura.webp"
```
^statblock