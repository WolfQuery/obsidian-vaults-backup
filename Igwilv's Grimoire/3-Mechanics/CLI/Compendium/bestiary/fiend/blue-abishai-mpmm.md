...
"actions":
  ...
  - "desc": "The abishai casts one of the following spells, using Intelligence as\
      ...
      \ [dispel magic](/3-Mechanics/CLI/Compendium/spells/dispel-magic.md), [greater\
      \ invisibility](/3-Mechanics/CLI/Compendium/spells/greater-invisibility.md),\
...
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/blue-abishai-mpmm.webp"
```
^statblock
