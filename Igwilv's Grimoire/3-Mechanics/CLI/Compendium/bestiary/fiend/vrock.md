...
*Source: Monster Manual p. 64, Waterdeep: Dungeon of the Mad Mage, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"actions":
  ...
  - "desc": "A 15-foot-radius cloud of toxic spores extends out from the vrock. The\
      ...
      \ a target takes 5 (d10) poison damage at the start of each of its turns. A\
...
"source":
  ...
  - "WDMM"
  - "TCE"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/vrock.webp"
```
^statblock