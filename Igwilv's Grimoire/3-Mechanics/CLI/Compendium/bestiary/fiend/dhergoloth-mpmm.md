...
"actions":
  ...
  - "desc": "The dhergoloth casts one of the following spells, requiring no material\
      ...
      \nAt will: [darkness](/3-Mechanics/CLI/Compendium/spells/darkness.md), [fear](/3-Mechanics/CLI/Compendium/spells/fear.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/dhergoloth-mpmm.webp"
```
^statblock
