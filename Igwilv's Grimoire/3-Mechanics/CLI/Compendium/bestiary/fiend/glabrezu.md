...
*Source: Monster Manual p. 58, Waterdeep: Dungeon of the Mad Mage. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"traits":
  - "desc": "The glabrezu's spellcasting ability is Intelligence (spell save DC 16).\
      ...
      \ [confusion](/3-Mechanics/CLI/Compendium/spells/confusion.md), [fly](/3-Mechanics/CLI/Compendium/spells/fly.md),\
...
"source":
  - "MM"
  - "WDMM"
"image": "/3-Mechanics/CLI/Compendium/bestiary/fiend/token/glabrezu.webp"
```
^statblock