...
![](/3-Mechanics/CLI/Compendium/races/img/firbolg.webp#right)
...
You can cast [detect magic](/3-Mechanics/CLI/Compendium/spells/detect-magic.md) and [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md) spells with this trait. When you use this version of [disguise self](/3-Mechanics/CLI/Compendium/spells/disguise-self.md), you can seem up to 3 feet shorter or taller. Once you cast either of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using any spell slots you have.
