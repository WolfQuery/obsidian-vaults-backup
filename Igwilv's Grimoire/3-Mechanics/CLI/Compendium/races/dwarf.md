...
![](/3-Mechanics/CLI/Compendium/races/img/dwarf.webp#right)
...
You have proficiency with the [battleaxe](/3-Mechanics/CLI/Compendium/items/battleaxe.md), [handaxe](/3-Mechanics/CLI/Compendium/items/handaxe.md), [light hammer](/3-Mechanics/CLI/Compendium/items/light-hammer.md), and [warhammer](/3-Mechanics/CLI/Compendium/items/warhammer.md).

### Tool Proficiency

You gain proficiency with the artisan's tools of your choice: [Smith's tools](/3-Mechanics/CLI/Compendium/items/smiths-tools.md), [brewer's supplies](/3-Mechanics/CLI/Compendium/items/brewers-supplies.md), or [mason's tools](/3-Mechanics/CLI/Compendium/items/masons-tools.md).
