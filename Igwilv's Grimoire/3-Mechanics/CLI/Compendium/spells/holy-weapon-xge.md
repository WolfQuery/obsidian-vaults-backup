...
As a bonus action on your turn, you can dismiss this spell and cause the weapon to emit a burst of radiance. Each creature of your choice that you can see within 30 feet of the weapon must make a Constitution saving throw. On a failed save, a creature takes `dice:4d8|noform|noparens|avg` (`4d8`) radiant damage, and it is [blinded](/3-Mechanics/CLI/Rules/conditions.md#Blinded) for 1 minute. On a successful save, a creature takes half as much damage and isn't [blinded](/3-Mechanics/CLI/Rules/conditions.md#Blinded). At the end of each of its turns, a [blinded](/3-Mechanics/CLI/Rules/conditions.md#Blinded) creature can make a Constitution saving throw, ending the effect on itself on a success.
