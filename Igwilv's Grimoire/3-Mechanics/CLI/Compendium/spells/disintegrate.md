...
A thin green ray springs from your pointing finger to a target that you can see within range. The target can be a creature, an object, or a creation of magical force, such as the wall created by [wall of force](/3-Mechanics/CLI/Compendium/spells/wall-of-force.md).
...
A disintegrated creature and everything it is wearing and carrying, except magic items, are reduced to a pile of fine gray dust. The creature can be restored to life only by means of a [true resurrection](/3-Mechanics/CLI/Compendium/spells/true-resurrection.md) or a [wish](/3-Mechanics/CLI/Compendium/spells/wish.md) spell.
