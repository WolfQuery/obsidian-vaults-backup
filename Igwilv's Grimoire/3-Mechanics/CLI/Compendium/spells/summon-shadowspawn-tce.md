...
![](/3-Mechanics/CLI/Compendium/spells/img/summon-shadowspawn.webp#right)
...
You call forth a shadowy spirit. It manifests in an unoccupied space that you can see within range. This corporeal form uses the [Shadow Spirit](/3-Mechanics/CLI/Compendium/bestiary/monstrosity/shadow-spirit-tce.md) stat block. When you cast the spell, choose an emotion: Fury, Despair, or Fear. The creature resembles a misshapen biped marked by the chosen emotion, which determines certain traits in its stat block. The creature disappears when it drops to 0 hit points or when the spell ends.
