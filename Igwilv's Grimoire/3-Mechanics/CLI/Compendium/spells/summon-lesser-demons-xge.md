...
The DM chooses the demons, such as [manes](/3-Mechanics/CLI/Compendium/bestiary/fiend/manes.md) or [dretches](/3-Mechanics/CLI/Compendium/bestiary/fiend/dretch.md), and you choose the unoccupied spaces you can see within range where they appear. A summoned demon disappears when it drops to 0 hit points or when the spell ends.
