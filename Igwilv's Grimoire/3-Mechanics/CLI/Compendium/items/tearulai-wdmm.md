...
---
# Tearulai
*Weapon ([longsword](/3-Mechanics/CLI/Compendium/items/longsword.md)), very rare (requires attunement)*  
...
The longsword, Tearulai, is a sentient, neutral good [sword of sharpness](/3-Mechanics/CLI/Compendium/items/sword-of-sharpness.md) with an emerald-colored blade and precious gemstones embedded in its hilt and pommel. The sword's magical properties are suppressed until it is removed from Valdemar's skull.
