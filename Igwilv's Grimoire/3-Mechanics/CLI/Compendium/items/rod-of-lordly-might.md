...
---
# Rod of Lordly Might
*Rod ([mace](/3-Mechanics/CLI/Compendium/items/mace.md)), melee weapon ([mace](/3-Mechanics/CLI/Compendium/items/mace.md)), major, legendary (requires attunement)*  
![](/3-Mechanics/CLI/Compendium/items/img/rod-of-lordly-might.webp#right)
...
If you press button 1, the rod becomes a [flame tongue](/3-Mechanics/CLI/Compendium/items/flame-tongue.md) as a fiery blade sprouts from the end opposite the rod's flanged head (you choose the type of sword).
