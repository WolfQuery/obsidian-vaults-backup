...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](/3-Mechanics/CLI/Compendium/spells/antipathy-sympathy.md), [charm person](/3-Mechanics/CLI/Compendium/spells/charm-person.md), [dominate person](/3-Mechanics/CLI/Compendium/spells/dominate-person.md), [enthrall](/3-Mechanics/CLI/Compendium/spells/enthrall.md), [hypnotic pattern](/3-Mechanics/CLI/Compendium/spells/hypnotic-pattern.md), [modify memory](/3-Mechanics/CLI/Compendium/spells/modify-memory.md), and [suggestion](/3-Mechanics/CLI/Compendium/spells/suggestion.md). It functions as a spellbook for you.
