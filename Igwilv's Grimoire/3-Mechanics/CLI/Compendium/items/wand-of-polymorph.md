...
![](/3-Mechanics/CLI/Compendium/items/img/wand-of-polymorph.webp#right)

- **Weight**: 1.0 lbs.

This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the [polymorph](/3-Mechanics/CLI/Compendium/spells/polymorph.md) spell (save DC 15) from it.
