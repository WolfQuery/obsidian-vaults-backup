...
![](/3-Mechanics/CLI/Compendium/items/img/wand-of-fear.webp#right)
...
While holding the wand, you can use an action to expend 1 charge and command another creature to flee or grovel, as with the [command](/3-Mechanics/CLI/Compendium/spells/command.md) spell (save DC 15).
