...
A brass horn summons `dice:3d4+3|noform|noparens|avg` (`3d4 + 3`) [berserkers](/3-Mechanics/CLI/Compendium/bestiary/humanoid/berserker.md). To use the brass horn, you must be proficient with all simple weapons.
