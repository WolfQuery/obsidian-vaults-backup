...
The [calm emotions](/3-Mechanics/CLI/Compendium/spells/calm-emotions.md) spell effect used to suppress the [charmed](/3-Mechanics/CLI/Rules/conditions.md#Charmed) and [frightened](/3-Mechanics/CLI/Rules/conditions.md#Frightened) conditions also suppresses the effects of one's Stress Score for the spell's duration.

A [lesser restoration](/3-Mechanics/CLI/Compendium/spells/lesser-restoration.md) spell reduces the target's Stress Score by 1, and a [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md) spell reduces a character's Stress Score to 0.