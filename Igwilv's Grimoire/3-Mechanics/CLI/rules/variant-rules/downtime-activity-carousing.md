...
| d100 + Level | Result |
|--------------|--------|
| 01-10 | You are jailed for `dice:1d4\|noform\|noparens\|avg` (`1d4`) days at the end of the downtime period on charges of disorderly conduct and disturbing the peace. You can pay a fine of 10 gp to avoid jail time, or you can try to resist arrest. |
