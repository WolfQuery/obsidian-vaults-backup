...
- Being subjected to spells that affect mental stability, such as the insanity option of the [symbol](/3-Mechanics/CLI/Compendium/spells/symbol.md) spell  
...
A failed Sanity save might result in [short-term](/3-Mechanics/CLI/Compendium/tables/short-term-madness.md), [long-term](/3-Mechanics/CLI/Compendium/tables/long-term-madness.md), or [indefinite madness](/3-Mechanics/CLI/Compendium/tables/indefinite-madness.md), as described in chapter 8, "Running the Game." Any time a character suffers from long-term or indefinite madness, the character's Sanity is reduced by 1. A [greater restoration](/3-Mechanics/CLI/Compendium/spells/greater-restoration.md) spell can restore Sanity lost in this way, and a character can increase his or her Sanity through level advancement.