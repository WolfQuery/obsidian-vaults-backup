...
> [!note]
> This disease can be inflicted with the [contagion](/3-Mechanics/CLI/Compendium/spells/contagion.md) spell.
...
Symptoms manifest `dice:1d4|noform|noparens|avg` (`d4`) hours after infection and include fever and disorientation. The infected creature gains one level of [exhaustion](/3-Mechanics/CLI/Rules/conditions.md#Exhaustion) that can't be removed until the disease is cured.
...
A beast or humanoid that drinks water tainted by sight rot must succeed on a DC 15 Constitution saving throw or become infected. One day after infection, the creature's vision starts to become blurry. The creature takes a -1 penalty to attack rolls and ability checks that rely on sight. At the end of each long rest after the symptoms appear, the penalty worsens by 1. When it reaches -5, the victim is [blinded](/3-Mechanics/CLI/Rules/conditions.md#Blinded) until its sight is restored by magic such as [lesser restoration](/3-Mechanics/CLI/Compendium/spells/lesser-restoration.md) or [heal](/3-Mechanics/CLI/Compendium/spells/heal.md).

Sight rot can be cured using a rare flower called Eyebright, which grows in some swamps. Given an hour, a character who has proficiency with an [herbalism kit](/3-Mechanics/CLI/Compendium/items/herbalism-kit.md) can turn the flower into one dose of ointment. Applied to the eyes before a long rest, one dose of it prevents the disease from worsening after that rest. After three doses, the ointment cures the disease entirely.
...
**Transmission.** The Gnaws is spread when a creature is bitten by a [rat](/3-Mechanics/CLI/Compendium/bestiary/beast/rat.md), [giant rat](/3-Mechanics/CLI/Compendium/bestiary/beast/giant-rat.md), [swarm of rats](/3-Mechanics/CLI/Compendium/bestiary/beast/swarm-of-rats.md), or [wererat](/3-Mechanics/CLI/Compendium/bestiary/humanoid/wererat.md) that carries the disease, or by coming into physical contact with an infected creature.
...
**Symptoms.** It takes `dice:1d2|noform|noparens|avg` (`d2`) days for the Gnawing Plague's symptoms to manifest in an infected creature. The infected creature then gains 1 level of [exhaustion](/3-Mechanics/CLI/Rules/conditions.md#Exhaustion), regains only half the normal number of hit points from spending Hit Dice, and regains no hit points from finishing a long rest.
